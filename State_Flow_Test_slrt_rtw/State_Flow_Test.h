...
#ifndef RTW_HEADER_State_Flow_Test_h_
#define RTW_HEADER_State_Flow_Test_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef State_Flow_Test_COMMON_INCLUDES_
# define State_Flow_Test_COMMON_INCLUDES_
...
#endif                                 /* State_Flow_Test_COMMON_INCLUDES_ */

#include "State_Flow_Test_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_State_Flow_Test        RT_MODEL_State_Flow_Test_T

/* Definition for use in the target main file */
#define State_Flow_Test_rtModel        RT_MODEL_State_Flow_Test_T
...
/* Block signals for system '<S96>/MATLAB Function' */
typedef struct {
  real_T y;                            /* '<S96>/MATLAB Function' */
...
typedef struct {
  ...
  real_T Switch1;                      /* '<S96>/Switch1' */
  real_T CoppiaAbracciasaturata;       /* '<S6>/Coppia A braccia saturata' */
  real_T DataTypeConversion14;         /* '<S96>/Data Type Conversion14' */
  real_T Memory_g;                     /* '<S100>/Memory' */
  real_T Gain;                         /* '<S4>/Gain' */
  real_T Switch1_l;                    /* '<S100>/Switch1' */
  real_T CoppiaBbracciasaturata;       /* '<S7>/Coppia B braccia saturata' */
  real_T DataTypeConversion14_g;       /* '<S100>/Data Type Conversion14' */
  real_T Memory_n;                     /* '<S104>/Memory' */
  real_T Sum_i;                        /* '<S118>/Sum' */
  real_T Sum3;                         /* '<S13>/Sum3' */
  real_T Sum5;                         /* '<S127>/Sum5' */
  real_T Sum2_b;                       /* '<S121>/Sum2' */
  real_T VelocityA_m;                  /* '<S125>/Velocity A' */
  real_T VelocityB_h;                  /* '<S125>/Velocity B' */
  real_T Switch1_f;                    /* '<S104>/Switch1' */
  real_T CoppiaAvitesaturata;          /* '<S8>/Coppia A vite saturata' */
  real_T DataTypeConversion14_k;       /* '<S104>/Data Type Conversion14' */
  real_T Memory_a;                     /* '<S106>/Memory' */
  real_T Switch1_k;                    /* '<S106>/Switch1' */
  real_T DataTypeConversion14_e;       /* '<S106>/Data Type Conversion14' */
  real_T Sum2_d;                       /* '<S4>/Sum2' */
  real_T Sum3_b;                       /* '<S4>/Sum3' */
  real_T Memory_d[4];                  /* '<S4>/Memory' */
  real_T TSamp;                        /* '<S51>/TSamp' */
  real_T Uk1;                          /* '<S51>/UD' */
  real_T Diff;                         /* '<S51>/Diff' */
  real_T Duk;                          /* '<S62>/D*u(k)' */
  real_T x1k;                          /* '<S62>/Delay_x1' */
  real_T C11;                          /* '<S65>/C11' */
  real_T x2k;                          /* '<S62>/Delay_x2' */
  real_T C12;                          /* '<S65>/C12' */
  real_T sum2;                         /* '<S65>/sum2' */
  real_T yk;                           /* '<S62>/C*X(k)+D*u(k)' */
  real_T TSamp_n;                      /* '<S49>/TSamp' */
  real_T Uk1_d;                        /* '<S49>/UD' */
  real_T Diff_i;                       /* '<S49>/Diff' */
  real_T A11;                          /* '<S63>/A11' */
  real_T A12;                          /* '<S63>/A12' */
  real_T A21;                          /* '<S63>/A21' */
  real_T A22;                          /* '<S63>/A22' */
  real_T sum2_n;                       /* '<S63>/sum2' */
  real_T sum3;                         /* '<S63>/sum3' */
  real_T B11;                          /* '<S64>/B11' */
  real_T x1k1;                         /* '<S62>/A*x1(k) + B*u1(k) ' */
  real_T B21;                          /* '<S64>/B21' */
  real_T x2k1;                         /* '<S62>/A*x2(k) + B*u2(k)' */
  real_T Duk_h;                        /* '<S58>/D*u(k)' */
  real_T x1k_a;                        /* '<S58>/Delay_x1' */
  real_T C11_h;                        /* '<S61>/C11' */
  real_T x2k_g;                        /* '<S58>/Delay_x2' */
  real_T C12_e;                        /* '<S61>/C12' */
  real_T sum2_k;                       /* '<S61>/sum2' */
  real_T yk_i;                         /* '<S58>/C*X(k)+D*u(k)' */
  real_T TSamp_h;                      /* '<S50>/TSamp' */
  real_T Uk1_b;                        /* '<S50>/UD' */
  real_T Diff_d;                       /* '<S50>/Diff' */
  real_T TSamp_nd;                     /* '<S52>/TSamp' */
  real_T Uk1_l;                        /* '<S52>/UD' */
  real_T Diff_n;                       /* '<S52>/Diff' */
  real_T A11_p;                        /* '<S59>/A11' */
  real_T A12_c;                        /* '<S59>/A12' */
  real_T A21_h;                        /* '<S59>/A21' */
  real_T A22_d;                        /* '<S59>/A22' */
  real_T sum2_nk;                      /* '<S59>/sum2' */
  real_T sum3_e;                       /* '<S59>/sum3' */
  real_T B11_k;                        /* '<S60>/B11' */
  real_T x1k1_g;                       /* '<S58>/A*x1(k) + B*u1(k) ' */
  real_T B21_l;                        /* '<S60>/B21' */
  real_T x2k1_n;                       /* '<S58>/A*x2(k) + B*u2(k)' */
  real_T DigitalClock;                 /* '<S34>/Digital Clock' */
  real_T Duk_n;                        /* '<S66>/D*u(k)' */
  real_T x1k_i;                        /* '<S66>/Delay_x1' */
  real_T C11_e;                        /* '<S69>/C11' */
  real_T x2k_d;                        /* '<S66>/Delay_x2' */
  real_T C12_m;                        /* '<S69>/C12' */
  real_T sum2_ka;                      /* '<S69>/sum2' */
  real_T yk_m;                         /* '<S66>/C*X(k)+D*u(k)' */
  real_T TSamp_f;                      /* '<S53>/TSamp' */
  real_T Uk1_j;                        /* '<S53>/UD' */
  real_T Diff_b;                       /* '<S53>/Diff' */
  real_T TSamp_i;                      /* '<S54>/TSamp' */
  real_T Uk1_bl;                       /* '<S54>/UD' */
  real_T Diff_bt;                      /* '<S54>/Diff' */
  real_T A11_h;                        /* '<S67>/A11' */
  real_T A12_g;                        /* '<S67>/A12' */
  real_T A21_p;                        /* '<S67>/A21' */
  real_T A22_j;                        /* '<S67>/A22' */
  real_T sum2_e;                       /* '<S67>/sum2' */
  real_T sum3_b;                       /* '<S67>/sum3' */
  real_T B11_d;                        /* '<S68>/B11' */
  real_T x1k1_h;                       /* '<S66>/A*x1(k) + B*u1(k) ' */
  real_T B21_h;                        /* '<S68>/B21' */
  real_T x2k1_h;                       /* '<S66>/A*x2(k) + B*u2(k)' */
  ...
  real_T Sum2_bi;                      /* '<S79>/Sum2' */
  real_T Sum_e;                        /* '<S5>/Sum' */
  real_T Sum1_g;                       /* '<S5>/Sum1' */
  real_T VelocityB_p;                  /* '<S86>/Velocity B' */
  real_T Sum6;                         /* '<S5>/Sum6' */
  real_T Coppiatheta1vel;              /* '<S5>/Coppia theta 1 vel' */
  real_T VelocityA_a;                  /* '<S86>/Velocity A' */
  real_T Sum17;                        /* '<S5>/Sum17' */
  real_T Coppiatheta2vel;              /* '<S5>/Coppia theta 2 vel' */
  real_T Sum5_g;                       /* '<S5>/Sum5' */
  real_T DerivativeGain;               /* '<S82>/Derivative Gain' */
  real_T Filter;                       /* '<S82>/Filter' */
  real_T SumD;                         /* '<S82>/SumD' */
  real_T FilterCoefficient;            /* '<S82>/Filter Coefficient' */
  real_T IntegralGain;                 /* '<S82>/Integral Gain' */
  real_T Integrator;                   /* '<S82>/Integrator' */
  real_T ProportionalGain;             /* '<S82>/Proportional Gain' */
  real_T Sum_h;                        /* '<S82>/Sum' */
  real_T Sum14;                        /* '<S5>/Sum14' */
  real_T DerivativeGain_b;             /* '<S83>/Derivative Gain' */
  real_T Filter_d;                     /* '<S83>/Filter' */
  real_T SumD_e;                       /* '<S83>/SumD' */
  real_T FilterCoefficient_g;          /* '<S83>/Filter Coefficient' */
  real_T IntegralGain_f;               /* '<S83>/Integral Gain' */
  real_T Integrator_d;                 /* '<S83>/Integrator' */
  real_T ProportionalGain_p;           /* '<S83>/Proportional Gain' */
  real_T Sum_n;                        /* '<S83>/Sum' */
  real_T Sum7_l;                       /* '<S5>/Sum7' */
  real_T Sum8;                         /* '<S5>/Sum8' */
  real_T selettore;                    /* '<S5>/selettore' */
  real_T TSamp_d;                      /* '<S123>/TSamp' */
  real_T Uk1_h;                        /* '<S123>/UD' */
  real_T Diff_c;                       /* '<S123>/Diff' */
  real_T TSamp_c;                      /* '<S126>/TSamp' */
  real_T Uk1_f;                        /* '<S126>/UD' */
  real_T Diff_iq;                      /* '<S126>/Diff' */
  ...
  real_T CA;                           /* '<S132>/MATLAB Function' */
  real_T CB;                           /* '<S132>/MATLAB Function' */
  real_T CH;                           /* '<S132>/MATLAB Function' */
  real_T vel_B_conv;                   /* '<S125>/Vel Asse B conv' */
  real_T vel_A_conv;                   /* '<S125>/Vel Asse A conv' */
  real_T pos_B_conv;                   /* '<S13>/Asse B conv' */
  real_T pos_B_conv_v;                 /* '<S127>/Asse B conv v' */
  real_T pos_A_conv;                   /* '<S127>/Asse A conv' */
  ...
  real_T Gain6;                        /* '<S122>/Gain6' */
  real_T Sum1_o;                       /* '<S13>/Sum1' */
  real_T Gain_h;                       /* '<S122>/Gain' */
  real_T Sum9_d;                       /* '<S122>/Sum9' */
  ...
  int32_T EtherCATPDOReceive14_l;      /* '<S125>/EtherCAT PDO Receive14' */
  int32_T EtherCATPDOReceive15_e;      /* '<S125>/EtherCAT PDO Receive15' */
  int32_T EtherCATPDOReceive15_l;      /* '<S86>/EtherCAT PDO Receive15' */
  int32_T EtherCATPDOReceive14_c;      /* '<S86>/EtherCAT PDO Receive14' */
  ...
  boolean_T EtherCATPDOReceive9;       /* '<S96>/EtherCAT PDO Receive9' */
  boolean_T EtherCATPDOReceive9_h;     /* '<S100>/EtherCAT PDO Receive9' */
  boolean_T EtherCATPDOReceive9_hd;    /* '<S104>/EtherCAT PDO Receive9' */
  boolean_T EtherCATPDOReceive9_d;     /* '<S106>/EtherCAT PDO Receive9' */
  ...
  B_AsseB_State_Flow_Test_T sf_RifermentoAsseAVite;/* '<S13>/Rifermento Asse A Vite' */
  B_AsseB_State_Flow_Test_T sf_AsseB;  /* '<S13>/Asse B' */
  B_MATLABFunction_State_Flow_l_T sf_MATLABFunction_i;/* '<S106>/MATLAB Function' */
  B_MATLABFunction_State_Flow_l_T sf_MATLABFunction_f;/* '<S104>/MATLAB Function' */
  B_MATLABFunction_State_Flow_l_T sf_MATLABFunction_a;/* '<S100>/MATLAB Function' */
  B_MATLABFunction_State_Flow_l_T sf_MATLABFunction_e;/* '<S96>/MATLAB Function' */
  B_VelAsseBconv_State_Flow_Tes_T sf_VelAsseBconv_o;/* '<S86>/Vel Asse B conv' */
  B_VelAsseAconv_State_Flow_Tes_T sf_VelAsseAconv_o;/* '<S86>/Vel Asse A conv' */
...
typedef struct {
  real_T UD_DSTATE;                    /* '<S51>/UD' */
  real_T Delay_x1_DSTATE;              /* '<S62>/Delay_x1' */
  real_T Delay_x2_DSTATE;              /* '<S62>/Delay_x2' */
  real_T UD_DSTATE_a;                  /* '<S49>/UD' */
  real_T Delay_x1_DSTATE_g;            /* '<S58>/Delay_x1' */
  real_T Delay_x2_DSTATE_m;            /* '<S58>/Delay_x2' */
  real_T UD_DSTATE_j;                  /* '<S50>/UD' */
  real_T UD_DSTATE_f;                  /* '<S52>/UD' */
  real_T Delay_x1_DSTATE_k;            /* '<S66>/Delay_x1' */
  real_T Delay_x2_DSTATE_k;            /* '<S66>/Delay_x2' */
  real_T UD_DSTATE_g;                  /* '<S53>/UD' */
  real_T UD_DSTATE_k;                  /* '<S54>/UD' */
  real_T Filter_DSTATE;                /* '<S82>/Filter' */
  real_T Integrator_DSTATE;            /* '<S82>/Integrator' */
  real_T Filter_DSTATE_d;              /* '<S83>/Filter' */
  real_T Integrator_DSTATE_a;          /* '<S83>/Integrator' */
  real_T UD_DSTATE_m;                  /* '<S123>/UD' */
  real_T UD_DSTATE_fc;                 /* '<S126>/UD' */
  real_T Memory_PreviousInput;         /* '<S96>/Memory' */
  real_T Memory_PreviousInput_o;       /* '<S100>/Memory' */
  real_T Memory_PreviousInput_g;       /* '<S104>/Memory' */
  real_T Memory_PreviousInput_h;       /* '<S106>/Memory' */
  real_T Memory_PreviousInput_hs[4];   /* '<S4>/Memory' */
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } HiddenToAsyncQueue_InsertedF_du;   /* synthesized block */
  ...
  int_T EtherCATPDOReceive9_IWORK[7];  /* '<S96>/EtherCAT PDO Receive9' */
  int_T EtherCATPDOTransmit7_IWORK[7]; /* '<S7>/EtherCAT PDO Transmit 7' */
  int_T EtherCATPDOReceive9_IWORK_n[7];/* '<S100>/EtherCAT PDO Receive9' */
  int_T EtherCATPDOReceive14_IWORK_j[7];/* '<S125>/EtherCAT PDO Receive14' */
  int_T EtherCATPDOReceive15_IWORK_e[7];/* '<S125>/EtherCAT PDO Receive15' */
  int_T Torquesend_IWORK[7];           /* '<S8>/Torque send' */
  int_T EtherCATPDOReceive9_IWORK_g[7];/* '<S104>/EtherCAT PDO Receive9' */
  int_T EtherCATPDOTransmit2_IWORK[7]; /* '<S9>/EtherCAT PDO Transmit 2' */
  int_T EtherCATPDOReceive9_IWORK_l[7];/* '<S106>/EtherCAT PDO Receive9' */
  int_T EtherCATPDOReceive15_IWORK_m[7];/* '<S86>/EtherCAT PDO Receive15' */
  int_T EtherCATPDOReceive14_IWORK_jl[7];/* '<S86>/EtherCAT PDO Receive14' */
  uint16_T temporalCounter_i1;         /* '<Root>/State flow robot' */
  int8_T Homing_SubsysRanBC;           /* '<S14>/Homing' */
  uint8_T is_active_c15_State_Flow_Test;/* '<Root>/State flow robot' */
  uint8_T is_c15_State_Flow_Test;      /* '<Root>/State flow robot' */
} DW_State_Flow_Test_T;

/* Backward compatible GRT Identifiers */
#define rtB                            State_Flow_Test_B
#define BlockIO                        B_State_Flow_Test_T
#define rtP                            State_Flow_Test_P
#define Parameters                     P_State_Flow_Test_T
#define rtDWork                        State_Flow_Test_DW
#define D_Work                         DW_State_Flow_Test_T

/* Parameters (auto storage) */
struct P_State_Flow_Test_T_ {
  ...
  real_T EtherCATPDOReceive9_P1_Size[2];/* Computed Parameter: EtherCATPDOReceive9_P1_Size
                                         * Referenced by: '<S96>/EtherCAT PDO Receive9'
                                         */
  ...
  real_T EtherCATPDOReceive9_P1_Size_m[2];/* Computed Parameter: EtherCATPDOReceive9_P1_Size_m
                                           * Referenced by: '<S100>/EtherCAT PDO Receive9'
                                           */
  ...
  real_T EtherCATPDOReceive14_P1_Size_oh[2];/* Computed Parameter: EtherCATPDOReceive14_P1_Size_oh
                                             * Referenced by: '<S125>/EtherCAT PDO Receive14'
                                             */
  ...
  real_T EtherCATPDOReceive15_P1_Size_k[2];/* Computed Parameter: EtherCATPDOReceive15_P1_Size_k
                                            * Referenced by: '<S125>/EtherCAT PDO Receive15'
                                            */
  ...
  real_T EtherCATPDOReceive15_P1_Size_h[2];/* Computed Parameter: EtherCATPDOReceive15_P1_Size_h
                                            * Referenced by: '<S86>/EtherCAT PDO Receive15'
                                            */
  ...
  real_T EtherCATPDOReceive14_P1_Size_h[2];/* Computed Parameter: EtherCATPDOReceive14_P1_Size_h
                                            * Referenced by: '<S86>/EtherCAT PDO Receive14'
                                            */
  ...
  real_T TSamp_WtEt_n;                 /* Computed Parameter: TSamp_WtEt_n
                                        * Referenced by: '<S126>/TSamp'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_State_Flow_Test_T {
  const char_T *path;
...
extern P_State_Flow_Test_T State_Flow_Test_P;

/* Block signals (auto storage) */
extern B_State_Flow_Test_T State_Flow_Test_B;

/* Block states (auto storage) */
extern DW_State_Flow_Test_T State_Flow_Test_DW;

/*====================*
 * External functions *
 *====================*/
extern State_Flow_Test_rtModel *State_Flow_Test(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  State_Flow_Test_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_State_Flow_Test_T *const State_Flow_Test_M;
 ...
 *
 * '<Root>' : 'State_Flow_Test'
 * '<S1>'   : 'State_Flow_Test/Finecorsa Vite'
 * '<S2>'   : 'State_Flow_Test/Finecorsa braccia'
 * '<S3>'   : 'State_Flow_Test/LED Status'
 * '<S4>'   : 'State_Flow_Test/Movimento'
 * '<S5>'   : 'State_Flow_Test/Movimento Braccia'
 * '<S6>'   : 'State_Flow_Test/Out Asse A Braccia'
 * '<S7>'   : 'State_Flow_Test/Out Asse B Braccia'
 * '<S8>'   : 'State_Flow_Test/Out asse A Vite'
 * '<S9>'   : 'State_Flow_Test/Out asse B Vite'
 * '<S10>'  : 'State_Flow_Test/Posizione Braccia '
 * '<S11>'  : 'State_Flow_Test/Posizione Vite'
 * '<S12>'  : 'State_Flow_Test/Sistema Braccia Linea'
 * '<S13>'  : 'State_Flow_Test/Sistema Vite'
 * '<S14>'  : 'State_Flow_Test/State flow robot'
 * '<S15>'  : 'State_Flow_Test/Status'
 * '<S16>'  : 'State_Flow_Test/Velocita vite '
 * '<S17>'  : 'State_Flow_Test/LED Status/MATLAB Function'
 * '<S18>'  : 'State_Flow_Test/LED Status/MATLAB Function1'
 * '<S19>'  : 'State_Flow_Test/LED Status/MATLAB Function2'
 * '<S20>'  : 'State_Flow_Test/Movimento/Cinematica Inversa'
 * '<S21>'  : 'State_Flow_Test/Movimento/Cinematica Inversa Acc'
 * '<S22>'  : 'State_Flow_Test/Movimento/Cinematica Inversa vel'
 * '<S23>'  : 'State_Flow_Test/Movimento/Cinematica diretta'
 * '<S24>'  : 'State_Flow_Test/Movimento/Cinematica diretta Acc'
 * '<S25>'  : 'State_Flow_Test/Movimento/Clock reale'
 * '<S26>'  : 'State_Flow_Test/Movimento/Coppia motrice'
 * '<S27>'  : 'State_Flow_Test/Movimento/Dinamica Inversa1'
 * '<S28>'  : 'State_Flow_Test/Movimento/Leggi di moto'
 * '<S29>'  : 'State_Flow_Test/Movimento/MATLAB Function'
 * '<S30>'  : 'State_Flow_Test/Movimento/MATLAB Function1'
 * '<S31>'  : 'State_Flow_Test/Movimento/MATLAB Function2'
 * '<S32>'  : 'State_Flow_Test/Movimento/MATLAB Jin'
 * '<S33>'  : 'State_Flow_Test/Movimento/Pos iniziali'
 * '<S34>'  : 'State_Flow_Test/Movimento/Posizioni'
 * '<S35>'  : 'State_Flow_Test/Movimento/Velocita '
 * '<S36>'  : 'State_Flow_Test/Movimento/Velocita vite 1'
 * '<S37>'  : 'State_Flow_Test/Movimento/XY Graph'
 * '<S38>'  : 'State_Flow_Test/Movimento/XY Graph1'
 * '<S39>'  : 'State_Flow_Test/Movimento/XZ Graph'
 * '<S40>'  : 'State_Flow_Test/Movimento/checkM'
 * '<S41>'  : 'State_Flow_Test/Movimento/Leggi di moto/Cerchi Tangenti'
 * '<S42>'  : 'State_Flow_Test/Movimento/Leggi di moto/Cerchio'
 * '<S43>'  : 'State_Flow_Test/Movimento/Leggi di moto/Quadrato'
 * '<S44>'  : 'State_Flow_Test/Movimento/Leggi di moto/g'
 * '<S45>'  : 'State_Flow_Test/Movimento/Leggi di moto/spirale'
 * '<S46>'  : 'State_Flow_Test/Movimento/Pos iniziali/Cinematica Inversa2'
 * '<S47>'  : 'State_Flow_Test/Movimento/Posizioni/Asse A conv bracc'
 * '<S48>'  : 'State_Flow_Test/Movimento/Posizioni/Asse B conv brac1'
 * '<S49>'  : 'State_Flow_Test/Movimento/Posizioni/Discrete Derivative B'
 * '<S50>'  : 'State_Flow_Test/Movimento/Posizioni/Discrete Derivative B1'
 * '<S51>'  : 'State_Flow_Test/Movimento/Posizioni/Discrete Derivative B2'
 * '<S52>'  : 'State_Flow_Test/Movimento/Posizioni/Discrete Derivative B3'
 * '<S53>'  : 'State_Flow_Test/Movimento/Posizioni/Discrete Derivative B4'
 * '<S54>'  : 'State_Flow_Test/Movimento/Posizioni/Discrete Derivative B5'
 * '<S55>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter'
 * '<S56>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter1'
 * '<S57>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter2'
 * '<S58>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter/Model'
 * '<S59>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter/Model/A*k(k-1)'
 * '<S60>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter/Model/B*(u(k)+u(k-1))'
 * '<S61>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter/Model/C*x(k)'
 * '<S62>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter1/Model'
 * '<S63>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter1/Model/A*k(k-1)'
 * '<S64>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter1/Model/B*(u(k)+u(k-1))'
 * '<S65>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter1/Model/C*x(k)'
 * '<S66>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter2/Model'
 * '<S67>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter2/Model/A*k(k-1)'
 * '<S68>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter2/Model/B*(u(k)+u(k-1))'
 * '<S69>'  : 'State_Flow_Test/Movimento/Posizioni/Second-Order Filter2/Model/C*x(k)'
 * '<S70>'  : 'State_Flow_Test/Movimento/Velocita /Vel Asse A conv'
 * '<S71>'  : 'State_Flow_Test/Movimento/Velocita /Vel Asse B conv'
 * '<S72>'  : 'State_Flow_Test/Movimento/Velocita vite 1/Vel Asse A conv'
 * '<S73>'  : 'State_Flow_Test/Movimento/Velocita vite 1/Vel Asse B conv'
 * '<S74>'  : 'State_Flow_Test/Movimento Braccia/Asse A conv brac'
 * '<S75>'  : 'State_Flow_Test/Movimento Braccia/Asse B conv brac1'
 * '<S76>'  : 'State_Flow_Test/Movimento Braccia/Cinematica Inversa'
 * '<S77>'  : 'State_Flow_Test/Movimento Braccia/Cinematica Inversa vel'
 * '<S78>'  : 'State_Flow_Test/Movimento Braccia/Cinematica Inversa1'
 * '<S79>'  : 'State_Flow_Test/Movimento Braccia/Clock reale'
 * '<S80>'  : 'State_Flow_Test/Movimento Braccia/MATLAB Function'
 * '<S81>'  : 'State_Flow_Test/Movimento Braccia/MATLAB Function1'
 * '<S82>'  : 'State_Flow_Test/Movimento Braccia/PID Controller1'
 * '<S83>'  : 'State_Flow_Test/Movimento Braccia/PID Controller2'
 * '<S84>'  : 'State_Flow_Test/Movimento Braccia/Quadrato1'
 * '<S85>'  : 'State_Flow_Test/Movimento Braccia/Subsystem'
 * '<S86>'  : 'State_Flow_Test/Movimento Braccia/Velocita vite '
 * '<S87>'  : 'State_Flow_Test/Movimento Braccia/XY Graph'
 * '<S88>'  : 'State_Flow_Test/Movimento Braccia/XZ Graph'
 * '<S89>'  : 'State_Flow_Test/Movimento Braccia/Subsystem/Cerchi Tangenti'
 * '<S90>'  : 'State_Flow_Test/Movimento Braccia/Subsystem/Cerchio'
 * '<S91>'  : 'State_Flow_Test/Movimento Braccia/Subsystem/Quadrato'
 * '<S92>'  : 'State_Flow_Test/Movimento Braccia/Subsystem/g'
 * '<S93>'  : 'State_Flow_Test/Movimento Braccia/Subsystem/spirale'
 * '<S94>'  : 'State_Flow_Test/Movimento Braccia/Velocita vite /Vel Asse A conv'
 * '<S95>'  : 'State_Flow_Test/Movimento Braccia/Velocita vite /Vel Asse B conv'
 * '<S96>'  : 'State_Flow_Test/Out Asse A Braccia/Fungo'
 * '<S97>'  : 'State_Flow_Test/Out Asse A Braccia/MATLAB Function'
 * '<S98>'  : 'State_Flow_Test/Out Asse A Braccia/Ramp'
 * '<S99>'  : 'State_Flow_Test/Out Asse A Braccia/Fungo/MATLAB Function'
 * '<S100>' : 'State_Flow_Test/Out Asse B Braccia/Fungo'
 * '<S101>' : 'State_Flow_Test/Out Asse B Braccia/MATLAB Function'
 * '<S102>' : 'State_Flow_Test/Out Asse B Braccia/Ramp'
 * '<S103>' : 'State_Flow_Test/Out Asse B Braccia/Fungo/MATLAB Function'
 * '<S104>' : 'State_Flow_Test/Out asse A Vite/Fungo'
 * '<S105>' : 'State_Flow_Test/Out asse A Vite/Fungo/MATLAB Function'
 * '<S106>' : 'State_Flow_Test/Out asse B Vite/Fungo'
 * '<S107>' : 'State_Flow_Test/Out asse B Vite/Fungo/MATLAB Function'
 * '<S108>' : 'State_Flow_Test/Sistema Braccia Linea/Asse A conv bracc2'
 * '<S109>' : 'State_Flow_Test/Sistema Braccia Linea/Asse B conv brac1'
 * '<S110>' : 'State_Flow_Test/Sistema Braccia Linea/Cinematica Inversa'
 * '<S111>' : 'State_Flow_Test/Sistema Braccia Linea/Cinematica Inversa vel'
 * '<S112>' : 'State_Flow_Test/Sistema Braccia Linea/Cinematica Inversa1'
 * '<S113>' : 'State_Flow_Test/Sistema Braccia Linea/Velocita vite '
 * '<S114>' : 'State_Flow_Test/Sistema Braccia Linea/x'
 * '<S115>' : 'State_Flow_Test/Sistema Braccia Linea/y'
 * '<S116>' : 'State_Flow_Test/Sistema Braccia Linea/Velocita vite /Vel Asse A conv'
 * '<S117>' : 'State_Flow_Test/Sistema Braccia Linea/Velocita vite /Vel Asse B conv'
 * '<S118>' : 'State_Flow_Test/Sistema Vite/Actual A'
 * '<S119>' : 'State_Flow_Test/Sistema Vite/Asse B'
 * '<S120>' : 'State_Flow_Test/Sistema Vite/Asse B conv'
 * '<S121>' : 'State_Flow_Test/Sistema Vite/Clock reale'
 * '<S122>' : 'State_Flow_Test/Sistema Vite/Coppia VIte A finale'
 * '<S123>' : 'State_Flow_Test/Sistema Vite/Discrete Derivative B'
 * '<S124>' : 'State_Flow_Test/Sistema Vite/Rifermento Asse A Vite'
 * '<S125>' : 'State_Flow_Test/Sistema Vite/Velocita vite '
 * '<S126>' : 'State_Flow_Test/Sistema Vite/Actual A/Discrete Derivative A'
 * '<S127>' : 'State_Flow_Test/Sistema Vite/Actual A/Posizione attuale Vite A'
 * '<S128>' : 'State_Flow_Test/Sistema Vite/Actual A/Posizione attuale Vite A/Asse A conv'
 * '<S129>' : 'State_Flow_Test/Sistema Vite/Actual A/Posizione attuale Vite A/Asse B conv v'
 * '<S130>' : 'State_Flow_Test/Sistema Vite/Velocita vite /Vel Asse A conv'
 * '<S131>' : 'State_Flow_Test/Sistema Vite/Velocita vite /Vel Asse B conv'
 * '<S132>' : 'State_Flow_Test/State flow robot/Homing'
 * '<S133>' : 'State_Flow_Test/State flow robot/Mov'
 * '<S134>' : 'State_Flow_Test/State flow robot/Mov1'
 * '<S135>' : 'State_Flow_Test/State flow robot/Homing/MATLAB Function'
 * '<S136>' : 'State_Flow_Test/State flow robot/Mov/Asse A conv bracc2'
 * '<S137>' : 'State_Flow_Test/State flow robot/Mov/Asse B conv brac'
 * '<S138>' : 'State_Flow_Test/State flow robot/Mov/Cinematica Inversa'
 * '<S139>' : 'State_Flow_Test/State flow robot/Mov/Cinematica Inversa vel'
 * '<S140>' : 'State_Flow_Test/State flow robot/Mov/Cinematica Inversa1'
 * '<S141>' : 'State_Flow_Test/State flow robot/Mov/x'
 * '<S142>' : 'State_Flow_Test/State flow robot/Mov/y'
 * '<S143>' : 'State_Flow_Test/State flow robot/Mov1/Asse A conv bracc'
 * '<S144>' : 'State_Flow_Test/State flow robot/Mov1/Asse A conv bracc1'
 * '<S145>' : 'State_Flow_Test/State flow robot/Mov1/Clock reale'
 * '<S146>' : 'State_Flow_Test/State flow robot/Mov1/Ldm theta1'
 * '<S147>' : 'State_Flow_Test/State flow robot/Mov1/Ldm theta2'
 * '<S148>' : 'State_Flow_Test/Velocita vite /Vel Asse A conv'
 * '<S149>' : 'State_Flow_Test/Velocita vite /Vel Asse B conv'
 */
#endif                                 /* RTW_HEADER_State_Flow_Test_h_ */
