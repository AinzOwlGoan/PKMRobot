...
#define c15_IN_Traiettoria             ((uint8_T)14U)
  ...
  *chartInstance)
{
  ...
  *chartInstance->c15_is_c15_StateFlowGUI = c15_IN_NO_ACTIVE_CHILD;
  ...
  _SFD_DATA_RANGE_CHECK(chartInstance->c15_SampleTime, 34U, 1U, 11U,
...
{
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_call_output_fcn_enable(chartInstance->S, 1, "Homing", 0);
}
...
{
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_call_output_fcn_disable(chartInstance->S, 1, "Homing", 0);
}
    ...
    switch (*chartInstance->c15_is_c15_StateFlowGUI) {
     ...
     case c15_IN_SetA:
      ...
      if (!chartInstance->c15_dataWrittenToVector[12U]) {
        _SFD_DATA_READ_BEFORE_WRITE_ERROR(3U, 5U, 8U,
          *chartInstance->c15_sfEvent, false);
      }

      if (!chartInstance->c15_dataWrittenToVector[9U]) {
        _SFD_DATA_READ_BEFORE_WRITE_ERROR(4U, 5U, 8U,
          *chartInstance->c15_sfEvent, false);
      }
      ...
      c15_out = CV_EML_IF(8, 0, 0, CV_RELATIONAL_EVAL(5U, 8U, 0,
     ...
     case c15_IN_SetB:
      ...
      if (!chartInstance->c15_dataWrittenToVector[9U]) {
        _SFD_DATA_READ_BEFORE_WRITE_ERROR(4U, 5U, 9U,
          *chartInstance->c15_sfEvent, false);
      }
      ...
      c15_b_out = CV_EML_IF(9, 0, 0, CV_RELATIONAL_EVAL(5U, 9U, 0,
     ...
     case c15_IN_SetB1:
      ...
      c15_c_out = CV_EML_IF(10, 0, 0, CV_RELATIONAL_EVAL(5U, 10U, 0,
      ...
      if (c15_c_out) {
        ...
        *chartInstance->c15_Hb = 1.0;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Hb, 31U, 4U, 2U,
                              *chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
      ...
      *chartInstance->c15_Bool = -1.0;
      ...
      if (c15_f_out) {
        ...
        *chartInstance->c15_Enable = 1.0;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Enable, 32U, 4U, 13U,
                              *chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
     ...
     case c15_IN_Step3:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_e_out, 2U, c15_b_sf_marshallOut,
        c15_b_sf_marshallIn);
      c15_e_out = CV_EML_IF(14, 0, 0, CV_RELATIONAL_EVAL(5U, 14U, 0,
      ...
      *chartInstance->c15_Bool = 0.0;
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_g_out, 2U, c15_b_sf_marshallOut,
        c15_b_sf_marshallIn);
      c15_g_out = CV_EML_IF(15, 0, 0, CV_RELATIONAL_EVAL(5U, 15U, 0,
      ...
      *chartInstance->c15_Bool = 4.0;
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_h_out, 2U, c15_b_sf_marshallOut,
        c15_b_sf_marshallIn);
      c15_h_out = CV_EML_IF(12, 0, 0, *chartInstance->c15_temporalCounter_i1 >=
                            5000);
      _SFD_SYMBOL_SCOPE_POP();
      if (c15_h_out) {
        ...
        *chartInstance->c15_FineLavorazione = 1.0;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_FineLavorazione, 33U, 4U, 0U, *
                              chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
  ...
  *chartInstance->c15_Bool = 2.0;
  ...
  if (c15_out) {
    ...
    *chartInstance->c15_OffT = *chartInstance->c15_Clock;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffT, 20U, 4U, 14U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_OffA_vite = *chartInstance->c15_posA_vite;
    chartInstance->c15_dataWrittenToVector[3U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffA_vite, 22U, 4U, 14U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_OffB_vite = *chartInstance->c15_posB_vite;
    chartInstance->c15_dataWrittenToVector[4U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffB_vite, 23U, 4U, 14U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Luci = 4.0;
    chartInstance->c15_dataWrittenToVector[10U] = true;
  ...
  *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(c15_c_fcB, 37U, 4U, 4U, *chartInstance->c15_sfEvent,
                        false);
  _SFD_DATA_RANGE_CHECK(c15_c_fcA, 36U, 4U, 4U, *chartInstance->c15_sfEvent,
                        false);
  _SFD_DATA_RANGE_CHECK(c15_c_fc, 35U, 4U, 4U, *chartInstance->c15_sfEvent,
                        false);
  _SFD_SET_DATA_VALUE_PTR(40U, (void *)&c15_b_CoppiaH);
  _SFD_SET_DATA_VALUE_PTR(39U, (void *)&c15_b_CoppiaB);
  _SFD_SET_DATA_VALUE_PTR(38U, (void *)&c15_b_CoppiaA);
  _SFD_SET_DATA_VALUE_PTR(37U, (void *)&c15_c_fcB);
  _SFD_SET_DATA_VALUE_PTR(36U, (void *)&c15_c_fcA);
  _SFD_SET_DATA_VALUE_PTR(35U, (void *)&c15_c_fc);
  ...
  *chartInstance->c15_b_fc = c15_c_fc;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_fc, 35U, 4U, 4U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_b_fcA = c15_c_fcA;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_fcA, 36U, 4U, 4U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_b_fcB = c15_c_fcB;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_fcB, 37U, 4U, 4U,
                        *chartInstance->c15_sfEvent, false);
  sf_call_output_fcn_call(chartInstance->S, 1, "Homing", 0);
  c15_b_CoppiaA = *chartInstance->c15_CA;
  chartInstance->c15_dataWrittenToVector[21U] = true;
  _SFD_DATA_RANGE_CHECK(c15_b_CoppiaA, 38U, 4U, 4U, *chartInstance->c15_sfEvent,
                        false);
  c15_b_CoppiaB = *chartInstance->c15_CB;
  chartInstance->c15_dataWrittenToVector[22U] = true;
  _SFD_DATA_RANGE_CHECK(c15_b_CoppiaB, 39U, 4U, 4U, *chartInstance->c15_sfEvent,
                        false);
  c15_b_CoppiaH = *chartInstance->c15_CH;
  chartInstance->c15_dataWrittenToVector[23U] = true;
  _SFD_DATA_RANGE_CHECK(c15_b_CoppiaH, 40U, 4U, 4U, *chartInstance->c15_sfEvent,
                        false);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *chartInstance->c15_Hv = 0.0;
  chartInstance->c15_dataWrittenToVector[17U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Hv, 30U, 4U, 3U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_FineLavorazione = 0.0;
  chartInstance->c15_dataWrittenToVector[20U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_FineLavorazione, 33U, 4U, 3U,
                        *chartInstance->c15_sfEvent, false);
  _SFD_SYMBOL_SCOPE_POP();
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2899338987U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1686660256U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1137838795U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2726318131U);
}
...
mxArray *sf_c15_StateFlowGUI_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("6AsHf7caO4zLhjgQbQZtYE");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(34,7,0,0,"SampleTime");
        ...
        _SFD_CV_INIT_EML_IF(16,0,0,1,31,1,31);

        {
          ...
          _SFD_CV_INIT_EML_MCDC(16,0,0,1,31,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(34U, (void *)&chartInstance->c15_SampleTime);
        ...
        _SFD_SET_DATA_VALUE_PTR(33U, (void *)chartInstance->c15_FineLavorazione);
      }
    }
  }
}
...
{
  return "shieYlfugBHIuIsfvgEoUCD";
}
...
static void mdlSetWorkWidths_c15_StateFlowGUI(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2237060190U));
  ssSetChecksum1(S,(2110614658U));
  ssSetChecksum2(S,(3706980820U));
  ssSetChecksum3(S,(1171126553U));
