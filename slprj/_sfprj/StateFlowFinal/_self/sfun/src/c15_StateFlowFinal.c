  ...
  *chartInstance)
{
  ...
  *chartInstance->c15_is_c15_StateFlowFinal = c15_IN_NO_ACTIVE_CHILD;
  ...
  _SFD_DATA_RANGE_CHECK(chartInstance->c15_SampleTime, 38U, 1U, 12U,
...
{
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_call_output_fcn_enable(chartInstance->S, 0, "Setting", 0);
}
...
{
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_call_output_fcn_disable(chartInstance->S, 0, "Setting", 0);
}
  ...
  chartInstance)
{
  ...
  if (*chartInstance->c15_is_active_c15_StateFlowFinal == 0U) {
    ...
    *chartInstance->c15_Bool = -1.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Bool, 20U, 4U, 12U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    switch (*chartInstance->c15_is_c15_StateFlowFinal) {
      ...
      *chartInstance->c15_Bool = 2.0;
      ...
      if (c15_g_out) {
        ...
        *chartInstance->c15_OffT = *chartInstance->c15_Clock;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffT, 21U, 4U, 1U,
                              *chartInstance->c15_sfEvent, false);
        *chartInstance->c15_Luci = 4.0;
        chartInstance->c15_dataWrittenToVector[10U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Luci, 29U, 4U, 1U,
                              *chartInstance->c15_sfEvent, false);
        *chartInstance->c15_Bool = 4.0;
        chartInstance->c15_dataWrittenToVector[0U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Bool, 20U, 4U, 1U,
                              *chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
     ...
     case c15_IN_SetA:
      ...
      if (c15_out) {
        ...
        *chartInstance->c15_CoppiaB = 0.0;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaB, 28U, 4U, 10U,
                              *chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
     ...
     case c15_IN_SetA1:
      ...
      if (!chartInstance->c15_dataWrittenToVector[8U]) {
        _SFD_DATA_READ_BEFORE_WRITE_ERROR(28U, 5U, 8U,
          *chartInstance->c15_sfEvent, false);
      }
      ...
      if (c15_b_out) {
        ...
        *chartInstance->c15_OffA_vite = *chartInstance->c15_posA_vite;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffA_vite, 23U, 4U, 3U,
                              *chartInstance->c15_sfEvent, false);
        *chartInstance->c15_CoppiaH = 0.0;
        chartInstance->c15_dataWrittenToVector[2U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaH, 22U, 4U, 3U,
                              *chartInstance->c15_sfEvent, false);
        *chartInstance->c15_Hb = 1.0;
        chartInstance->c15_dataWrittenToVector[16U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Hb, 32U, 4U, 3U,
                              *chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
     ...
     case c15_IN_SetB:
      ...
      if (c15_c_out) {
        ...
        *chartInstance->c15_CoppiaA = 0.0;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaA, 27U, 4U, 8U,
                              *chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
     ...
     case c15_IN_SetB1:
      ...
      if (!chartInstance->c15_dataWrittenToVector[7U]) {
        _SFD_DATA_READ_BEFORE_WRITE_ERROR(27U, 5U, 7U,
          *chartInstance->c15_sfEvent, false);
      }
      ...
      *chartInstance->c15_Bool = -1.0;
      ...
      if (c15_e_out) {
        ...
        *chartInstance->c15_Bool = 0.0;
        chartInstance->c15_dataWrittenToVector[0U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Bool, 20U, 4U, 0U,
                              *chartInstance->c15_sfEvent, false);
        *chartInstance->c15_Enable = 1.0;
        chartInstance->c15_dataWrittenToVector[17U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Enable, 33U, 4U, 0U,
                              *chartInstance->c15_sfEvent, false);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
...
static void c15_Discesa_Vite(SFc15_StateFlowFinalInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_CoppiaH = 0.0;
  chartInstance->c15_dataWrittenToVector[2U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaH, 22U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_CoppiaA = 0.0;
  chartInstance->c15_dataWrittenToVector[7U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaA, 27U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_CoppiaB = 0.0;
  chartInstance->c15_dataWrittenToVector[8U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaB, 28U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_OffA = *chartInstance->c15_posA;
  chartInstance->c15_dataWrittenToVector[5U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffA, 25U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_OffB = *chartInstance->c15_posB;
  chartInstance->c15_dataWrittenToVector[6U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffB, 26U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  ...
  *chartInstance->c15_Bool = 2.0;
  chartInstance->c15_dataWrittenToVector[0U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Bool, 20U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_Luci = 3.0;
  chartInstance->c15_dataWrittenToVector[10U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Luci, 29U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_Hv = 1.0;
  chartInstance->c15_dataWrittenToVector[15U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Hv, 31U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_OffA_vite = *chartInstance->c15_posA_vite;
  chartInstance->c15_dataWrittenToVector[3U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffA_vite, 23U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_OffB_vite = *chartInstance->c15_posB_vite;
  chartInstance->c15_dataWrittenToVector[4U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffB_vite, 24U, 4U, 6U,
                        *chartInstance->c15_sfEvent, false);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *chartInstance->c15_Bool = 4.0;
  ...
  if (c15_out) {
    ...
    *chartInstance->c15_Bool = 5.0;
    chartInstance->c15_dataWrittenToVector[0U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Bool, 20U, 4U, 4U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Luci = 5.0;
    chartInstance->c15_dataWrittenToVector[10U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Luci, 29U, 4U, 4U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_b_FineLavorazione = 1.0;
    chartInstance->c15_dataWrittenToVector[18U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_FineLavorazione, 34U, 4U, 4U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Hv = 0.0;
    chartInstance->c15_dataWrittenToVector[15U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Hv, 31U, 4U, 4U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Hb = 0.0;
    chartInstance->c15_dataWrittenToVector[16U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Hb, 32U, 4U, 4U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    ...
    if (c15_b_out) {
      ...
      *chartInstance->c15_Bool = 3.0;
      chartInstance->c15_dataWrittenToVector[0U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Bool, 20U, 4U, 13U,
                            *chartInstance->c15_sfEvent, false);
      *chartInstance->c15_CoppiaA = 0.0;
      chartInstance->c15_dataWrittenToVector[7U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaA, 27U, 4U, 13U,
                            *chartInstance->c15_sfEvent, false);
      *chartInstance->c15_CoppiaB = 0.0;
      chartInstance->c15_dataWrittenToVector[8U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaB, 28U, 4U, 13U,
                            *chartInstance->c15_sfEvent, false);
      *chartInstance->c15_CoppiaH = 0.0;
      chartInstance->c15_dataWrittenToVector[2U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaH, 22U, 4U, 13U,
                            *chartInstance->c15_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
  ...
  *chartInstance)
{
  ...
  *chartInstance->c15_Bool = 1.0;
  chartInstance->c15_dataWrittenToVector[0U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Bool, 20U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  ...
  *chartInstance->c15_Luci = 1.0;
  chartInstance->c15_dataWrittenToVector[10U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Luci, 29U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_Kp = *chartInstance->c15_KP;
  chartInstance->c15_dataWrittenToVector[14U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Kp, 30U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_Hb = 0.0;
  chartInstance->c15_dataWrittenToVector[16U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Hb, 32U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_Hv = 0.0;
  chartInstance->c15_dataWrittenToVector[15U] = true;
  ...
  *chartInstance->c15_b_FineLavorazione = 0.0;
  chartInstance->c15_dataWrittenToVector[18U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_FineLavorazione, 34U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  if (!chartInstance->c15_dataWrittenToVector[9U]) {
  ...
  *chartInstance->c15_PosRifA = c15_hoistedGlobal * c15_y;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_PosRifA, 35U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  if (!chartInstance->c15_dataWrittenToVector[9U]) {
    _SFD_DATA_READ_BEFORE_WRITE_ERROR(2U, 4U, 5U, *chartInstance->c15_sfEvent,
      false);
  ...
  *chartInstance->c15_PosRifB = c15_c_hoistedGlobal * c15_b_y;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_PosRifB, 36U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_CoppiaH = -600.0;
  chartInstance->c15_dataWrittenToVector[2U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaH, 22U, 4U, 5U,
                        *chartInstance->c15_sfEvent, false);
  _SFD_SYMBOL_SCOPE_POP();
}
...
static void c15_Home(SFc15_StateFlowFinalInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_Bool = 1.0;
  ...
  if (CV_EML_COND(15, 0, 0, CV_RELATIONAL_EVAL(5U, 15U, 0,
      ...
      CV_EML_COND(15, 0, 3, CV_RELATIONAL_EVAL(5U, 15U, 3,
        *chartInstance->c15_HomeSignal, 1.0, -1, 0U,
  ...
  if (c15_out) {
    ...
    *chartInstance->c15_CoppiaA = 250.0;
    chartInstance->c15_dataWrittenToVector[7U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaA, 27U, 4U, 2U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_CoppiaB = 250.0;
    chartInstance->c15_dataWrittenToVector[8U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaB, 28U, 4U, 2U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_CoppiaH = 0.0;
    chartInstance->c15_dataWrittenToVector[2U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaH, 22U, 4U, 2U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Luci = 2.0;
    chartInstance->c15_dataWrittenToVector[10U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Luci, 29U, 4U, 2U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    ...
    *chartInstance->c15_PosRifA -= 0.015;
    chartInstance->c15_dataWrittenToVector[19U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_PosRifA, 35U, 4U, 5U,
                          *chartInstance->c15_sfEvent, false);
    if (!chartInstance->c15_dataWrittenToVector[20U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(36U, 4U, 5U, *chartInstance->c15_sfEvent,
        false);
    }

    *chartInstance->c15_PosRifB -= 0.015;
    chartInstance->c15_dataWrittenToVector[20U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_PosRifB, 36U, 4U, 5U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Stato = 0.0;
    chartInstance->c15_dataWrittenToVector[21U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Stato, 37U, 4U, 5U,
                          *chartInstance->c15_sfEvent, false);
    if (!chartInstance->c15_dataWrittenToVector[19U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(35U, 4U, 5U, *chartInstance->c15_sfEvent,
        false);
    ...
    if (!chartInstance->c15_dataWrittenToVector[14U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(30U, 4U, 5U, *chartInstance->c15_sfEvent,
        false);
    }
    ...
    c15_g_hoistedGlobal = *chartInstance->c15_posB;
    c15_h_hoistedGlobal = *chartInstance->c15_Kp;
    ...
    c15_c_posA = c15_f_hoistedGlobal;
    c15_c_posB = c15_g_hoistedGlobal;
    c15_c_Kp = c15_h_hoistedGlobal;
    _SFD_DATA_RANGE_CHECK(c15_c_Kp, 46U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    _SFD_DATA_RANGE_CHECK(c15_c_posB, 45U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    _SFD_DATA_RANGE_CHECK(c15_c_posA, 44U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    _SFD_DATA_RANGE_CHECK(c15_b_posrifB, 43U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_DATA_RANGE_CHECK(c15_b_posrifA, 42U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_DATA_RANGE_CHECK(c15_b_Fcb, 41U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    _SFD_DATA_RANGE_CHECK(c15_b_Fca, 40U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    _SFD_DATA_RANGE_CHECK(c15_b_Fc, 39U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    _SFD_SET_DATA_VALUE_PTR(49U, (void *)&c15_d0);
    _SFD_SET_DATA_VALUE_PTR(48U, (void *)&c15_d1);
    _SFD_SET_DATA_VALUE_PTR(47U, (void *)&c15_d2);
    _SFD_SET_DATA_VALUE_PTR(46U, (void *)&c15_c_Kp);
    _SFD_SET_DATA_VALUE_PTR(45U, (void *)&c15_c_posB);
    _SFD_SET_DATA_VALUE_PTR(44U, (void *)&c15_c_posA);
    _SFD_SET_DATA_VALUE_PTR(43U, (void *)&c15_b_posrifB);
    _SFD_SET_DATA_VALUE_PTR(42U, (void *)&c15_b_posrifA);
    _SFD_SET_DATA_VALUE_PTR(41U, (void *)&c15_b_Fcb);
    _SFD_SET_DATA_VALUE_PTR(40U, (void *)&c15_b_Fca);
    _SFD_SET_DATA_VALUE_PTR(39U, (void *)&c15_b_Fc);
    _SFD_CS_CALL(FUNCTION_ACTIVE_TAG, 11U, *chartInstance->c15_sfEvent);
    ...
    _SFD_SYMBOL_SCOPE_ADD_IMPORTABLE("posrifB", &c15_b_posrifB,
      c15_sf_marshallOut, c15_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_IMPORTABLE("posA", &c15_c_posA, c15_sf_marshallOut,
      c15_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_IMPORTABLE("posB", &c15_c_posB, c15_sf_marshallOut,
      c15_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_IMPORTABLE("Kp", &c15_c_Kp, c15_sf_marshallOut,
      c15_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_IMPORTABLE("CA", &c15_d2, c15_sf_marshallOut,
      c15_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_IMPORTABLE("CB", &c15_d1, c15_sf_marshallOut,
      c15_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_IMPORTABLE("CH", &c15_d0, c15_sf_marshallOut,
      c15_sf_marshallIn);
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 11U,
                 *chartInstance->c15_sfEvent);
    *chartInstance->c15_Fc = c15_b_Fc;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Fc, 39U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Fca = c15_b_Fca;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Fca, 40U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Fcb = c15_b_Fcb;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Fcb, 41U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_posrifA = c15_b_posrifA;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_posrifA, 42U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_posrifB = c15_b_posrifB;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_posrifB, 43U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_b_posA = c15_c_posA;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_posA, 44U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_b_posB = c15_c_posB;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_posB, 45U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_b_Kp = c15_c_Kp;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_b_Kp, 46U, 4U, 11U,
                          *chartInstance->c15_sfEvent, false);
    sf_call_output_fcn_call(chartInstance->S, 0, "Setting", 0);
    c15_d2 = *chartInstance->c15_CA;
    chartInstance->c15_dataWrittenToVector[22U] = true;
    _SFD_DATA_RANGE_CHECK(c15_d2, 47U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    c15_d1 = *chartInstance->c15_CB;
    chartInstance->c15_dataWrittenToVector[23U] = true;
    _SFD_DATA_RANGE_CHECK(c15_d1, 48U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    c15_d0 = *chartInstance->c15_CH;
    chartInstance->c15_dataWrittenToVector[24U] = true;
    _SFD_DATA_RANGE_CHECK(c15_d0, 49U, 4U, 11U, *chartInstance->c15_sfEvent,
                          false);
    _SFD_SYMBOL_SCOPE_POP();
    _SFD_CS_CALL(FUNCTION_INACTIVE_TAG, 11U, *chartInstance->c15_sfEvent);
    ...
    *chartInstance->c15_CoppiaA = c15_d3;
    chartInstance->c15_dataWrittenToVector[7U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaA, 27U, 4U, 5U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_CoppiaB = c15_d4;
    chartInstance->c15_dataWrittenToVector[8U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaB, 28U, 4U, 5U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_CoppiaH = c15_d5;
    ...
    sf_mex_printf("%s =\\n", "CoppiaA");
    c15_i_hoistedGlobal = *chartInstance->c15_CoppiaA;
    c15_y = NULL;
    sf_mex_assign(&c15_y, sf_mex_create("y", &c15_i_hoistedGlobal, 0, 0U, 0U, 0U,
      0), false);
    sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c15_y);
    if (!chartInstance->c15_dataWrittenToVector[8U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(28U, 4U, 5U, *chartInstance->c15_sfEvent,
        false);
    }

    sf_mex_printf("%s =\\n", "CoppiaB");
    c15_j_hoistedGlobal = *chartInstance->c15_CoppiaB;
    c15_b_y = NULL;
    sf_mex_assign(&c15_b_y, sf_mex_create("y", &c15_j_hoistedGlobal, 0, 0U, 0U,
      0U, 0), false);
    sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c15_b_y);
    if (!chartInstance->c15_dataWrittenToVector[2U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(22U, 4U, 5U, *chartInstance->c15_sfEvent,
        false);
    }

    sf_mex_printf("%s =\\n", "CoppiaH");
    c15_k_hoistedGlobal = *chartInstance->c15_CoppiaH;
    c15_c_y = NULL;
    sf_mex_assign(&c15_c_y, sf_mex_create("y", &c15_k_hoistedGlobal, 0, 0U, 0U,
      0U, 0), false);
...
static void c15_Coppie(SFc15_StateFlowFinalInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_Luci = 2.0;
  ...
  if (c15_out) {
    ...
    *chartInstance->c15_CoppiaA = 0.0;
    chartInstance->c15_dataWrittenToVector[7U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaA, 27U, 4U, 7U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    ...
    if (c15_b_out) {
      ...
      *chartInstance->c15_CoppiaB = 0.0;
      chartInstance->c15_dataWrittenToVector[8U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c15_CoppiaB, 28U, 4U, 9U,
                            *chartInstance->c15_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_b_posB = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 25);
  chartInstance->c15_b_Kp = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 26);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1163936673U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2147716081U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2359259104U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1888671065U);
}
...
mxArray *sf_c15_StateFlowFinal_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("BWC3DPgi1uGMwX2K3XlLFG");
...
static const mxArray *sf_get_sim_state_info_c15_StateFlowFinal(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x6'type','srcId','name','auxInfo'{{M[3],M[137],T\"conv\",},{M[3],M[178],T\"conv_vite\",},{M[8],M[0],T\"is_active_c15_StateFlowFinal\",},{M[9],M[0],T\"is_c15_StateFlowFinal\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M1x2[147 69],M[1]}}},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(20,2,0,1,"Bool");
          _SFD_SET_DATA_PROPS(21,2,0,1,"OffT");
          _SFD_SET_DATA_PROPS(22,2,0,1,"CoppiaH");
          _SFD_SET_DATA_PROPS(23,2,0,1,"OffA_vite");
          _SFD_SET_DATA_PROPS(24,2,0,1,"OffB_vite");
          _SFD_SET_DATA_PROPS(25,2,0,1,"OffA");
          _SFD_SET_DATA_PROPS(26,2,0,1,"OffB");
          _SFD_SET_DATA_PROPS(27,2,0,1,"CoppiaA");
          _SFD_SET_DATA_PROPS(28,2,0,1,"CoppiaB");
          _SFD_SET_DATA_PROPS(29,2,0,1,"Luci");
          _SFD_SET_DATA_PROPS(30,2,0,1,"Kp");
          _SFD_SET_DATA_PROPS(31,2,0,1,"Hv");
          _SFD_SET_DATA_PROPS(32,2,0,1,"Hb");
          _SFD_SET_DATA_PROPS(33,2,0,1,"Enable");
          _SFD_SET_DATA_PROPS(34,2,0,1,"FineLavorazione");
          _SFD_SET_DATA_PROPS(35,2,0,1,"PosRifA");
          _SFD_SET_DATA_PROPS(36,2,0,1,"PosRifB");
          _SFD_SET_DATA_PROPS(37,2,0,1,"Stato");
          _SFD_SET_DATA_PROPS(38,7,0,0,"SampleTime");
        ...
        _SFD_CV_INIT_EML(15,0,0,0,1,0,0,0,0,0,4,1);
        _SFD_CV_INIT_EML_IF(15,0,0,1,50,1,48);

        {
          ...
          _SFD_CV_INIT_EML_MCDC(15,0,0,1,50,4,0,&(condStart[0]),&(condEnd[0]),7,
                                &(pfixExpr[0]));
        }
        ...
        _SFD_CV_INIT_EML_RELATIONAL(15,0,3,35,50,-1,0);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(38U, (void *)&chartInstance->c15_SampleTime);
        ...
        _SFD_SET_DATA_VALUE_PTR(20U, (void *)chartInstance->c15_Bool);
        _SFD_SET_DATA_VALUE_PTR(21U, (void *)chartInstance->c15_OffT);
        _SFD_SET_DATA_VALUE_PTR(22U, (void *)chartInstance->c15_CoppiaH);
        _SFD_SET_DATA_VALUE_PTR(23U, (void *)chartInstance->c15_OffA_vite);
        _SFD_SET_DATA_VALUE_PTR(24U, (void *)chartInstance->c15_OffB_vite);
        _SFD_SET_DATA_VALUE_PTR(25U, (void *)chartInstance->c15_OffA);
        _SFD_SET_DATA_VALUE_PTR(26U, (void *)chartInstance->c15_OffB);
        _SFD_SET_DATA_VALUE_PTR(27U, (void *)chartInstance->c15_CoppiaA);
        _SFD_SET_DATA_VALUE_PTR(28U, (void *)chartInstance->c15_CoppiaB);
        ...
        _SFD_SET_DATA_VALUE_PTR(29U, (void *)chartInstance->c15_Luci);
        ...
        _SFD_SET_DATA_VALUE_PTR(30U, (void *)chartInstance->c15_Kp);
        _SFD_SET_DATA_VALUE_PTR(13U, (void *)chartInstance->c15_KP);
        _SFD_SET_DATA_VALUE_PTR(31U, (void *)chartInstance->c15_Hv);
        _SFD_SET_DATA_VALUE_PTR(32U, (void *)chartInstance->c15_Hb);
        ...
        _SFD_SET_DATA_VALUE_PTR(33U, (void *)chartInstance->c15_Enable);
        ...
        _SFD_SET_DATA_VALUE_PTR(35U, (void *)chartInstance->c15_PosRifA);
        _SFD_SET_DATA_VALUE_PTR(36U, (void *)chartInstance->c15_PosRifB);
        _SFD_SET_DATA_VALUE_PTR(37U, (void *)chartInstance->c15_Stato);
...
{
  return "sWBjbDGhtZCbr6IL5axXojD";
}
...
static void mdlSetWorkWidths_c15_StateFlowFinal(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...

    {
      ...
      for (outPortIdx=1; outPortIdx<=26; ++outPortIdx) {
  ...
  ssSetChecksum0(S,(4069679668U));
  ssSetChecksum1(S,(2773818888U));
  ssSetChecksum2(S,(566539125U));
  ssSetChecksum3(S,(2458948179U));
