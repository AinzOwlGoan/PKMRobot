...
#include "StateflowKalman_sfun.h"
#include "c15_StateflowKalman.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "StateflowKalman_sfun_debug_macros.h"
...
static void initialize_c15_StateflowKalman(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void initialize_params_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void enable_c15_StateflowKalman(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void disable_c15_StateflowKalman(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void c15_update_debugger_state_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void ext_mode_exec_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void set_sim_state_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance, const mxArray *c15_st);
static void c15_set_sim_state_side_effects_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void finalize_c15_StateflowKalman(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void sf_gateway_c15_StateflowKalman(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void mdl_start_c15_StateflowKalman(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void c15_chartstep_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void initSimStructsc15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void c15_Discesa_Vite(SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void c15_Controllo(SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void c15_Attivazione(SFc15_StateflowKalmanInstanceStruct *chartInstance);
static void c15_enter_atomic_Home(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void c15_Home(SFc15_StateflowKalmanInstanceStruct *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_nargout, const char_T *c15_identifier);
static real_T c15_b_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static boolean_T c15_c_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_c_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_d_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_e_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_StateflowKalman, const
  char_T *c15_identifier);
static uint8_T c15_f_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static uint16_T c15_g_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_b_temporalCounter_i1, const char_T
  *c15_identifier);
static uint16_T c15_h_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_i_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_b_dataWrittenToVector, const char_T
  *c15_identifier, boolean_T c15_y[27]);
static void c15_j_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  boolean_T c15_y[27]);
static const mxArray *c15_k_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_b_setSimStateSideEffectsInfo, const char_T *
  c15_identifier);
static const mxArray *c15_l_emlrt_marshallIn(SFc15_StateflowKalmanInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc15_StateflowKalmanInstanceStruct *chartInstance, int32_T c15_ssid);
static void c15_init_sf_message_store_memory(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc15_StateflowKalmanInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc15_StateflowKalman(chartInstance);
  ...
  *chartInstance->c15_temporalCounter_i1 = 0U;
  *chartInstance->c15_is_active_c15_StateflowKalman = 0U;
  *chartInstance->c15_is_c15_StateflowKalman = c15_IN_NO_ACTIVE_CHILD;
...
static void ext_mode_exec_c15_StateflowKalman
  (SFc15_StateflowKalmanInstanceStruct *chartInstance)
{
  c15_update_debugger_state_c15_StateflowKalman(chartInstance);
}
  ...
  (SFc15_StateflowKalmanInstanceStruct *chartInstance)
{
  ...
  c15_w_hoistedGlobal = *chartInstance->c15_is_active_c15_StateflowKalman;
  c15_x_y = NULL;
  sf_mex_assign(&c15_x_y, sf_mex_create("y", &c15_w_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c15_y, 22, c15_x_y);
  c15_x_hoistedGlobal = *chartInstance->c15_is_c15_StateflowKalman;
  c15_y_y = NULL;
  ...
  (SFc15_StateflowKalmanInstanceStruct *chartInstance, const mxArray *c15_st)
{
  ...
  *chartInstance->c15_is_active_c15_StateflowKalman = c15_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c15_StateflowKalman",
       c15_u, 22)), "is_active_c15_StateflowKalman");
  *chartInstance->c15_is_c15_StateflowKalman = c15_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_c15_StateflowKalman", c15_u,
       23)), "is_c15_StateflowKalman");
...
static void sf_gateway_c15_StateflowKalman(SFc15_StateflowKalmanInstanceStruct
  *chartInstance)
{
  c15_set_sim_state_side_effects_c15_StateflowKalman(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_Clock, 5U, 1U, 0U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_sfEvent = CALL_EVENT;
  c15_chartstep_c15_StateflowKalman(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_StateflowKalmanMachineNumber_,
  ...
  (SFc15_StateflowKalmanInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c15_is_active_c15_StateflowKalman == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 12U,
                 *chartInstance->c15_sfEvent);
    *chartInstance->c15_is_active_c15_StateflowKalman = 1U;
    ...
    *chartInstance->c15_is_c15_StateflowKalman = c15_IN_Step1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c15_sfEvent);
    ...
    *chartInstance->c15_Bool = -1.0;
    ...
    switch (*chartInstance->c15_is_c15_StateflowKalman) {
      ...
      *chartInstance->c15_Bool = 5.0;
      ...
      if (c15_e_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c15_sfEvent);
        *chartInstance->c15_is_c15_StateflowKalman = c15_IN_Home;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c15_sfEvent);
      ...
      *chartInstance->c15_Luci = 2.0;
      ...
      if (c15_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, *chartInstance->c15_sfEvent);
        *chartInstance->c15_is_c15_StateflowKalman = c15_IN_Discesa_Vite;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c15_sfEvent);
        ...
        *chartInstance->c15_OffA_vite = *chartInstance->c15_posA_vite;
        ...
        _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffA_vite, 25U, 4U, 2U,
                              *chartInstance->c15_sfEvent, false);
        *chartInstance->c15_CoppiaH = 500.0;
      ...
      *chartInstance->c15_Bool = 2.0;
      ...
      if (c15_d_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 6U, *chartInstance->c15_sfEvent);
        *chartInstance->c15_is_c15_StateflowKalman = c15_IN_Controllo;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c15_sfEvent);
        *chartInstance->c15_temporalCounter_i1 = 0U;
      ...
      *chartInstance->c15_Bool = -1.0;
      ...
      if (c15_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 9U, *chartInstance->c15_sfEvent);
        *chartInstance->c15_is_c15_StateflowKalman = c15_IN_Attivazione;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c15_sfEvent);
...
static void c15_Discesa_Vite(SFc15_StateflowKalmanInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_Hb = 1.0;
  chartInstance->c15_dataWrittenToVector[15U] = true;
  _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 4U, *chartInstance->c15_sfEvent);
  ...
  if (!chartInstance->c15_dataWrittenToVector[3U]) {
    _SFD_DATA_READ_BEFORE_WRITE_ERROR(25U, 5U, 4U, *chartInstance->c15_sfEvent,
      false);
  }

  if (!chartInstance->c15_dataWrittenToVector[21U]) {
    _SFD_DATA_READ_BEFORE_WRITE_ERROR(4U, 5U, 4U, *chartInstance->c15_sfEvent,
      false);
  }

  if (!chartInstance->c15_dataWrittenToVector[13U]) {
    _SFD_DATA_READ_BEFORE_WRITE_ERROR(3U, 5U, 4U, *chartInstance->c15_sfEvent,
      false);
  }

  c15_hoistedGlobal = *chartInstance->c15_posA_vite;
  c15_b_hoistedGlobal = *chartInstance->c15_OffA_vite;
  c15_c_hoistedGlobal = *chartInstance->c15_dv;
  c15_d_hoistedGlobal = *chartInstance->c15_conv_vite;
  c15_A = c15_c_hoistedGlobal;
  c15_B = c15_d_hoistedGlobal;
  c15_x = c15_A;
  c15_y = c15_B;
  c15_b_x = c15_x;
  c15_b_y = c15_y;
  c15_c_y = c15_b_x / c15_b_y;
  c15_e_hoistedGlobal = *chartInstance->c15_posA_vite;
  c15_f_hoistedGlobal = *chartInstance->c15_OffA_vite;
  c15_g_hoistedGlobal = *chartInstance->c15_dv;
  c15_h_hoistedGlobal = *chartInstance->c15_conv_vite;
  c15_b_A = c15_g_hoistedGlobal;
  c15_b_B = c15_h_hoistedGlobal;
  c15_c_x = c15_b_A;
  c15_d_y = c15_b_B;
  c15_d_x = c15_c_x;
  c15_e_y = c15_d_y;
  c15_f_y = c15_d_x / c15_e_y;
  c15_out = CV_EML_IF(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0, c15_hoistedGlobal -
    c15_b_hoistedGlobal, c15_c_y, -1, 5U, c15_e_hoistedGlobal -
    c15_f_hoistedGlobal >= c15_f_y));
  _SFD_SYMBOL_SCOPE_POP();
  if (c15_out) {
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 4U, *chartInstance->c15_sfEvent);
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c15_sfEvent);
    *chartInstance->c15_is_c15_StateflowKalman = c15_IN_OffSet;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, *chartInstance->c15_sfEvent);
...
static void c15_Controllo(SFc15_StateflowKalmanInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_Bool = 4.0;
  ...
  if (c15_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c15_sfEvent);
    *chartInstance->c15_is_c15_StateflowKalman = c15_IN_FineLavorazione;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c15_sfEvent);
    *chartInstance->c15_temporalCounter_i1 = 0U;
    ...
    *chartInstance->c15_Hb = 0.0;
    ...
    if (c15_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c15_sfEvent);
      *chartInstance->c15_is_c15_StateflowKalman = c15_IN_StopPhase;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, *chartInstance->c15_sfEvent);
...
static void c15_Home(SFc15_StateflowKalmanInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_Bool = 1.0;
  ...
  if (c15_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c15_sfEvent);
    *chartInstance->c15_is_c15_StateflowKalman = c15_IN_HomeDef;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, *chartInstance->c15_sfEvent);
    ...
    *chartInstance->c15_OffB_0 = *chartInstance->c15_posB;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_OffB_0, 1U, 4U, 5U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_dv = *chartInstance->c15_DiscVite * 0.01;
    chartInstance->c15_dataWrittenToVector[21U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_dv, 4U, 4U, 5U,
                          *chartInstance->c15_sfEvent, false);
    *chartInstance->c15_Luci = 2.0;
    chartInstance->c15_dataWrittenToVector[10U] = true;
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_StateflowKalmanInstanceStruct *chartInstance;
  chartInstance = (SFc15_StateflowKalmanInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_StateflowKalman_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c15_identifier)
{
  ...
  c15_y = c15_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_StateflowKalman), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_StateflowKalman);
  return c15_y;
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_StateflowKalman = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c15_is_c15_StateflowKalman = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c15_StateflowKalman_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4089822331U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3778045358U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2901793400U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(374065995U);
}

mxArray* sf_c15_StateflowKalman_get_post_codegen_info(void);
mxArray *sf_c15_StateflowKalman_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("TTOZQqjJ9W3H9R4c59VjtF");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c15_StateflowKalman_get_post_codegen_info();
...
mxArray *sf_c15_StateflowKalman_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_StateflowKalman_jit_fallback_info(void)
{
...
mxArray *sf_c15_StateflowKalman_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_StateflowKalman(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x6'type','srcId','name','auxInfo'{{M[3],M[178],T\"conv_vite\",},{M[3],M[335],T\"dv\",},{M[8],M[0],T\"is_active_c15_StateflowKalman\",},{M[9],M[0],T\"is_c15_StateflowKalman\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M1x2[147 69],M[1]}}},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 26, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_StateflowKalman_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc15_StateflowKalmanInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc15_StateflowKalmanInstanceStruct *chartInstance =
      (SFc15_StateflowKalmanInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _StateflowKalmanMachineNumber_,
           15,
           11,
           11,
           0,
        ...
        init_script_number_translation(_StateflowKalmanMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_StateflowKalmanMachineNumber_,
        ...
        _SFD_CV_INIT_EML_RELATIONAL(4,0,0,1,38,-1,5);
        _SFD_CV_INIT_EML(10,0,0,0,1,0,0,0,0,0,3,1);
        _SFD_CV_INIT_EML_IF(10,0,0,1,48,1,48);

        {
          static int condStart[] = { 1, 17, 33 };

          static int condEnd[] = { 13, 29, 48 };

          static int pfixExpr[] = { 0, 1, -3, 2, -3 };

          _SFD_CV_INIT_EML_MCDC(10,0,0,1,48,3,0,&(condStart[0]),&(condEnd[0]),5,
                                &(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(10,0,0,1,13,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(10,0,1,17,29,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(10,0,2,33,48,-1,0);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _StateflowKalmanMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "sdPtOfjVTp7BiUvvo3a7ysB";
}
...
static void sf_check_dwork_consistency(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    mxArray *infoStruct = load_StateflowKalman_optimization_info
...
static void sf_opaque_initialize_c15_StateflowKalman(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar);
  initialize_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_StateflowKalman(void *chartInstanceVar)
{
  enable_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c15_StateflowKalman(void *chartInstanceVar)
{
  disable_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c15_StateflowKalman(void *chartInstanceVar)
{
  sf_gateway_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c15_StateflowKalman(void *chartInstanceVar)
{
  ext_mode_exec_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c15_StateflowKalman(SimStruct* S)
{
  return get_sim_state_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c15_StateflowKalman(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c15_StateflowKalman(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_StateflowKalmanInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_StateflowKalman_optimization_info();
    }

    finalize_c15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_StateflowKalman((SFc15_StateflowKalmanInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_StateflowKalman(SimStruct *S)
{
  int i;
...
mxArray *sf_c15_StateflowKalman_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c15_StateflowKalman(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3114216723U));
  ssSetChecksum1(S,(2204356341U));
  ssSetChecksum2(S,(1596811793U));
  ssSetChecksum3(S,(2994404855U));
...
static void mdlRTW_c15_StateflowKalman(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_StateflowKalman(SimStruct *S)
{
  SFc15_StateflowKalmanInstanceStruct *chartInstance;
  chartInstance = (SFc15_StateflowKalmanInstanceStruct *)utMalloc(sizeof
    (SFc15_StateflowKalmanInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc15_StateflowKalmanInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c15_StateflowKalman;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_StateflowKalman;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c15_StateflowKalman;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_StateflowKalman;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_StateflowKalman;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_StateflowKalman;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_StateflowKalman;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_StateflowKalman;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_StateflowKalman;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_StateflowKalman;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c15_StateflowKalman;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c15_StateflowKalman;
  ...
  mdl_start_c15_StateflowKalman(chartInstance);
}

void c15_StateflowKalman_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_StateflowKalman(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_StateflowKalman(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_StateflowKalman(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_StateflowKalman_method_dispatcher.\n"
