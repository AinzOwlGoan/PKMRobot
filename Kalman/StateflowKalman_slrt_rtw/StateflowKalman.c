...
static void StateflowKalman_output(void)
{
...

  {
      ...
      switch (StateflowKalman_DW.is_c15_StateflowKalman) {
       ...
       case StateflowKalman_IN_Home:
        ...
        if (sf_internal_predicateOutput) {
          ...
          /* Gain: '<S200>/Gain1' */
          StateflowKalman_B.Gain1_f = StateflowKalman_P.Gain1_Gain_e *
       ...
       case StateflowKalman_IN_HomeDef:
        ...
        if (sf_internal_predicateOutput) {
          ...
          /* Gain: '<S199>/Gain1' */
          StateflowKalman_B.Gain1_e = StateflowKalman_P.Gain1_Gain *
    ...
    /* Gain: '<S12>/Gain1' */
    StateflowKalman_B.Gain1 = StateflowKalman_P.Gain1_Gain_i *
    ...
    if (StateflowKalman_B.Memory != 0.0) {
      ...
      if (StateflowKalman_B.Bool > StateflowKalman_P.Switch1_Threshold) {
        /* Switch: '<S5>/Switch1' */
        StateflowKalman_B.Switch1_c = StateflowKalman_B.Gain1;
      } else {
        /* Switch: '<S5>/Switch1' */
    ...
    /* Gain: '<S12>/Gain' */
    StateflowKalman_B.Gain = StateflowKalman_P.Gain_Gain_j *
    ...
    if (StateflowKalman_B.Memory_g != 0.0) {
      ...
      if (StateflowKalman_B.Bool > StateflowKalman_P.Switch1_Threshold_f) {
        /* Switch: '<S6>/Switch1' */
        StateflowKalman_B.Switch1_i = StateflowKalman_B.Gain;
      } else {
        /* Switch: '<S6>/Switch1' */
    ...
    /* Gain: '<S38>/Gain' */
    StateflowKalman_B.Gain_a = StateflowKalman_P.Gain_Gain_b *
    ...
    /* Sum: '<S38>/Sum9' */
    StateflowKalman_B.Sum9_p = StateflowKalman_B.Gain_a +
      StateflowKalman_B.Gain6;
    ...
    if (StateflowKalman_B.Memory_n != 0.0) {
      ...
      if (StateflowKalman_B.Bool > StateflowKalman_P.Switch_Threshold) {
         ...
         *  Switch: '<S7>/Switch'
         */
        StateflowKalman_B.Gain_m = StateflowKalman_P.Gain_Gain *
    ...
    x2 = StateflowKalman_B.C2;
    G1 = StateflowKalman_B.C1;
...
RT_MODEL_StateflowKalman_T *StateflowKalman(void)
{
  ...
  StateflowKalman_M->Sizes.numBlocks = (586);/* Number of blocks */
