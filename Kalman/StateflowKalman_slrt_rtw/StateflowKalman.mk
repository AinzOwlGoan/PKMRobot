...
MODEL           = StateflowKalman
MODULES         = rt_matrx.c rt_printf.c StateflowKalman_capi.c StateflowKalman_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c ecat_config_xml_0.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = StateflowKalman.mk
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\Danie\AppData\Roaming\MathWorks\MATLAB\R2017a\mex_C_win64.xml"
...
MODELLIB                  = StateflowKalmanlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = StateflowKalman_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\StateflowKalman_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Danie\Documenti\MATLAB\PKMRobot\Stateflow
