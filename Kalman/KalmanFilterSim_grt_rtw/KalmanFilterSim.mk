###########################################################################
## Makefile generated for Simulink model 'KalmanFilterSim'. 
## 
## Makefile     : KalmanFilterSim.mk
## Generated on : Wed Dec 01 13:44:02 2021
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\KalmanFilterSim.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\Danie\Documenti\MATLAB\PKMRobot\Kalman
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = KalmanFilterSim_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = KalmanFilterSim_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\KalmanFilterSim.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\KalmanFilterSim_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=KalmanFilterSim -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\KalmanFilterSim_grt_rtw\KalmanFilterSim.c $(START_DIR)\KalmanFilterSim_grt_rtw\KalmanFilterSim_data.c $(START_DIR)\KalmanFilterSim_grt_rtw\rtGetInf.c $(START_DIR)\KalmanFilterSim_grt_rtw\rtGetNaN.c $(START_DIR)\KalmanFilterSim_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = KalmanFilterSim.obj KalmanFilterSim_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\KalmanFilterSim_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\KalmanFilterSim_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
