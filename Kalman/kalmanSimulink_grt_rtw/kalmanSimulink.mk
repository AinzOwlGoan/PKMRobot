###########################################################################
## Makefile generated for Simulink model 'kalmanSimulink'. 
## 
## Makefile     : kalmanSimulink.mk
## Generated on : Wed Nov 24 14:55:44 2021
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\kalmanSimulink.exe
...
MODELREF_LINK_RSPFILE_NAME = kalmanSimulink_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = kalmanSimulink_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\kalmanSimulink.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\kalmanSimulink_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=kalmanSimulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\kalmanSimulink_grt_rtw\kalmanSimulink.c $(START_DIR)\kalmanSimulink_grt_rtw\kalmanSimulink_data.c $(START_DIR)\kalmanSimulink_grt_rtw\rtGetInf.c $(START_DIR)\kalmanSimulink_grt_rtw\rtGetNaN.c $(START_DIR)\kalmanSimulink_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = kalmanSimulink.obj kalmanSimulink_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\kalmanSimulink_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\kalmanSimulink_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
