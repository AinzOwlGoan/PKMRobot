...
MODEL           = State_Flow_vel
MODULES         = rt_matrx.c rt_printf.c State_Flow_vel_capi.c State_Flow_vel_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c ecat_config_xml_0.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = State_Flow_vel.mk
...
MODELLIB                  = State_Flow_vellib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = State_Flow_vel_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\State_Flow_vel_slrt_rtw
