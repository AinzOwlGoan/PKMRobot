...
typedef struct {
  ...
  real_T Gain_na;                      /* '<S12>/Gain' */
  real_T Switch1_c;                    /* '<S5>/Switch1' */
  real_T Gain1_i;                      /* '<S12>/Gain1' */
...
typedef struct {
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } HiddenToAsyncQueue_InsertedF_ix;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } HiddenToAsyncQueue_InsertedF_hh;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } HiddenToAsyncQueue_InsertedF_kj;   /* synthesized block */
...
struct P_StateflowKalman_T_ {
  ...
  real_T Switch1_Threshold;            /* Expression: 3
                                        ...
                                        */
  real_T Gain_Gain;                    /* Expression: 1000/0.3
  ...
  real_T DiscreteTimeIntegrator1_IC;   /* Expression: 0
                                        * Referenced by: '<S199>/Discrete-Time Integrator1'
                                        */
  real_T Gain1_Gain_d;                 /* Expression: ( (2*pi)/16384/64*180/pi)
