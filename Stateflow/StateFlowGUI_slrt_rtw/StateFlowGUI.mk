...
MODEL           = StateFlowGUI
MODULES         = rt_matrx.c rt_printf.c StateFlowGUI_capi.c StateFlowGUI_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c ecat_config_xml_0.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = StateFlowGUI.mk
...
MODELLIB                  = StateFlowGUIlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = StateFlowGUI_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\StateFlowGUI_slrt_rtw
