...
static void StateFlowGUI_output(void)
{
...

  {
    ...
    /* '<S31>:1:3' */
    /* '<S31>:1:4' */
    x1 = StateFlowGUI_B.Sum2 / (0.5 * StateFlowGUI_P.PeriodoQ_Value / 4.0);
    ...
    if ((StateFlowGUI_B.Sum2 > 0.0) && (StateFlowGUI_B.Sum2 <= 0.5 *
      ...
      if ((x1 >= 0.0) && (x1 < 0.1)) {
        ...
        /* '<S31>:1:19' */
        x2 = 9.259259259259256 * StateFlowGUI_mpower(x1);
        ...
        /* '<S31>:1:25' */
        x2 = (x1 * x1 * 2.7777777777777772 - 0.27777777777777773 * x1) +
          0.0092592592592592587;
        ...
        /* '<S31>:1:31' */
        x2 = ((((x1 * x1 * 11.111111111111109 + -9.259259259259256 *
                 StateFlowGUI_mpower(x1)) - 2.7777777777777777 * x1) -
        ...
        /* '<S31>:1:38' */
        x2 = (1.6666666666666665 * x1 - 0.44444444444444442) +
          0.1111111111111111;
        ...
        /* '<S31>:1:44' */
        x2 = (((((x1 * x1 * 16.666666666666661 + -9.259259259259256 *
                  StateFlowGUI_mpower(x1)) + 1.6666666666666665 * x1) -
        ...
        /* '<S31>:1:51' */
        x2 = (((x1 * x1 * -2.7777777777777772 + 5.5555555555555545 * x1) -
        ...
        /* '<S31>:1:57' */
        x2 = (((9.259259259259256 * StateFlowGUI_mpower(x1) - x1 * x1 *
      ...
      /* '<S31>:1:66' */
      StateFlowGUI_B.xq_pg = x2 * StateFlowGUI_P.AlzataQ_Value / 2.0;

      /* '<S31>:1:67' */
      StateFlowGUI_B.xq_p_h = StateFlowGUI_P.AlzataQ_Value / 2.0 * F /
        (StateFlowGUI_P.PeriodoQ_Value / 4.0);
      ...
      /* '<S31>:1:125' */
      StateFlowGUI_B.xq_pg = StateFlowGUI_P.AlzataQ_Value / 2.0;

      /* '<S31>:1:126' */
      StateFlowGUI_B.xq_p_h = 0.0;

      /* '<S31>:1:127' */
      StateFlowGUI_B.yq_o = -x2 * StateFlowGUI_P.AlzataQ_Value;

      /* '<S31>:1:128' */
      StateFlowGUI_B.yq_p_e = -F * StateFlowGUI_P.AlzataQ_Value /
        (StateFlowGUI_P.PeriodoQ_Value / 4.0);
      ...
      /* '<S31>:1:184' */
      StateFlowGUI_B.xq_pg = StateFlowGUI_P.AlzataQ_Value / 2.0 - x2 *
        StateFlowGUI_P.AlzataQ_Value;

      /* '<S31>:1:185' */
      StateFlowGUI_B.xq_p_h = -F * StateFlowGUI_P.AlzataQ_Value /
        (StateFlowGUI_P.PeriodoQ_Value / 4.0);

      /* '<S31>:1:186' */
      StateFlowGUI_B.yq_o = -StateFlowGUI_P.AlzataQ_Value;
      ...
      /* '<S31>:1:303' */
      StateFlowGUI_B.xq_p_h = F * StateFlowGUI_P.AlzataQ_Value / 2.0 /
        (StateFlowGUI_P.PeriodoQ_Value / 4.0);
    ...
    /* '<S32>:1:2' */
    x1 = StateFlowGUI_P.PeriodoC1_Value / 32.0;
    ...
    /* '<S32>:1:45' */
    /* '<S32>:1:46' */
    if ((StateFlowGUI_B.Sum2 > 0.0) && (StateFlowGUI_B.Sum2 <= x1 / 2.0)) {
      /* '<S32>:1:48' */
      /*  1 */
      /* '<S32>:1:49' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 0.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F);
      ...
      /* '<S32>:1:52' */
      StateFlowGUI_B.y_j = -x2 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:53' */
      StateFlowGUI_B.y_p_h = -F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > x1 / 2.0) && (StateFlowGUI_B.Sum2 <= 3.0 *
                x1 / 2.0)) {
      /* '<S32>:1:55' */
      /*  2 */
      /* '<S32>:1:56' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - x1 / 2.0) / x1, &x2, &F);

      /* '<S32>:1:57' */
      StateFlowGUI_B.x_o = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:58' */
      StateFlowGUI_B.x_p_n = F * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;

      /* '<S32>:1:59' */
      StateFlowGUI_B.y_j = -StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:60' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 3.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                4.0 * x1 / 2.0)) {
      /* '<S32>:1:62' */
      /*  3 */
      /* '<S32>:1:63' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 3.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F);

      /* '<S32>:1:64' */
      StateFlowGUI_B.x_o = 3.0 * StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:67' */
      StateFlowGUI_B.y_p_h = F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 4.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                5.0 * x1 / 2.0)) {
      /* '<S32>:1:69' */
      /*  4 */
      /* '<S32>:1:70' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 4.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F);

      /* '<S32>:1:71' */
      StateFlowGUI_B.x_o = 3.0 * StateFlowGUI_P.AlzataC1_Value - x2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:72' */
      StateFlowGUI_B.x_p_n = -F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
      ...
      /* '<S32>:1:74' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 5.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                7.0 * x1 / 2.0)) {
      /* '<S32>:1:76' */
      /*  5 */
      /* '<S32>:1:77' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 5.0 * x1 / 2.0) / x1, &x2, &F);

      /* '<S32>:1:78' */
      StateFlowGUI_B.x_o = 2.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:79' */
      StateFlowGUI_B.x_p_n = 0.0;

      /* '<S32>:1:80' */
      StateFlowGUI_B.y_j = -x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:81' */
      StateFlowGUI_B.y_p_h = -F * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 7.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                9.0 * x1 / 2.0)) {
      /* '<S32>:1:83' */
      /*  6 */
      /* '<S32>:1:84' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 7.0 * x1 / 2.0) / x1, &x2, &T2);

      /* '<S32>:1:85' */
      StateFlowGUI_B.x_o = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value + 2.0 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:86' */
      StateFlowGUI_B.x_p_n = T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;

      /* '<S32>:1:87' */
      StateFlowGUI_B.y_j = -3.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:88' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 9.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                11.0 * x1 / 2.0)) {
      /* '<S32>:1:90' */
      /*  7 */
      /* '<S32>:1:91' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 9.0 * x1 / 2.0) / x1, &x2, &T2);

      /* '<S32>:1:92' */
      StateFlowGUI_B.x_o = 5.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:93' */
      StateFlowGUI_B.x_p_n = 0.0;

      /* '<S32>:1:94' */
      StateFlowGUI_B.y_j = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value + -3.0 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:95' */
      StateFlowGUI_B.y_p_h = -T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 11.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                12.0 * x1 / 2.0)) {
      /* '<S32>:1:97' */
      /*  8 */
      /* '<S32>:1:98' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 11.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:99' */
      StateFlowGUI_B.x_o = 5.0 * StateFlowGUI_P.AlzataC1_Value - T2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:102' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 12.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                13.0 * x1 / 2.0)) {
      /* '<S32>:1:104' */
      /*  9 */
      /* '<S32>:1:105' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 12.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:106' */
      StateFlowGUI_B.x_o = 4.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:107' */
      StateFlowGUI_B.x_p_n = 0.0;

      /* '<S32>:1:108' */
      StateFlowGUI_B.y_j = -T2 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:109' */
      StateFlowGUI_B.y_p_h = -F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 13.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                15.0 * x1 / 2.0)) {
      /* '<S32>:1:111' */
      /*  10 */
      /* '<S32>:1:112' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 13.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:113' */
      StateFlowGUI_B.x_o = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value + 4.0 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:116' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 15.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                16.0 * x1 / 2.0)) {
      /* '<S32>:1:118' */
      /*  11 */
      /* '<S32>:1:119' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 15.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:120' */
      StateFlowGUI_B.x_o = 7.0 * StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:123' */
      StateFlowGUI_B.y_p_h = F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 16.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                17.0 * x1 / 2.0)) {
      /* '<S32>:1:125' */
      /*  12 */
      /* '<S32>:1:126' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 16.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:127' */
      StateFlowGUI_B.x_o = 7.0 * StateFlowGUI_P.AlzataC1_Value - T2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:130' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 17.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                19.0 * x1 / 2.0)) {
      /* '<S32>:1:132' */
      /*  13 */
      /* '<S32>:1:133' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 17.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:134' */
      StateFlowGUI_B.x_o = 6.0 * StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:137' */
      StateFlowGUI_B.y_p_h = -T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 19.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                20.0 * x1 / 2.0)) {
      /* '<S32>:1:139' */
      /*  14 */
      /* '<S32>:1:140' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 19.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:141' */
      StateFlowGUI_B.x_o = 6.0 * StateFlowGUI_P.AlzataC1_Value + T2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:144' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 20.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                21.0 * x1 / 2.0)) {
      /* '<S32>:1:146' */
      /*  15 */
      /* '<S32>:1:147' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 20.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:150' */
      StateFlowGUI_B.y_j = -3.0 * StateFlowGUI_P.AlzataC1_Value + T2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:151' */
      StateFlowGUI_B.y_p_h = F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 21.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                23.0 * x1 / 2.0)) {
      /* '<S32>:1:153' */
      /*  16 */
      /* '<S32>:1:154' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 21.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:155' */
      StateFlowGUI_B.x_o = 7.0 * StateFlowGUI_P.AlzataC1_Value - x2 * 3.0 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:157' */
      StateFlowGUI_B.y_j = -2.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:158' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 23.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                25.0 * x1 / 2.0)) {
      /* '<S32>:1:160' */
      /*  17 */
      /* '<S32>:1:161' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 23.0 * x1 / 2.0) / x1, &x2,
                           &T2);
      ...
      /* '<S32>:1:164' */
      StateFlowGUI_B.y_j = -2.0 * StateFlowGUI_P.AlzataC1_Value - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:165' */
      StateFlowGUI_B.y_p_h = -T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 25.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                27.0 * x1 / 2.0)) {
      /* '<S32>:1:167' */
      /*  18 */
      /* '<S32>:1:168' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 25.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:169' */
      StateFlowGUI_B.x_o = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value + 4.0 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:171' */
      StateFlowGUI_B.y_j = -5.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:172' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 27.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                28.0 * x1 / 2.0)) {
      /* '<S32>:1:174' */
      /*  19 */
      /* '<S32>:1:175' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 27.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:178' */
      StateFlowGUI_B.y_j = -5.0 * StateFlowGUI_P.AlzataC1_Value + T2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:179' */
      StateFlowGUI_B.y_p_h = F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 28.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                29.0 * x1 / 2.0)) {
      /* '<S32>:1:181' */
      /*  20 */
      /* '<S32>:1:182' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 28.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:185' */
      StateFlowGUI_B.y_j = -4.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:186' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 29.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                31.0 * x1 / 2.0)) {
      /* '<S32>:1:188' */
      /*  21 */
      /* '<S32>:1:189' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 29.0 * x1 / 2.0) / x1, &x2,
                           &T2);
      ...
      /* '<S32>:1:192' */
      StateFlowGUI_B.y_j = -4.0 * StateFlowGUI_P.AlzataC1_Value - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:193' */
      StateFlowGUI_B.y_p_h = -T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 31.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                32.0 * x1 / 2.0)) {
      /* '<S32>:1:195' */
      /*  22 */
      /* '<S32>:1:196' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 31.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:199' */
      StateFlowGUI_B.y_j = -7.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:200' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 32.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                33.0 * x1 / 2.0)) {
      /* '<S32>:1:202' */
      /*  23 */
      /* '<S32>:1:203' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 32.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:206' */
      StateFlowGUI_B.y_j = -7.0 * StateFlowGUI_P.AlzataC1_Value + T2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:207' */
      StateFlowGUI_B.y_p_h = F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 33.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                35.0 * x1 / 2.0)) {
      /* '<S32>:1:209' */
      /*  24 */
      /* '<S32>:1:210' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 33.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:211' */
      StateFlowGUI_B.x_o = 7.0 * StateFlowGUI_P.AlzataC1_Value - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:213' */
      StateFlowGUI_B.y_j = -6.0 * StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:214' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 35.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                36.0 * x1 / 2.0)) {
      /* '<S32>:1:216' */
      /*  25 */
      /* '<S32>:1:217' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 35.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:220' */
      StateFlowGUI_B.y_j = -6.0 * StateFlowGUI_P.AlzataC1_Value - T2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:221' */
      StateFlowGUI_B.y_p_h = -F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 36.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                37.0 * x1 / 2.0)) {
      /* '<S32>:1:223' */
      /*  26 */
      /* '<S32>:1:224' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 36.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:225' */
      StateFlowGUI_B.x_o = 4.0 * StateFlowGUI_P.AlzataC1_Value + T2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:228' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 37.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                39.0 * x1 / 2.0)) {
      /* '<S32>:1:230' */
      /*  27 */
      /* '<S32>:1:231' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 37.0 * x1 / 2.0) / x1, &x2,
                           &T2);
      ...
      /* '<S32>:1:234' */
      StateFlowGUI_B.y_j = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value + -7.0 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:235' */
      StateFlowGUI_B.y_p_h = T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 39.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                41.0 * x1 / 2.0)) {
      /* '<S32>:1:237' */
      /*  28 */
      /* '<S32>:1:238' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 39.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:239' */
      StateFlowGUI_B.x_o = 5.0 * StateFlowGUI_P.AlzataC1_Value - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:242' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 41.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                43.0 * x1 / 2.0)) {
      /* '<S32>:1:244' */
      /*  29 */
      /* '<S32>:1:245' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 41.0 * x1 / 2.0) / x1, &x2,
                           &T2);
      ...
      /* '<S32>:1:248' */
      StateFlowGUI_B.y_j = -4.0 * StateFlowGUI_P.AlzataC1_Value - x2 * 3.0 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:249' */
      StateFlowGUI_B.y_p_h = -T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 43.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                44.0 * x1 / 2.0)) {
      /* '<S32>:1:251' */
      /*  30 */
      /* '<S32>:1:252' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 43.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:253' */
      StateFlowGUI_B.x_o = 2.0 * StateFlowGUI_P.AlzataC1_Value + T2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:256' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 44.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                45.0 * x1 / 2.0)) {
      /* '<S32>:1:258' */
      /*  31 */
      /* '<S32>:1:259' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 44.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:263' */
      StateFlowGUI_B.y_p_h = F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 45.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                47.0 * x1 / 2.0)) {
      /* '<S32>:1:265' */
      /*  32 */
      /* '<S32>:1:266' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 45.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:267' */
      StateFlowGUI_B.x_o = 3.0 * StateFlowGUI_P.AlzataC1_Value - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:270' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 47.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                48.0 * x1 / 2.0)) {
      /* '<S32>:1:272' */
      /*  33 */
      /* '<S32>:1:273' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 47.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:277' */
      StateFlowGUI_B.y_p_h = -F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 48.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                49.0 * x1 / 2.0)) {
      /* '<S32>:1:279' */
      /*  34 */
      /* '<S32>:1:280' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 48.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:281' */
      StateFlowGUI_B.x_o = T2 * StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:284' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 49.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                51.0 * x1 / 2.0)) {
      /* '<S32>:1:286' */
      /*  35 */
      /* '<S32>:1:287' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 49.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:288' */
      StateFlowGUI_B.x_o = StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:291' */
      StateFlowGUI_B.y_p_h = T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 51.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                52.0 * x1 / 2.0)) {
      /* '<S32>:1:293' */
      /*  36 */
      /* '<S32>:1:294' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 51.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);

      /* '<S32>:1:295' */
      StateFlowGUI_B.x_o = StateFlowGUI_P.AlzataC1_Value - T2 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:298' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 52.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                53.0 * x1 / 2.0)) {
      /* '<S32>:1:300' */
      /*  37 */
      /* '<S32>:1:301' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 52.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:304' */
      StateFlowGUI_B.y_j = -4.0 * StateFlowGUI_P.AlzataC1_Value - T2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:305' */
      StateFlowGUI_B.y_p_h = -F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 53.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                55.0 * x1 / 2.0)) {
      /* '<S32>:1:307' */
      /*  38 */
      /* '<S32>:1:308' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 53.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:309' */
      StateFlowGUI_B.x_o = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:312' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 55.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                57.0 * x1 / 2.0)) {
      /* '<S32>:1:314' */
      /*  39 */
      /* '<S32>:1:315' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 55.0 * x1 / 2.0) / x1, &x2,
                           &T2);
      ...
      /* '<S32>:1:318' */
      StateFlowGUI_B.y_j = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value + -5.0 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:319' */
      StateFlowGUI_B.y_p_h = T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 57.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                59.0 * x1 / 2.0)) {
      /* '<S32>:1:321' */
      /*  40 */
      /* '<S32>:1:322' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 57.0 * x1 / 2.0) / x1, &x2,
                           &T2);

      /* '<S32>:1:323' */
      StateFlowGUI_B.x_o = 3.0 * StateFlowGUI_P.AlzataC1_Value - x2 * 3.0 *
        StateFlowGUI_P.AlzataC1_Value;
      ...
      /* '<S32>:1:326' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 59.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                60.0 * x1 / 2.0)) {
      /* '<S32>:1:328' */
      /*  41 */
      /* '<S32>:1:329' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 59.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:332' */
      StateFlowGUI_B.y_j = -2.0 * StateFlowGUI_P.AlzataC1_Value - T2 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:333' */
      StateFlowGUI_B.y_p_h = -F * StateFlowGUI_P.AlzataC1_Value / (x1 / 2.0);
    } else if ((StateFlowGUI_B.Sum2 > 60.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                61.0 * x1 / 2.0)) {
      /* '<S32>:1:335' */
      /*  42 */
      /* '<S32>:1:336' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 60.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F);
      ...
      /* '<S32>:1:340' */
      StateFlowGUI_B.y_p_h = 0.0;
    } else if ((StateFlowGUI_B.Sum2 > 61.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                63.0 * x1 / 2.0)) {
      /* '<S32>:1:342' */
      /*  43 */
      /* '<S32>:1:343' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 61.0 * x1 / 2.0) / x1, &x2,
                           &T2);
      ...
      /* '<S32>:1:346' */
      StateFlowGUI_B.y_j = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value + -3.0 *
        StateFlowGUI_P.AlzataC1_Value;

      /* '<S32>:1:347' */
      StateFlowGUI_B.y_p_h = T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value / x1;
    } else if ((StateFlowGUI_B.Sum2 > 63.0 * x1 / 2.0) && (StateFlowGUI_B.Sum2 <=
                64.0 * x1 / 2.0)) {
      /* '<S32>:1:349' */
      /*  44 */
      /* '<S32>:1:350' */
      StateFlowGUI_ldm7t_f((StateFlowGUI_B.Sum2 - 63.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F);

      /* '<S32>:1:351' */
      StateFlowGUI_B.x_o = StateFlowGUI_P.AlzataC1_Value - x2 *
        StateFlowGUI_P.AlzataC1_Value;
    ...
    /* '<S29>:1:4' */
    x1 = 100.0 * StateFlowGUI_P.Constant3_Value / 2.0;

    /* '<S29>:1:5' */
    /* '<S29>:1:6' */
    T2 = (StateFlowGUI_P.Constant3_Value - 0.025) * 100.0 / 2.0;
    ...
    /* '<S29>:1:17' */
    /* '<S29>:1:18' */
    if ((StateFlowGUI_B.Sum2 > 0.0) && (StateFlowGUI_B.Sum2 <= x1)) {
      /* '<S29>:1:20' */
      /*  1 */
      /* '<S29>:1:21' */
      StateFlowGUI_ldm7t(StateFlowGUI_B.Sum2 / x1, &x2, &F);

      /* '<S29>:1:22' */
      x2 = x2 * 2.0 * 3.1415926535897931;

      /* '<S29>:1:23' */
      F = F * 2.0 * 3.1415926535897931 / x1;

      /* '<S29>:1:24' */
      StateFlowGUI_B.xct_a = StateFlowGUI_P.Constant3_Value / 2.0 * cos
        (1.5707963267948966 - x2);

      /* '<S29>:1:25' */
      StateFlowGUI_B.yct_g = StateFlowGUI_P.Constant3_Value / 2.0 * sin
        (1.5707963267948966 - x2) - StateFlowGUI_P.Constant3_Value / 2.0;

      /* '<S29>:1:26' */
      StateFlowGUI_B.xct_p_l = StateFlowGUI_P.Constant3_Value / 2.0 * sin
        (1.5707963267948966 - x2) * F;

      /* '<S29>:1:27' */
      StateFlowGUI_B.yct_p_i = -StateFlowGUI_P.Constant3_Value / 2.0 * cos
        (1.5707963267948966 - x2) * F;
    } else if ((StateFlowGUI_B.Sum2 > x1) && (StateFlowGUI_B.Sum2 <= x1 + T2)) {
      /* '<S29>:1:29' */
      /*  2 */
      /* '<S29>:1:30' */
      StateFlowGUI_ldm7t((StateFlowGUI_B.Sum2 - x1) / T2, &x2, &F);

      /* '<S29>:1:31' */
      x2 = x2 * 2.0 * 3.1415926535897931;

      /* '<S29>:1:32' */
      F = F * 2.0 * 3.1415926535897931 / T2;

      /* '<S29>:1:33' */
      StateFlowGUI_B.xct_a = (StateFlowGUI_P.Constant3_Value - 0.025) / 2.0 *
        cos(1.5707963267948966 - x2);

      /* '<S29>:1:34' */
      StateFlowGUI_B.yct_g = (StateFlowGUI_P.Constant3_Value - 0.025) / 2.0 *
        sin(1.5707963267948966 - x2) - (StateFlowGUI_P.Constant3_Value - 0.025) /
        2.0;

      /* '<S29>:1:35' */
      StateFlowGUI_B.xct_p_l = (StateFlowGUI_P.Constant3_Value - 0.025) / 2.0 *
        sin(1.5707963267948966 - x2) * F;

      /* '<S29>:1:36' */
      StateFlowGUI_B.yct_p_i = -(StateFlowGUI_P.Constant3_Value - 0.025) / 2.0 *
        cos(1.5707963267948966 - x2) * F;
    } else if ((StateFlowGUI_B.Sum2 > x1 + T2) && (StateFlowGUI_B.Sum2 <= (x1 +
                 T2) + x3)) {
      /* '<S29>:1:38' */
      /*  3 */
      /* '<S29>:1:39' */
      StateFlowGUI_ldm7t(((StateFlowGUI_B.Sum2 - x1) - T2) / x3, &x2, &F);
      ...
      /* '<S29>:1:42' */
      StateFlowGUI_B.xct_a = ((StateFlowGUI_P.Constant3_Value - 0.025) - 0.025) /
        2.0 * cos(1.5707963267948966 - x2);

      /* '<S29>:1:43' */
      StateFlowGUI_B.yct_g = ((StateFlowGUI_P.Constant3_Value - 0.025) - 0.025) /
        2.0 * sin(1.5707963267948966 - x2) - ((StateFlowGUI_P.Constant3_Value -
        0.025) - 0.025) / 2.0;

      /* '<S29>:1:44' */
      StateFlowGUI_B.xct_p_l = ((StateFlowGUI_P.Constant3_Value - 0.025) - 0.025)
        / 2.0 * sin(1.5707963267948966 - x2) * F;

      /* '<S29>:1:45' */
      StateFlowGUI_B.yct_p_i = -((StateFlowGUI_P.Constant3_Value - 0.025) -
        0.025) / 2.0 * cos(1.5707963267948966 - x2) * F;
    } else if ((StateFlowGUI_B.Sum2 > (x1 + T2) + x3) && (StateFlowGUI_B.Sum2 <=
                ((x1 + T2) + x3) + x4)) {
      /* '<S29>:1:47' */
      /*  4 */
      /* '<S29>:1:48' */
      StateFlowGUI_ldm7t((((StateFlowGUI_B.Sum2 - x1) - T2) - x3) / x4, &x2, &F);
      ...
      /* '<S29>:1:53' */
      StateFlowGUI_B.xct_p_l = (((StateFlowGUI_P.Constant3_Value - 0.025) -
        0.025) - 0.025) / 2.0 * sin(1.5707963267948966 - x2) * F;

      /* '<S29>:1:54' */
      StateFlowGUI_B.yct_p_i = -(((StateFlowGUI_P.Constant3_Value - 0.025) -
        0.025) - 0.025) / 2.0 * cos(1.5707963267948966 - x2) * F;
    } else if ((StateFlowGUI_B.Sum2 > ((x1 + T2) + x3) + x4) &&
               (StateFlowGUI_B.Sum2 <= (((x1 + T2) + x3) + x4) + T5)) {
      /* '<S29>:1:56' */
      /*  5 */
      /* '<S29>:1:57' */
      StateFlowGUI_ldm7t(((((StateFlowGUI_B.Sum2 - x1) - T2) - x3) - x4) / T5,
                         &x2, &F);
    ...
    if ((StateFlowGUI_B.Sum2 >= 0.0) && (StateFlowGUI_B.Sum2 <=
      ...
      /* '<S33>:1:5' */
      /* '<S33>:1:6' */
      StateFlowGUI_ldm7t_b(StateFlowGUI_B.Sum2 /
                           StateFlowGUI_P.Tempospostiniziale_Value, &x2, &F);

      /* '<S33>:1:7' */
      StateFlowGUI_B.xs_pl = x2 * StateFlowGUI_P.Rmin_Value;

      /* '<S33>:1:8' */
      StateFlowGUI_B.xs_p_e = F * StateFlowGUI_P.Rmin_Value /
        StateFlowGUI_P.Tempospostiniziale_Value;
      ...
      StateFlowGUI_ldm7t_b((StateFlowGUI_B.Sum2 -
                            StateFlowGUI_P.Tempospostiniziale_Value) /
                           StateFlowGUI_P.Periodo_Value, &x2, &F);

      /* '<S33>:1:13' */
      x1 = x2 * StateFlowGUI_P.Rmax_Value + StateFlowGUI_P.Rmin_Value;

      /* '<S33>:1:14' */
      T2 = F * StateFlowGUI_P.Rmax_Value / StateFlowGUI_P.Periodo_Value;
      ...
      /* '<S33>:1:17' */
      StateFlowGUI_B.xs_pl = x1 * cos(x2);

      /* '<S33>:1:18' */
      StateFlowGUI_B.ys_j = x1 * sin(x2);

      /* '<S33>:1:19' */
      StateFlowGUI_B.xs_p_e = -x1 * sin(x2) * F + T2 * cos(x2);

      /* '<S33>:1:20' */
      StateFlowGUI_B.ys_p_e = x1 * cos(x2) * F + T2 * sin(x2);
    } else {
      /* '<S33>:1:22' */
      StateFlowGUI_B.xs_pl = cos(StateFlowGUI_P.Ngiri_Value * 2.0 *
      ...
      /* '<S33>:1:24' */
      StateFlowGUI_B.ys_j = sin(StateFlowGUI_P.Ngiri_Value * 2.0 *
        3.1415926535897931) * (StateFlowGUI_P.Rmin_Value +
        StateFlowGUI_P.Rmax_Value);
    ...
    switch ((int32_T)StateFlowGUI_P.selettore_Value) {
     case 1:
      StateFlowGUI_B.MultiportSwitch[0] = StateFlowGUI_B.xq_pg;
      StateFlowGUI_B.MultiportSwitch[1] = StateFlowGUI_B.yq_o;
      StateFlowGUI_B.MultiportSwitch[2] = StateFlowGUI_B.xq_p_h;
      StateFlowGUI_B.MultiportSwitch[3] = StateFlowGUI_B.yq_p_e;
      break;

     case 2:
      StateFlowGUI_B.MultiportSwitch[0] = StateFlowGUI_B.xc_k;
      StateFlowGUI_B.MultiportSwitch[1] = StateFlowGUI_B.yc_g;
      StateFlowGUI_B.MultiportSwitch[2] = StateFlowGUI_B.xc_p_c;
      StateFlowGUI_B.MultiportSwitch[3] = StateFlowGUI_B.yc_p_f;
      break;

     case 3:
      StateFlowGUI_B.MultiportSwitch[0] = StateFlowGUI_B.x_o;
      StateFlowGUI_B.MultiportSwitch[1] = StateFlowGUI_B.y_j;
      StateFlowGUI_B.MultiportSwitch[2] = StateFlowGUI_B.x_p_n;
      StateFlowGUI_B.MultiportSwitch[3] = StateFlowGUI_B.y_p_h;
      break;

     case 4:
      StateFlowGUI_B.MultiportSwitch[0] = StateFlowGUI_B.xct_a;
      StateFlowGUI_B.MultiportSwitch[1] = StateFlowGUI_B.yct_g;
      StateFlowGUI_B.MultiportSwitch[2] = StateFlowGUI_B.xct_p_l;
      StateFlowGUI_B.MultiportSwitch[3] = StateFlowGUI_B.yct_p_i;
      break;

     default:
      StateFlowGUI_B.MultiportSwitch[0] = StateFlowGUI_B.xs_pl;
      StateFlowGUI_B.MultiportSwitch[1] = StateFlowGUI_B.ys_j;
      StateFlowGUI_B.MultiportSwitch[2] = StateFlowGUI_B.xs_p_e;
      StateFlowGUI_B.MultiportSwitch[3] = StateFlowGUI_B.ys_p_e;
      break;
    }
     ...
     */
    StateFlowGUI_B.Theta1Reale = StateFlowGUI_P.Constant_Value_e +
      StateFlowGUI_B.sf_AsseBconvbrac1.pos_B_conv;

    /* Sum: '<S4>/Sum4' */
    StateFlowGUI_B.Sum4 = StateFlowGUI_B.convert_g - StateFlowGUI_B.OffA;

    /* MATLAB Function: '<S4>/Asse A conv brac' */
    StateFlowGUI_AsseAconvbrac(StateFlowGUI_B.Sum4,
      &StateFlowGUI_B.sf_AsseAconvbrac);

    /* Sum: '<S4>/Sum3' incorporates:
     *  Constant: '<S4>/Constant1'
     */
    StateFlowGUI_B.theta2Reale = StateFlowGUI_P.Constant1_Value +
    ...
    if (StateFlowGUI_B.Sum2 == 0.0) {
      /* '<S22>:1:3' */
      /* '<S22>:1:5' */
      /* '<S22>:1:6' */
      /* '<S22>:1:8' */
      x1 = sin(StateFlowGUI_B.theta2Reale) - sin(StateFlowGUI_B.Theta1Reale);
      J_p_idx_1 = -0.18 - (cos(StateFlowGUI_B.theta2Reale) - cos
                           (StateFlowGUI_B.Theta1Reale)) * 0.25;
      x1 = x1 * x1 * 0.0625 + J_p_idx_1 * J_p_idx_1;

      /* '<S22>:1:9' */
      J_p_idx_3 = -0.18 - (cos(StateFlowGUI_B.theta2Reale) - cos
                           (StateFlowGUI_B.Theta1Reale)) * 0.25;
      T2 = ((-0.18 - (cos(StateFlowGUI_B.theta2Reale) - cos
      ...
      /* '<S22>:1:16' */
      x1 = (sqrt(T2 * T2 - ((x4 * x4 * 0.00050625 - (-0.18 - (cos
                 (StateFlowGUI_B.theta2Reale) - cos(StateFlowGUI_B.Theta1Reale))
                * 0.25) * ((cos(StateFlowGUI_B.theta2Reale) + cos
                            (StateFlowGUI_B.Theta1Reale)) * 0.0225) * (-0.18 -
                0.5 * cos(StateFlowGUI_B.theta2Reale))) + (0.045 * cos
               (StateFlowGUI_B.theta2Reale) + 0.0081) * (x5 * x5)) * (4.0 * x1))
            + -T2) / (2.0 * x1);

      /*  Posizione X end-effector */
      /* '<S22>:1:18' */
      StateFlowGUI_B.x0_o = (x1 * 0.25 * (sin(StateFlowGUI_B.theta2Reale) - sin
      ...
      /* '<S22>:1:21' */
      x1 = StateFlowGUI_B.Memory1;
    }

    StateFlowGUI_B.y0_e = x1;

    /* End of MATLAB Function: '<S4>/Cinematica Inversa1' */

    /* Sum: '<S4>/Sum' */
    StateFlowGUI_B.Sum = StateFlowGUI_B.MultiportSwitch[0] + StateFlowGUI_B.x0_o;
    ...
    /* Sum: '<S4>/Sum5' */
    StateFlowGUI_B.Sum5 = StateFlowGUI_B.sf_CinematicaInversa.theta2 -
    ...
    StateFlowGUI_VelAsseAconv(StateFlowGUI_B.VelocityA,
      &StateFlowGUI_B.sf_VelAsseAconv);

    /* MATLAB Function: '<S4>/Cinematica Inversa vel' */
    x2 = StateFlowGUI_B.MultiportSwitch[2];
    T2 = StateFlowGUI_B.MultiportSwitch[3];
    ...
    /* '<S21>:1:8' */
    /* '<S21>:1:10' */
    x1 = (StateFlowGUI_B.Sum1 - 0.25 * sin
    ...
    x4 = (((StateFlowGUI_B.Sum + 0.09) - 0.25 * cos
           ...
           cos(StateFlowGUI_B.sf_CinematicaInversa.theta1))) / x1;
    ...
    x1 = ((StateFlowGUI_B.Sum1 - 0.25 * sin
          ...
          ((StateFlowGUI_B.Sum - 0.09) - 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa.theta2)) + ((StateFlowGUI_B.Sum
            + 0.09) - 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa.theta1)) *
          (0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa.theta2))) / x1;
    ...
    J[2] = (-(StateFlowGUI_B.Sum1 - 0.25 * sin
              (StateFlowGUI_B.sf_CinematicaInversa.theta2)) /
            ((StateFlowGUI_B.Sum - 0.09) - 0.25 * cos
             (StateFlowGUI_B.sf_CinematicaInversa.theta2)) * x1 - 0.25 * sin
    ...
    if (StateFlowGUI_B.Memory != 0.0) {
      ...
      if (StateFlowGUI_B.Bool > StateFlowGUI_P.Switch1_Threshold) {
         ...
         *  Switch: '<S5>/Switch1'
         */
        StateFlowGUI_B.Sum17 = StateFlowGUI_B.sf_VelAsseAconv.vel_A_conv -
        ...
        /* Switch: '<S5>/Switch1' */
        StateFlowGUI_B.Switch1_c = StateFlowGUI_B.Sum8_f;
      } else {
        /* Switch: '<S5>/Switch1' */
    ...
    /* Sum: '<S4>/Sum14' */
    StateFlowGUI_B.Sum14 = StateFlowGUI_B.sf_CinematicaInversa.theta1 -
    ...
    StateFlowGUI_VelAsseBconv(StateFlowGUI_B.VelocityB,
      &StateFlowGUI_B.sf_VelAsseBconv);
    ...
    if (StateFlowGUI_B.Memory_g != 0.0) {
      ...
      if (StateFlowGUI_B.Bool > StateFlowGUI_P.Switch1_Threshold_f) {
         ...
         *  Switch: '<S6>/Switch1'
         */
        StateFlowGUI_B.Sum6_n = StateFlowGUI_B.sf_VelAsseBconv.vel_B_conv -
        ...
        /* Switch: '<S6>/Switch1' */
        StateFlowGUI_B.Switch1_i = StateFlowGUI_B.Sum7_l;
      } else {
        /* Switch: '<S6>/Switch1' */
    ...
    /* Sum: '<S57>/Sum5' */
    StateFlowGUI_B.Sum5_j = StateFlowGUI_B.pos_A_conv +
    ...
    /* Sum: '<S11>/Sum1' */
    StateFlowGUI_B.Sum1_m = StateFlowGUI_B.ldm_pos - StateFlowGUI_B.Sum5_j;

    /* Gain: '<S52>/Gain' */
    StateFlowGUI_B.Gain = StateFlowGUI_P.Gain_Gain_b * StateFlowGUI_B.Sum1_m;
    ...
    /* Sum: '<S52>/Sum9' */
    StateFlowGUI_B.Sum9 = StateFlowGUI_B.Gain + StateFlowGUI_B.Gain6;
    ...
    if (StateFlowGUI_B.Memory_n != 0.0) {
      StateFlowGUI_B.Switch1_f = StateFlowGUI_P.Constant_Value_eg;
    } else {
      if (StateFlowGUI_B.Bool > StateFlowGUI_P.Switch_Threshold) {
        /* Gain: '<S7>/Gain' incorporates:
         *  Switch: '<S7>/Switch'
         */
        StateFlowGUI_B.Gain_m = StateFlowGUI_P.Gain_Gain * StateFlowGUI_B.Sum9;
    ...
    /* Sum: '<S11>/Sum7' */
    StateFlowGUI_B.Sum7 = StateFlowGUI_B.Gain2 + StateFlowGUI_B.Gain4;
    ...
    if (StateFlowGUI_B.Memory_d != 0.0) {
      ...
      if (StateFlowGUI_B.Bool > StateFlowGUI_P.Switch2_Threshold) {
        /* Switch: '<S8>/Switch2' */
        StateFlowGUI_B.Switch2 = StateFlowGUI_B.Sum7;
      } else {
     ...
     *  y = u * K where K = 1 / ( w * Ts )
     */
    StateFlowGUI_B.TSamp_i = StateFlowGUI_B.Sum5_j * StateFlowGUI_P.TSamp_WtEt_g;
    ...
    /* '<S91>:1:4' */
    /* '<S91>:1:6' */
    x1 = sin(StateFlowGUI_P.Constant1_Value_k) - sin
      (StateFlowGUI_P.Constant_Value_b);
    J_p_idx_1 = -0.18 - (cos(StateFlowGUI_P.Constant1_Value_k) - cos
                         (StateFlowGUI_P.Constant_Value_b)) * 0.25;
    x1 = x1 * x1 * 0.0625 + J_p_idx_1 * J_p_idx_1;

    /* '<S91>:1:7' */
    J_p_idx_3 = -0.18 - (cos(StateFlowGUI_P.Constant1_Value_k) - cos
                         (StateFlowGUI_P.Constant_Value_b)) * 0.25;
    T2 = ((-0.18 - (cos(StateFlowGUI_P.Constant1_Value_k) - cos
                    (StateFlowGUI_P.Constant_Value_b)) * 0.25) * ((sin
            (StateFlowGUI_P.Constant1_Value_k) - sin
            (StateFlowGUI_P.Constant_Value_b)) * 0.25) * (-0.18 - 0.5 * cos
           (StateFlowGUI_P.Constant1_Value_k)) + (sin
           (StateFlowGUI_P.Constant1_Value_k) - sin
           (StateFlowGUI_P.Constant_Value_b)) * -0.01125 * (cos
           (StateFlowGUI_P.Constant1_Value_k) + cos
           (StateFlowGUI_P.Constant_Value_b))) - 0.5 * sin
      (StateFlowGUI_P.Constant1_Value_k) * (J_p_idx_3 * J_p_idx_3);

    /* '<S91>:1:10' */
    x4 = cos(StateFlowGUI_P.Constant1_Value_k) + cos
      (StateFlowGUI_P.Constant_Value_b);
    x5 = -0.18 - (cos(StateFlowGUI_P.Constant1_Value_k) - cos
                  (StateFlowGUI_P.Constant_Value_b)) * 0.25;
    ...
    x1 = (sqrt(T2 * T2 - ((x4 * x4 * 0.00050625 - (-0.18 - (cos
              ...
              (StateFlowGUI_P.Constant1_Value_k))) + (0.045 * cos
             (StateFlowGUI_P.Constant1_Value_k) + 0.0081) * (x5 * x5)) * (4.0 *
            x1)) + -T2) / (2.0 * x1);

    /*  Posizione X end-effector */
    /* '<S91>:1:16' */
    StateFlowGUI_B.x0 = (x1 * 0.25 * (sin(StateFlowGUI_P.Constant1_Value_k) -
      sin(StateFlowGUI_P.Constant_Value_b)) - (cos
      (StateFlowGUI_P.Constant1_Value_k) + cos(StateFlowGUI_P.Constant_Value_b))
                         * 0.0225) / (-0.18 - (cos
      (StateFlowGUI_P.Constant1_Value_k) - cos(StateFlowGUI_P.Constant_Value_b))
      * 0.25);
    StateFlowGUI_B.y0 = x1;

    /* Sum: '<S67>/Sum2' */
    StateFlowGUI_B.Sum2_d = StateFlowGUI_B.Clock - StateFlowGUI_B.OffT;
    ...
    /* '<S88>:1:3' */
    /* '<S88>:1:4' */
    x1 = StateFlowGUI_B.Sum2_d / (0.5 * StateFlowGUI_P.PeriodoQ_Value_m / 4.0);

    /* '<S88>:1:5' */
    x2 = (StateFlowGUI_B.Sum2_d - 0.5 * StateFlowGUI_P.PeriodoQ_Value_m / 4.0) /
      (StateFlowGUI_P.PeriodoQ_Value_m / 4.0);

    /* '<S88>:1:6' */
    x3 = (StateFlowGUI_B.Sum2_d - 1.5 * StateFlowGUI_P.PeriodoQ_Value_m / 4.0) /
      (StateFlowGUI_P.PeriodoQ_Value_m / 4.0);

    /* '<S88>:1:7' */
    x4 = (StateFlowGUI_B.Sum2_d - 2.5 * StateFlowGUI_P.PeriodoQ_Value_m / 4.0) /
      (StateFlowGUI_P.PeriodoQ_Value_m / 4.0);

    /* '<S88>:1:8' */
    x5 = (StateFlowGUI_B.Sum2_d - 3.5 * StateFlowGUI_P.PeriodoQ_Value_m / 4.0) /
      (0.5 * StateFlowGUI_P.PeriodoQ_Value_m / 4.0);

    /* '<S88>:1:9' */
    /*  Ca = 1/(xv*(1-xv)); */
    /*  Cv = 1/(1-xv); */
    if ((StateFlowGUI_B.Sum2_d > 0.0) && (StateFlowGUI_B.Sum2_d <= 0.5 *
         StateFlowGUI_P.PeriodoQ_Value_m / 4.0)) {
      /* '<S88>:1:14' */
      if ((x1 >= 0.0) && (x1 < 0.1)) {
        /* '<S88>:1:16' */
        /* acc crescente positiva */
        /* '<S88>:1:17' */
        T2 = 55.555555555555543 * x1;

        /* '<S88>:1:18' */
        F = x1 * x1 * 27.777777777777771;

        /* '<S88>:1:19' */
        x2 = 9.259259259259256 * StateFlowGUI_mpower_m(x1);
      } else if ((x1 >= 0.1) && (x1 < 0.30000000000000004)) {
        /* '<S88>:1:22' */
        /* acc costante positiva */
        /* '<S88>:1:23' */
        T2 = 5.5555555555555545;
        ...
        /* acc decrescente positiva */
        /* '<S88>:1:29' */
        T2 = -55.555555555555543 * x1 + 22.222222222222218;
        ...
        /* '<S88>:1:31' */
        x2 = ((((x1 * x1 * 11.111111111111109 + -9.259259259259256 *
                 StateFlowGUI_mpower_m(x1)) - 2.7777777777777777 * x1) -
        ...
        /* acc decrescente negativa */
        /* '<S88>:1:42' */
        T2 = -55.555555555555543 * x1 + 33.333333333333321;
        ...
        /* '<S88>:1:44' */
        x2 = (((((x1 * x1 * 16.666666666666661 + -9.259259259259256 *
                  StateFlowGUI_mpower_m(x1)) + 1.6666666666666665 * x1) -
                9.9999999999999982 * x1) - 0.44444444444444442) +
        ...
        /* '<S88>:1:57' */
        x2 = (((9.259259259259256 * StateFlowGUI_mpower_m(x1) - x1 * x1 *
                27.777777777777771) + 27.777777777777771 * x1) + 1.0) -
          9.259259259259256;
      } else {
        /* acc costante nulla */
      ...
      /* '<S88>:1:66' */
      StateFlowGUI_B.xq = x2 * StateFlowGUI_P.AlzataQ_Value_p / 2.0;

      /* '<S88>:1:67' */
      StateFlowGUI_B.xq_p = StateFlowGUI_P.AlzataQ_Value_p / 2.0 * F /
        (StateFlowGUI_P.PeriodoQ_Value_m / 4.0);
      ...
      /* '<S88>:1:70' */
      x1 = StateFlowGUI_P.PeriodoQ_Value_m / 4.0;
      StateFlowGUI_B.xq_pp = StateFlowGUI_P.AlzataQ_Value_p / 2.0 * T2 / (x1 *
        x1);

      /* '<S88>:1:71' */
      StateFlowGUI_B.yq_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 0.5 * StateFlowGUI_P.PeriodoQ_Value_m /
                4.0) && (StateFlowGUI_B.Sum2_d <= 1.5 *
                         StateFlowGUI_P.PeriodoQ_Value_m / 4.0)) {
      /* '<S88>:1:73' */
      /* '<S88>:1:74' */
      /*  Cj = Ca/xj; */
      if ((x2 >= 0.0) && (x2 < 0.1)) {
        ...
        /* acc decrescente positiva */
        /* '<S88>:1:90' */
        T2 = -55.555555555555543 * x2 + 22.222222222222218;
        ...
        /* acc decrescente negativa */
        /* '<S88>:1:103' */
        T2 = -55.555555555555543 * x2 + 33.333333333333321;
      ...
      /* '<S88>:1:127' */
      StateFlowGUI_B.xq = StateFlowGUI_P.AlzataQ_Value_p / 2.0;

      /* '<S88>:1:128' */
      StateFlowGUI_B.xq_p = 0.0;

      /* '<S88>:1:129' */
      StateFlowGUI_B.yq = -x2 * StateFlowGUI_P.AlzataQ_Value_p;

      /* '<S88>:1:130' */
      StateFlowGUI_B.yq_p = -F * StateFlowGUI_P.AlzataQ_Value_p /
        (StateFlowGUI_P.PeriodoQ_Value_m / 4.0);
      ...
      /* '<S88>:1:132' */
      x1 = StateFlowGUI_P.PeriodoQ_Value_m / 4.0;
      StateFlowGUI_B.yq_pp = StateFlowGUI_P.AlzataQ_Value_p / 2.0 * -T2 / (x1 *
        x1);
    } else if ((StateFlowGUI_B.Sum2_d > 1.5 * StateFlowGUI_P.PeriodoQ_Value_m /
                4.0) && (StateFlowGUI_B.Sum2_d <= 2.5 *
                         StateFlowGUI_P.PeriodoQ_Value_m / 4.0)) {
      /* '<S88>:1:134' */
      /* '<S88>:1:135' */
      /*  Cj = Ca/xj; */
      if ((x3 >= 0.0) && (x3 < 0.1)) {
        ...
        /* acc decrescente positiva */
        /* '<S88>:1:151' */
        T2 = -55.555555555555543 * x3 + 22.222222222222218;
        ...
        /* acc decrescente negativa */
        /* '<S88>:1:164' */
        T2 = -55.555555555555543 * x3 + 33.333333333333321;
      ...
      /* '<S88>:1:188' */
      StateFlowGUI_B.xq = StateFlowGUI_P.AlzataQ_Value_p / 2.0 - x2 *
        StateFlowGUI_P.AlzataQ_Value_p;

      /* '<S88>:1:189' */
      StateFlowGUI_B.xq_p = -F * StateFlowGUI_P.AlzataQ_Value_p /
        (StateFlowGUI_P.PeriodoQ_Value_m / 4.0);

      /* '<S88>:1:190' */
      StateFlowGUI_B.yq = -StateFlowGUI_P.AlzataQ_Value_p;
      ...
      /* '<S88>:1:193' */
      StateFlowGUI_B.yq_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 2.5 * StateFlowGUI_P.PeriodoQ_Value_m /
                4.0) && (StateFlowGUI_B.Sum2_d <= 3.5 *
                         StateFlowGUI_P.PeriodoQ_Value_m / 4.0)) {
      /* '<S88>:1:195' */
      /* '<S88>:1:196' */
      /*  Cj = Ca/xj; */
      if ((x4 >= 0.0) && (x4 < 0.1)) {
        ...
        /* acc decrescente positiva */
        /* '<S88>:1:212' */
        T2 = -55.555555555555543 * x4 + 22.222222222222218;
        ...
        /* acc decrescente negativa */
        /* '<S88>:1:225' */
        T2 = -55.555555555555543 * x4 + 33.333333333333321;
      ...
      StateFlowGUI_B.yq_pp = StateFlowGUI_P.AlzataQ_Value_p / 2.0 * T2 / (x1 *
        x1);
    } else if ((StateFlowGUI_B.Sum2_d > 3.5 * StateFlowGUI_P.PeriodoQ_Value_m /
                4.0) && (StateFlowGUI_B.Sum2_d <= 4.0 *
                         StateFlowGUI_P.PeriodoQ_Value_m / 4.0)) {
      /* '<S88>:1:256' */
      /* '<S88>:1:257' */
      /*  Cj = Ca/xj; */
      if ((x5 >= 0.0) && (x5 < 0.1)) {
        ...
        /* acc decrescente positiva */
        /* '<S88>:1:273' */
        T2 = -55.555555555555543 * x5 + 22.222222222222218;
        ...
        /* acc decrescente negativa */
        /* '<S88>:1:286' */
        T2 = -55.555555555555543 * x5 + 33.333333333333321;
      ...
      /* '<S88>:1:310' */
      StateFlowGUI_B.xq = x2 * StateFlowGUI_P.AlzataQ_Value_p / 2.0 +
        -StateFlowGUI_P.AlzataQ_Value_p / 2.0;

      /* '<S88>:1:311' */
      StateFlowGUI_B.xq_p = F * StateFlowGUI_P.AlzataQ_Value_p / 2.0 /
        (StateFlowGUI_P.PeriodoQ_Value_m / 4.0);
      ...
      /* '<S88>:1:314' */
      x2 = StateFlowGUI_P.PeriodoQ_Value_m / 4.0;
      StateFlowGUI_B.xq_pp = StateFlowGUI_P.AlzataQ_Value_p / 2.0 * T2 / (x2 *
        x2);
    ...
    /* '<S87>:1:3' */
    x4 = StateFlowGUI_B.Sum2_d / StateFlowGUI_P.PeriodoC_Value_p;
    ...
    /* '<S87>:1:7' */
    F = F * 2.0 * 3.1415926535897931 / StateFlowGUI_P.PeriodoC_Value_p;

    /* '<S87>:1:8' */
    x3 = T2 * 2.0 * 3.1415926535897931 / (StateFlowGUI_P.PeriodoC_Value_p *
      StateFlowGUI_P.PeriodoC_Value_p);

    /* '<S87>:1:9' */
    StateFlowGUI_B.xc = cos(1.5707963267948966 - x2) *
      StateFlowGUI_P.AlzataC_Value_p;

    /* '<S87>:1:10' */
    StateFlowGUI_B.yc = sin(1.5707963267948966 - x2) *
      StateFlowGUI_P.AlzataC_Value_p - StateFlowGUI_P.AlzataC_Value_p;

    /* '<S87>:1:11' */
    StateFlowGUI_B.xc_p = sin(1.5707963267948966 - x2) *
      StateFlowGUI_P.AlzataC_Value_p * F;
    ...
    StateFlowGUI_B.xc_pp = cos(1.5707963267948966 - x2) *
      -StateFlowGUI_P.AlzataC_Value_p * (F * F) + sin(1.5707963267948966 - x2) *
      StateFlowGUI_P.AlzataC_Value_p * x3;

    /* '<S87>:1:14' */
    StateFlowGUI_B.yc_pp = sin(1.5707963267948966 - x2) *
      -StateFlowGUI_P.AlzataC_Value_p * (F * F) - cos(1.5707963267948966 - x2) *
      StateFlowGUI_P.AlzataC_Value_p * x3;
    ...
    /* '<S89>:1:2' */
    x1 = StateFlowGUI_P.PeriodoC1_Value_m / 32.0;
    ...
    /* '<S89>:1:45' */
    /* '<S89>:1:46' */
    if ((StateFlowGUI_B.Sum2_d > 0.0) && (StateFlowGUI_B.Sum2_d <= x1 / 2.0)) {
      /* '<S89>:1:48' */
      /*  1 */
      /* '<S89>:1:49' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 0.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F, &T2);
      ...
      /* '<S89>:1:52' */
      StateFlowGUI_B.y = -x2 * StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:53' */
      StateFlowGUI_B.y_p_o = -F * StateFlowGUI_P.AlzataC1_Value_b / (x1 / 2.0);
      ...
      /* '<S89>:1:55' */
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = -T2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > x1 / 2.0) && (StateFlowGUI_B.Sum2_d <=
                3.0 * x1 / 2.0)) {
      /* '<S89>:1:57' */
      /*  2 */
      /* '<S89>:1:58' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - x1 / 2.0) / x1, &x2, &F, &x3);

      /* '<S89>:1:59' */
      StateFlowGUI_B.x = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:60' */
      StateFlowGUI_B.x_p_l = F * 3.0 * StateFlowGUI_P.AlzataC1_Value_b / x1;

      /* '<S89>:1:61' */
      StateFlowGUI_B.y = -StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:62' */
      StateFlowGUI_B.y_p_o = 0.0;

      /* '<S89>:1:63' */
      StateFlowGUI_B.x_pp = x3 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);

      /* '<S89>:1:64' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 3.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 4.0 * x1 / 2.0)) {
      /* '<S89>:1:66' */
      /*  3 */
      /* '<S89>:1:67' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 3.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F, &x4);

      /* '<S89>:1:68' */
      StateFlowGUI_B.x = 3.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:73' */
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = x4 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 4.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 5.0 * x1 / 2.0)) {
      /* '<S89>:1:75' */
      /*  4 */
      /* '<S89>:1:76' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 4.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F, &x5);

      /* '<S89>:1:77' */
      StateFlowGUI_B.x = 3.0 * StateFlowGUI_P.AlzataC1_Value_b - x2 *
        StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:78' */
      StateFlowGUI_B.x_p_l = -F * StateFlowGUI_P.AlzataC1_Value_b / (x1 / 2.0);
      ...
      /* '<S89>:1:81' */
      x1 /= 2.0;
      StateFlowGUI_B.x_pp = -x5 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);

      /* '<S89>:1:82' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 5.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 7.0 * x1 / 2.0)) {
      /* '<S89>:1:84' */
      /*  5 */
      /* '<S89>:1:85' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 5.0 * x1 / 2.0) / x1, &x2,
                           &F, &x5);

      /* '<S89>:1:86' */
      StateFlowGUI_B.x = 2.0 * StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:87' */
      StateFlowGUI_B.x_p_l = 0.0;

      /* '<S89>:1:88' */
      StateFlowGUI_B.y = -x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:89' */
      StateFlowGUI_B.y_p_o = -F * 3.0 * StateFlowGUI_P.AlzataC1_Value_b / x1;

      /* '<S89>:1:90' */
      StateFlowGUI_B.x_pp = 0.0;

      /* '<S89>:1:91' */
      StateFlowGUI_B.y_pp = -x5 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 7.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 9.0 * x1 / 2.0)) {
      /* '<S89>:1:93' */
      /*  6 */
      /* '<S89>:1:94' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 7.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:95' */
      StateFlowGUI_B.x = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b + 2.0 *
        StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:96' */
      StateFlowGUI_B.x_p_l = T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b / x1;

      /* '<S89>:1:97' */
      StateFlowGUI_B.y = -3.0 * StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:98' */
      StateFlowGUI_B.y_p_o = 0.0;

      /* '<S89>:1:99' */
      StateFlowGUI_B.x_pp = F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);

      /* '<S89>:1:100' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 9.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 11.0 * x1 / 2.0)) {
      /* '<S89>:1:102' */
      /*  7 */
      /* '<S89>:1:103' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 9.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:104' */
      StateFlowGUI_B.x = 5.0 * StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:105' */
      StateFlowGUI_B.x_p_l = 0.0;

      /* '<S89>:1:106' */
      StateFlowGUI_B.y = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b + -3.0 *
        StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:107' */
      StateFlowGUI_B.y_p_o = -T2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b / x1;

      /* '<S89>:1:108' */
      StateFlowGUI_B.x_pp = 0.0;

      /* '<S89>:1:109' */
      StateFlowGUI_B.y_pp = F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 11.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 12.0 * x1 / 2.0)) {
      /* '<S89>:1:111' */
      /*  8 */
      /* '<S89>:1:112' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 11.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:113' */
      StateFlowGUI_B.x = 5.0 * StateFlowGUI_P.AlzataC1_Value_b - T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:117' */
      x1 /= 2.0;
      StateFlowGUI_B.x_pp = -x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);

      /* '<S89>:1:118' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 12.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 13.0 * x1 / 2.0)) {
      /* '<S89>:1:120' */
      /*  9 */
      /* '<S89>:1:121' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 12.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:122' */
      StateFlowGUI_B.x = 4.0 * StateFlowGUI_P.AlzataC1_Value_b;

      /* '<S89>:1:123' */
      StateFlowGUI_B.x_p_l = 0.0;

      /* '<S89>:1:124' */
      StateFlowGUI_B.y = -T2 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:127' */
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = -x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 13.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 15.0 * x1 / 2.0)) {
      /* '<S89>:1:129' */
      /*  10 */
      /* '<S89>:1:130' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 13.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:131' */
      StateFlowGUI_B.x = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b + 4.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:136' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 15.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 16.0 * x1 / 2.0)) {
      /* '<S89>:1:138' */
      /*  11 */
      /* '<S89>:1:139' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 15.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:140' */
      StateFlowGUI_B.x = 7.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 16.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 17.0 * x1 / 2.0)) {
      /* '<S89>:1:147' */
      /*  12 */
      /* '<S89>:1:148' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 16.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:149' */
      StateFlowGUI_B.x = 7.0 * StateFlowGUI_P.AlzataC1_Value_b - T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:154' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 17.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 19.0 * x1 / 2.0)) {
      /* '<S89>:1:156' */
      /*  13 */
      /* '<S89>:1:157' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 17.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:158' */
      StateFlowGUI_B.x = 6.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:163' */
      StateFlowGUI_B.y_pp = -F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 19.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 20.0 * x1 / 2.0)) {
      /* '<S89>:1:165' */
      /*  14 */
      /* '<S89>:1:166' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 19.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:167' */
      StateFlowGUI_B.x = 6.0 * StateFlowGUI_P.AlzataC1_Value_b + T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:172' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 20.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 21.0 * x1 / 2.0)) {
      /* '<S89>:1:174' */
      /*  15 */
      /* '<S89>:1:175' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 20.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:178' */
      StateFlowGUI_B.y = -3.0 * StateFlowGUI_P.AlzataC1_Value_b + T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 21.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 23.0 * x1 / 2.0)) {
      /* '<S89>:1:183' */
      /*  16 */
      /* '<S89>:1:184' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 21.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:185' */
      StateFlowGUI_B.x = 7.0 * StateFlowGUI_P.AlzataC1_Value_b - x2 * 3.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:187' */
      StateFlowGUI_B.y = -2.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:190' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 23.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 25.0 * x1 / 2.0)) {
      /* '<S89>:1:192' */
      /*  17 */
      /* '<S89>:1:193' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 23.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);
      ...
      /* '<S89>:1:196' */
      StateFlowGUI_B.y = -2.0 * StateFlowGUI_P.AlzataC1_Value_b - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:199' */
      StateFlowGUI_B.y_pp = -F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 25.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 27.0 * x1 / 2.0)) {
      /* '<S89>:1:201' */
      /*  18 */
      /* '<S89>:1:202' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 25.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:203' */
      StateFlowGUI_B.x = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value_b + 4.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:205' */
      StateFlowGUI_B.y = -5.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:208' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 27.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 28.0 * x1 / 2.0)) {
      /* '<S89>:1:210' */
      /*  19 */
      /* '<S89>:1:211' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 27.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:214' */
      StateFlowGUI_B.y = -5.0 * StateFlowGUI_P.AlzataC1_Value_b + T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 28.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 29.0 * x1 / 2.0)) {
      /* '<S89>:1:219' */
      /*  20 */
      /* '<S89>:1:220' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 28.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:223' */
      StateFlowGUI_B.y = -4.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:226' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 29.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 31.0 * x1 / 2.0)) {
      /* '<S89>:1:228' */
      /*  21 */
      /* '<S89>:1:229' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 29.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);
      ...
      /* '<S89>:1:232' */
      StateFlowGUI_B.y = -4.0 * StateFlowGUI_P.AlzataC1_Value_b - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:235' */
      StateFlowGUI_B.y_pp = -F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 31.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 32.0 * x1 / 2.0)) {
      /* '<S89>:1:237' */
      /*  22 */
      /* '<S89>:1:238' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 31.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:241' */
      StateFlowGUI_B.y = -7.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:244' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 32.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 33.0 * x1 / 2.0)) {
      /* '<S89>:1:246' */
      /*  23 */
      /* '<S89>:1:247' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 32.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:250' */
      StateFlowGUI_B.y = -7.0 * StateFlowGUI_P.AlzataC1_Value_b + T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 33.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 35.0 * x1 / 2.0)) {
      /* '<S89>:1:255' */
      /*  24 */
      /* '<S89>:1:256' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 33.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:257' */
      StateFlowGUI_B.x = 7.0 * StateFlowGUI_P.AlzataC1_Value_b - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:259' */
      StateFlowGUI_B.y = -6.0 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:262' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 35.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 36.0 * x1 / 2.0)) {
      /* '<S89>:1:264' */
      /*  25 */
      /* '<S89>:1:265' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 35.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:268' */
      StateFlowGUI_B.y = -6.0 * StateFlowGUI_P.AlzataC1_Value_b - T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = -x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 36.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 37.0 * x1 / 2.0)) {
      /* '<S89>:1:273' */
      /*  26 */
      /* '<S89>:1:274' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 36.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:275' */
      StateFlowGUI_B.x = 4.0 * StateFlowGUI_P.AlzataC1_Value_b + T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:280' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 37.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 39.0 * x1 / 2.0)) {
      /* '<S89>:1:282' */
      /*  27 */
      /* '<S89>:1:283' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 37.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);
      ...
      /* '<S89>:1:286' */
      StateFlowGUI_B.y = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value_b + -7.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:289' */
      StateFlowGUI_B.y_pp = F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 39.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 41.0 * x1 / 2.0)) {
      /* '<S89>:1:291' */
      /*  28 */
      /* '<S89>:1:292' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 39.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:293' */
      StateFlowGUI_B.x = 5.0 * StateFlowGUI_P.AlzataC1_Value_b - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:298' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 41.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 43.0 * x1 / 2.0)) {
      /* '<S89>:1:300' */
      /*  29 */
      /* '<S89>:1:301' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 41.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);
      ...
      /* '<S89>:1:304' */
      StateFlowGUI_B.y = -4.0 * StateFlowGUI_P.AlzataC1_Value_b - x2 * 3.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:307' */
      StateFlowGUI_B.y_pp = -F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 43.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 44.0 * x1 / 2.0)) {
      /* '<S89>:1:309' */
      /*  30 */
      /* '<S89>:1:310' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 43.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:311' */
      StateFlowGUI_B.x = 2.0 * StateFlowGUI_P.AlzataC1_Value_b + T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:316' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 44.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 45.0 * x1 / 2.0)) {
      /* '<S89>:1:318' */
      /*  31 */
      /* '<S89>:1:319' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 44.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 45.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 47.0 * x1 / 2.0)) {
      /* '<S89>:1:327' */
      /*  32 */
      /* '<S89>:1:328' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 45.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:329' */
      StateFlowGUI_B.x = 3.0 * StateFlowGUI_P.AlzataC1_Value_b - 3.0 * x2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:334' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 47.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 48.0 * x1 / 2.0)) {
      /* '<S89>:1:336' */
      /*  33 */
      /* '<S89>:1:337' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 47.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = -x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 48.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 49.0 * x1 / 2.0)) {
      /* '<S89>:1:345' */
      /*  34 */
      /* '<S89>:1:346' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 48.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:347' */
      StateFlowGUI_B.x = T2 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:352' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 49.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 51.0 * x1 / 2.0)) {
      /* '<S89>:1:354' */
      /*  35 */
      /* '<S89>:1:355' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 49.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:356' */
      StateFlowGUI_B.x = StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:361' */
      StateFlowGUI_B.y_pp = F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 51.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 52.0 * x1 / 2.0)) {
      /* '<S89>:1:363' */
      /*  36 */
      /* '<S89>:1:364' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 51.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);

      /* '<S89>:1:365' */
      StateFlowGUI_B.x = StateFlowGUI_P.AlzataC1_Value_b - T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:370' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 52.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 53.0 * x1 / 2.0)) {
      /* '<S89>:1:372' */
      /*  37 */
      /* '<S89>:1:373' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 52.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:376' */
      StateFlowGUI_B.y = -4.0 * StateFlowGUI_P.AlzataC1_Value_b - T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = -x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 53.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 55.0 * x1 / 2.0)) {
      /* '<S89>:1:381' */
      /*  38 */
      /* '<S89>:1:382' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 53.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:383' */
      StateFlowGUI_B.x = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:388' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 55.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 57.0 * x1 / 2.0)) {
      /* '<S89>:1:390' */
      /*  39 */
      /* '<S89>:1:391' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 55.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);
      ...
      /* '<S89>:1:394' */
      StateFlowGUI_B.y = x2 * 3.0 * StateFlowGUI_P.AlzataC1_Value_b + -5.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:397' */
      StateFlowGUI_B.y_pp = F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 57.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 59.0 * x1 / 2.0)) {
      /* '<S89>:1:399' */
      /*  40 */
      /* '<S89>:1:400' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 57.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);

      /* '<S89>:1:401' */
      StateFlowGUI_B.x = 3.0 * StateFlowGUI_P.AlzataC1_Value_b - x2 * 3.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:406' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 59.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 60.0 * x1 / 2.0)) {
      /* '<S89>:1:408' */
      /*  41 */
      /* '<S89>:1:409' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 59.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:412' */
      StateFlowGUI_B.y = -2.0 * StateFlowGUI_P.AlzataC1_Value_b - T2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      x1 /= 2.0;
      StateFlowGUI_B.y_pp = -x2 * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 60.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 61.0 * x1 / 2.0)) {
      /* '<S89>:1:417' */
      /*  42 */
      /* '<S89>:1:418' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 60.0 * x1 / 2.0) / (x1 / 2.0),
                           &T2, &F, &x2);
      ...
      /* '<S89>:1:424' */
      StateFlowGUI_B.y_pp = 0.0;
    } else if ((StateFlowGUI_B.Sum2_d > 61.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 63.0 * x1 / 2.0)) {
      /* '<S89>:1:426' */
      /*  43 */
      /* '<S89>:1:427' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 61.0 * x1 / 2.0) / x1, &x2,
                           &T2, &F);
      ...
      /* '<S89>:1:430' */
      StateFlowGUI_B.y = 3.0 * x2 * StateFlowGUI_P.AlzataC1_Value_b + -3.0 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:433' */
      StateFlowGUI_B.y_pp = F * StateFlowGUI_P.AlzataC1_Value_b / (x1 * x1);
    } else if ((StateFlowGUI_B.Sum2_d > 63.0 * x1 / 2.0) &&
               (StateFlowGUI_B.Sum2_d <= 64.0 * x1 / 2.0)) {
      /* '<S89>:1:435' */
      /*  44 */
      /* '<S89>:1:436' */
      StateFlowGUI_ldm7t_k((StateFlowGUI_B.Sum2_d - 63.0 * x1 / 2.0) / (x1 / 2.0),
                           &x2, &F, &T2);

      /* '<S89>:1:437' */
      StateFlowGUI_B.x = StateFlowGUI_P.AlzataC1_Value_b - x2 *
        StateFlowGUI_P.AlzataC1_Value_b;
      ...
      /* '<S89>:1:441' */
      x2 = x1 / 2.0;
      StateFlowGUI_B.x_pp = -T2 * StateFlowGUI_P.AlzataC1_Value_b / (x2 * x2);
    ...
    /* '<S86>:1:4' */
    x1 = 100.0 * StateFlowGUI_P.Constant3_Value_o / 2.0;

    /* '<S86>:1:5' */
    /* '<S86>:1:6' */
    T2 = (StateFlowGUI_P.Constant3_Value_o - 0.025) * 100.0 / 2.0;

    /* '<S86>:1:7' */
    /* '<S86>:1:8' */
    x3 = ((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) * 100.0 / 2.0;

    /* '<S86>:1:9' */
    /* '<S86>:1:10' */
    x4 = (((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) - 0.025) * 100.0 /
      2.0;

    /* '<S86>:1:11' */
    /* '<S86>:1:12' */
    T5 = ((((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) - 0.025) - 0.025)
      * 100.0 / 2.0;
    ...
    /* '<S86>:1:17' */
    /* '<S86>:1:18' */
    if ((StateFlowGUI_B.Sum2_d > 0.0) && (StateFlowGUI_B.Sum2_d <= x1)) {
      /* '<S86>:1:20' */
      /*  1 */
      /* '<S86>:1:21' */
      StateFlowGUI_ldm7t_p(StateFlowGUI_B.Sum2_d / x1, &x2, &F, &T2);
      ...
      /* '<S86>:1:24' */
      x3 = T2 * 2.0 * 3.1415926535897931 / (x1 * x1);

      /* '<S86>:1:25' */
      StateFlowGUI_B.xct = StateFlowGUI_P.Constant3_Value_o / 2.0 * cos
        (1.5707963267948966 - x2);

      /* '<S86>:1:26' */
      StateFlowGUI_B.yct = StateFlowGUI_P.Constant3_Value_o / 2.0 * sin
        (1.5707963267948966 - x2) - StateFlowGUI_P.Constant3_Value_o / 2.0;

      /* '<S86>:1:27' */
      StateFlowGUI_B.xct_p = StateFlowGUI_P.Constant3_Value_o / 2.0 * sin
        (1.5707963267948966 - x2) * F;

      /* '<S86>:1:28' */
      StateFlowGUI_B.yct_p = -StateFlowGUI_P.Constant3_Value_o / 2.0 * cos
        (1.5707963267948966 - x2) * F;

      /* '<S86>:1:29' */
      StateFlowGUI_B.xct_pp = -StateFlowGUI_P.Constant3_Value_o / 2.0 * cos
        (1.5707963267948966 - x2) * (F * F) + StateFlowGUI_P.Constant3_Value_o /
        2.0 * sin(1.5707963267948966 - x2) * x3;

      /* '<S86>:1:30' */
      StateFlowGUI_B.yct_pp = -StateFlowGUI_P.Constant3_Value_o / 2.0 * sin
        (1.5707963267948966 - x2) * (F * F) - StateFlowGUI_P.Constant3_Value_o /
        2.0 * cos(1.5707963267948966 - x2) * x3;
    } else if ((StateFlowGUI_B.Sum2_d > x1) && (StateFlowGUI_B.Sum2_d <= x1 + T2))
    {
      /* '<S86>:1:32' */
      /*  2 */
      /* '<S86>:1:33' */
      StateFlowGUI_ldm7t_p((StateFlowGUI_B.Sum2_d - x1) / T2, &x2, &F, &x3);
      ...
      /* '<S86>:1:36' */
      x3 = x3 * 2.0 * 3.1415926535897931 / (T2 * T2);

      /* '<S86>:1:37' */
      StateFlowGUI_B.xct = (StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 *
        cos(1.5707963267948966 - x2);

      /* '<S86>:1:38' */
      StateFlowGUI_B.yct = (StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 *
        sin(1.5707963267948966 - x2) - (StateFlowGUI_P.Constant3_Value_o - 0.025)
        / 2.0;

      /* '<S86>:1:39' */
      StateFlowGUI_B.xct_p = (StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 *
        sin(1.5707963267948966 - x2) * F;

      /* '<S86>:1:40' */
      StateFlowGUI_B.yct_p = -(StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 *
        cos(1.5707963267948966 - x2) * F;

      /* '<S86>:1:41' */
      StateFlowGUI_B.xct_pp = -(StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 *
        cos(1.5707963267948966 - x2) * (F * F) +
        (StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 * sin
        (1.5707963267948966 - x2) * x3;

      /* '<S86>:1:42' */
      StateFlowGUI_B.yct_pp = -(StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 *
        sin(1.5707963267948966 - x2) * (F * F) -
        (StateFlowGUI_P.Constant3_Value_o - 0.025) / 2.0 * cos
        (1.5707963267948966 - x2) * x3;
    } else if ((StateFlowGUI_B.Sum2_d > x1 + T2) && (StateFlowGUI_B.Sum2_d <=
                (x1 + T2) + x3)) {
      /* '<S86>:1:44' */
      /*  3 */
      /* '<S86>:1:45' */
      StateFlowGUI_ldm7t_p(((StateFlowGUI_B.Sum2_d - x1) - T2) / x3, &x2, &F,
                           &x4);
      ...
      /* '<S86>:1:49' */
      StateFlowGUI_B.xct = ((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) /
        2.0 * cos(1.5707963267948966 - x2);

      /* '<S86>:1:50' */
      StateFlowGUI_B.yct = ((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) /
        2.0 * sin(1.5707963267948966 - x2) - ((StateFlowGUI_P.Constant3_Value_o
        - 0.025) - 0.025) / 2.0;

      /* '<S86>:1:51' */
      StateFlowGUI_B.xct_p = ((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025)
        / 2.0 * sin(1.5707963267948966 - x2) * F;

      /* '<S86>:1:52' */
      StateFlowGUI_B.yct_p = -((StateFlowGUI_P.Constant3_Value_o - 0.025) -
        0.025) / 2.0 * cos(1.5707963267948966 - x2) * F;

      /* '<S86>:1:53' */
      StateFlowGUI_B.xct_pp = -((StateFlowGUI_P.Constant3_Value_o - 0.025) -
        0.025) / 2.0 * cos(1.5707963267948966 - x2) * (F * F) +
        ((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) / 2.0 * sin
        (1.5707963267948966 - x2) * x3;

      /* '<S86>:1:54' */
      StateFlowGUI_B.yct_pp = -((StateFlowGUI_P.Constant3_Value_o - 0.025) -
        0.025) / 2.0 * sin(1.5707963267948966 - x2) * (F * F) -
        ((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) / 2.0 * cos
        (1.5707963267948966 - x2) * x3;
    } else if ((StateFlowGUI_B.Sum2_d > (x1 + T2) + x3) &&
               (StateFlowGUI_B.Sum2_d <= ((x1 + T2) + x3) + x4)) {
      /* '<S86>:1:56' */
      /*  4 */
      /* '<S86>:1:57' */
      StateFlowGUI_ldm7t_p((((StateFlowGUI_B.Sum2_d - x1) - T2) - x3) / x4, &x2,
                           &F, &x5);
      ...
      StateFlowGUI_B.yct = (((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025)
                            - 0.025) / 2.0 * sin(1.5707963267948966 - x2) -
        (((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) - 0.025) / 2.0;

      /* '<S86>:1:63' */
      StateFlowGUI_B.xct_p = (((StateFlowGUI_P.Constant3_Value_o - 0.025) -
        0.025) - 0.025) / 2.0 * sin(1.5707963267948966 - x2) * F;
    ...
    } else if ((StateFlowGUI_B.Sum2_d > ((x1 + T2) + x3) + x4) &&
               (StateFlowGUI_B.Sum2_d <= (((x1 + T2) + x3) + x4) + T5)) {
      /* '<S86>:1:68' */
      /*  5 */
      /* '<S86>:1:69' */
      StateFlowGUI_ldm7t_p(((((StateFlowGUI_B.Sum2_d - x1) - T2) - x3) - x4) /
                           T5, &x2, &F, &x5);
      ...
      StateFlowGUI_B.yct = ((((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025)
        - 0.025) - 0.025) / 2.0 * sin(1.5707963267948966 - x2) -
        ((((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) - 0.025) - 0.025)
        / 2.0;
      ...
      StateFlowGUI_B.xct_pp = -((((StateFlowGUI_P.Constant3_Value_o - 0.025) -
        ...
        + ((((StateFlowGUI_P.Constant3_Value_o - 0.025) - 0.025) - 0.025) -
    ...
    /* '<S90>:1:3' */
    /* '<S90>:1:4' */
    if ((StateFlowGUI_B.Sum2_d >= 0.0) && (StateFlowGUI_B.Sum2_d <=
         StateFlowGUI_P.Tempospostiniziale_Value_e)) {
      /* '<S90>:1:5' */
      /* '<S90>:1:6' */
      StateFlowGUI_ldm7t_m(StateFlowGUI_B.Sum2_d /
                           StateFlowGUI_P.Tempospostiniziale_Value_e, &x2, &F,
                           &T2);

      /* '<S90>:1:7' */
      StateFlowGUI_B.xs = x2 * StateFlowGUI_P.Rmin_Value_g;

      /* '<S90>:1:8' */
      StateFlowGUI_B.xs_p = F * StateFlowGUI_P.Rmin_Value_g /
        StateFlowGUI_P.Tempospostiniziale_Value_e;

      /* '<S90>:1:9' */
      StateFlowGUI_B.xs_pp = T2 * StateFlowGUI_P.Rmin_Value_g /
        (StateFlowGUI_P.Tempospostiniziale_Value_e *
         StateFlowGUI_P.Tempospostiniziale_Value_e);
    ...
    } else if ((StateFlowGUI_B.Sum2_d >
                StateFlowGUI_P.Tempospostiniziale_Value_e) &&
               (StateFlowGUI_B.Sum2_d <=
                StateFlowGUI_P.Tempospostiniziale_Value_e +
                StateFlowGUI_P.Periodo_Value_e)) {
      /* '<S90>:1:13' */
      /* '<S90>:1:14' */
      StateFlowGUI_ldm7t_m((StateFlowGUI_B.Sum2_d -
                            StateFlowGUI_P.Tempospostiniziale_Value_e) /
                           StateFlowGUI_P.Periodo_Value_e, &x2, &F, &x3);

      /* '<S90>:1:15' */
      x1 = x2 * StateFlowGUI_P.Rmax_Value_n + StateFlowGUI_P.Rmin_Value_g;

      /* '<S90>:1:16' */
      T2 = F * StateFlowGUI_P.Rmax_Value_n / StateFlowGUI_P.Periodo_Value_e;

      /* '<S90>:1:17' */
      x4 = x3 * StateFlowGUI_P.Rmax_Value_n / (StateFlowGUI_P.Periodo_Value_e *
        StateFlowGUI_P.Periodo_Value_e);
      ...
      /* '<S90>:1:20' */
      x3 = x3 * StateFlowGUI_P.Ngiri_Value_a * 2.0 * 3.1415926535897931 /
        (StateFlowGUI_P.Periodo_Value_e * StateFlowGUI_P.Periodo_Value_e);

      /* '<S90>:1:21' */
      StateFlowGUI_B.xs = x1 * cos(x2);

      /* '<S90>:1:22' */
      StateFlowGUI_B.ys = x1 * sin(x2);

      /* '<S90>:1:23' */
      StateFlowGUI_B.xs_p = -x1 * sin(x2) * F + T2 * cos(x2);

      /* '<S90>:1:24' */
      StateFlowGUI_B.ys_p = x1 * cos(x2) * F + T2 * sin(x2);

      /* '<S90>:1:25' */
      StateFlowGUI_B.xs_pp = ((-T2 * sin(x2) * F - (F * F * cos(x2) + sin(x2) *
        x3) * x1) + x4 * cos(x2)) - T2 * sin(x2) * F;

      /* '<S90>:1:26' */
      StateFlowGUI_B.ys_pp = (((F * F * -sin(x2) + cos(x2) * x3) * x1 + T2 * cos
        (x2) * F) + x4 * sin(x2)) + T2 * cos(x2) * F;
    } else {
      /* '<S90>:1:28' */
      StateFlowGUI_B.xs = cos(StateFlowGUI_P.Ngiri_Value_a * 2.0 *
        3.1415926535897931) * (StateFlowGUI_P.Rmin_Value_g +
        StateFlowGUI_P.Rmax_Value_n);

      /* '<S90>:1:29' */
      StateFlowGUI_B.xs_p = 0.0;

      /* '<S90>:1:30' */
      StateFlowGUI_B.ys = sin(StateFlowGUI_P.Ngiri_Value_a * 2.0 *
        3.1415926535897931) * (StateFlowGUI_P.Rmin_Value_g +
        StateFlowGUI_P.Rmax_Value_n);
     ...
     *  Constant: '<S70>/Rmin3'
     */
    switch ((int32_T)StateFlowGUI_P.selettore_Value_p) {
     case 1:
      StateFlowGUI_B.MultiportSwitch_i[0] = StateFlowGUI_B.xq;
      StateFlowGUI_B.MultiportSwitch_i[1] = StateFlowGUI_B.yq;
      StateFlowGUI_B.MultiportSwitch_i[2] = StateFlowGUI_B.xq_p;
      StateFlowGUI_B.MultiportSwitch_i[3] = StateFlowGUI_B.yq_p;
      StateFlowGUI_B.MultiportSwitch_i[4] = StateFlowGUI_B.xq_pp;
      StateFlowGUI_B.MultiportSwitch_i[5] = StateFlowGUI_B.yq_pp;
      break;

     case 2:
      StateFlowGUI_B.MultiportSwitch_i[0] = StateFlowGUI_B.xc;
      StateFlowGUI_B.MultiportSwitch_i[1] = StateFlowGUI_B.yc;
      StateFlowGUI_B.MultiportSwitch_i[2] = StateFlowGUI_B.xc_p;
      StateFlowGUI_B.MultiportSwitch_i[3] = StateFlowGUI_B.yc_p;
      StateFlowGUI_B.MultiportSwitch_i[4] = StateFlowGUI_B.xc_pp;
      StateFlowGUI_B.MultiportSwitch_i[5] = StateFlowGUI_B.yc_pp;
      break;

     case 3:
      StateFlowGUI_B.MultiportSwitch_i[0] = StateFlowGUI_B.x;
      StateFlowGUI_B.MultiportSwitch_i[1] = StateFlowGUI_B.y;
      StateFlowGUI_B.MultiportSwitch_i[2] = StateFlowGUI_B.x_p_l;
      StateFlowGUI_B.MultiportSwitch_i[3] = StateFlowGUI_B.y_p_o;
      StateFlowGUI_B.MultiportSwitch_i[4] = StateFlowGUI_B.x_pp;
      StateFlowGUI_B.MultiportSwitch_i[5] = StateFlowGUI_B.y_pp;
      break;

     case 4:
      StateFlowGUI_B.MultiportSwitch_i[0] = StateFlowGUI_B.xct;
      StateFlowGUI_B.MultiportSwitch_i[1] = StateFlowGUI_B.yct;
      StateFlowGUI_B.MultiportSwitch_i[2] = StateFlowGUI_B.xct_p;
      StateFlowGUI_B.MultiportSwitch_i[3] = StateFlowGUI_B.yct_p;
      StateFlowGUI_B.MultiportSwitch_i[4] = StateFlowGUI_B.xct_pp;
      StateFlowGUI_B.MultiportSwitch_i[5] = StateFlowGUI_B.yct_pp;
      break;

     case 5:
      StateFlowGUI_B.MultiportSwitch_i[0] = StateFlowGUI_B.xs;
      StateFlowGUI_B.MultiportSwitch_i[1] = StateFlowGUI_B.ys;
      StateFlowGUI_B.MultiportSwitch_i[2] = StateFlowGUI_B.xs_p;
      StateFlowGUI_B.MultiportSwitch_i[3] = StateFlowGUI_B.ys_p;
      StateFlowGUI_B.MultiportSwitch_i[4] = StateFlowGUI_B.xs_pp;
      StateFlowGUI_B.MultiportSwitch_i[5] = StateFlowGUI_B.ys_pp;
      break;

     default:
      StateFlowGUI_B.MultiportSwitch_i[0] = StateFlowGUI_P.Rmax1_Value;
      StateFlowGUI_B.MultiportSwitch_i[1] = StateFlowGUI_P.Ngiri1_Value;
      StateFlowGUI_B.MultiportSwitch_i[2] = StateFlowGUI_P.Rmin1_Value;
      StateFlowGUI_B.MultiportSwitch_i[3] = StateFlowGUI_P.Ngiri2_Value;
      StateFlowGUI_B.MultiportSwitch_i[4] = StateFlowGUI_P.Rmin2_Value;
      StateFlowGUI_B.MultiportSwitch_i[5] = StateFlowGUI_P.Rmin3_Value;
      break;
    }
    ...
    /* Sum: '<S12>/Sum' */
    StateFlowGUI_B.Sum_e = StateFlowGUI_B.x0 + StateFlowGUI_B.MultiportSwitch_i
      [0];

    /* Sum: '<S12>/Sum1' */
    StateFlowGUI_B.Ymov = StateFlowGUI_B.MultiportSwitch_i[1] +
      StateFlowGUI_B.y0;

    /* MATLAB Function: '<S12>/Cinematica Inversa' */
    StateFlowGUI_CinematicaInversa(StateFlowGUI_B.Sum_e, StateFlowGUI_B.Ymov,
      &StateFlowGUI_B.sf_CinematicaInversa_k);

    /* Sum: '<S78>/Sum12' */
    StateFlowGUI_B.Sum12_i = StateFlowGUI_B.convert10_d - StateFlowGUI_B.OffB;

    /* MATLAB Function: '<S78>/Asse B conv brac1' */
    StateFlowGUI_AsseBconvbrac1(StateFlowGUI_B.Sum12_i,
      &StateFlowGUI_B.sf_AsseBconvbrac1_i);

    /* Sum: '<S78>/Sum4' incorporates:
     *  Constant: '<S78>/Constant4'
     */
    StateFlowGUI_B.Sum4_d = StateFlowGUI_B.sf_AsseBconvbrac1_i.pos_B_conv +
      StateFlowGUI_P.Constant4_Value;

    /* Sum: '<S78>/Sum9' */
    StateFlowGUI_B.Sum9_n = StateFlowGUI_B.convert_g - StateFlowGUI_B.OffA;

    /* MATLAB Function: '<S78>/Asse A conv bracc' */
    StateFlowGUI_AsseAconvbrac(StateFlowGUI_B.Sum9_n,
      &StateFlowGUI_B.sf_AsseAconvbracc);

    /* Sum: '<S78>/Sum7' incorporates:
     *  Constant: '<S78>/Constant5'
     */
    StateFlowGUI_B.Sum7_n = StateFlowGUI_B.sf_AsseAconvbracc.pos_A_conv +
    ...
    /* '<S65>:1:3' */
    /* '<S65>:1:6' */
    x1 = sin(StateFlowGUI_B.Sum7_n) - sin(StateFlowGUI_B.Sum4_d);
    J_p_idx_1 = -0.18 - (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d))
      * 0.25;
    x1 = x1 * x1 * 0.0625 + J_p_idx_1 * J_p_idx_1;

    /* '<S65>:1:7' */
    J_p_idx_3 = -0.18 - (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d))
      * 0.25;
    T2 = ((-0.18 - (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) *
           0.25) * ((sin(StateFlowGUI_B.Sum7_n) - sin(StateFlowGUI_B.Sum4_d)) *
                    0.25) * (-0.18 - 0.5 * cos(StateFlowGUI_B.Sum7_n)) + (sin
           (StateFlowGUI_B.Sum7_n) - sin(StateFlowGUI_B.Sum4_d)) * -0.01125 *
          (cos(StateFlowGUI_B.Sum7_n) + cos(StateFlowGUI_B.Sum4_d))) - 0.5 * sin
      (StateFlowGUI_B.Sum7_n) * (J_p_idx_3 * J_p_idx_3);

    /* '<S65>:1:10' */
    x4 = cos(StateFlowGUI_B.Sum7_n) + cos(StateFlowGUI_B.Sum4_d);
    x5 = -0.18 - (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) *
      0.25;

    /*  Posizione Y end-effector */
    /* '<S65>:1:14' */
    x2 = (sqrt(T2 * T2 - ((x4 * x4 * 0.00050625 - (-0.18 - (cos
               (StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) * 0.25) *
             ((cos(StateFlowGUI_B.Sum7_n) + cos(StateFlowGUI_B.Sum4_d)) * 0.0225)
             * (-0.18 - 0.5 * cos(StateFlowGUI_B.Sum7_n))) + (0.045 * cos
             (StateFlowGUI_B.Sum7_n) + 0.0081) * (x5 * x5)) * (4.0 * x1)) + -T2)
      / (2.0 * x1);

    /*  Posizione X end-effector */
    /* '<S65>:1:16' */
    StateFlowGUI_B.x_n = (x2 * 0.25 * (sin(StateFlowGUI_B.Sum7_n) - sin
      (StateFlowGUI_B.Sum4_d)) - (cos(StateFlowGUI_B.Sum7_n) + cos
      (StateFlowGUI_B.Sum4_d)) * 0.0225) / (-0.18 - (cos(StateFlowGUI_B.Sum7_n)
      - cos(StateFlowGUI_B.Sum4_d)) * 0.25);
    StateFlowGUI_B.y_k = x2;

    /* MATLAB Function: '<S12>/Cinematica Inversa vel' */
    x2 = StateFlowGUI_B.MultiportSwitch_i[2];
    T2 = StateFlowGUI_B.MultiportSwitch_i[3];
    ...
    /* '<S64>:1:8' */
    /* '<S64>:1:10' */
    x1 = (StateFlowGUI_B.Ymov - 0.25 * sin
          (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) - (StateFlowGUI_B.Ymov
      - 0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) *
      ((StateFlowGUI_B.Sum_e + 0.09) - 0.25 * cos
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((StateFlowGUI_B.Sum_e
      - 0.09) - 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2));

    /* '<S64>:1:12' */
    x4 = (((StateFlowGUI_B.Sum_e + 0.09) - 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (-0.25 * sin
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) +
          (StateFlowGUI_B.Ymov - 0.25 * sin
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) / x1;

    /* '<S64>:1:14' */
    x1 = ((StateFlowGUI_B.Ymov - 0.25 * sin
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (-0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) *
          ((StateFlowGUI_B.Sum_e + 0.09) - 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) /
          ((StateFlowGUI_B.Sum_e - 0.09) - 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) +
          ((StateFlowGUI_B.Sum_e + 0.09) - 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * sin
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) / x1;
    ...
    J[0] = -(StateFlowGUI_B.Ymov - 0.25 * sin
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) /
      ((StateFlowGUI_B.Sum_e - 0.09) - 0.25 * cos
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * x4;
    J[2] = (-(StateFlowGUI_B.Ymov - 0.25 * sin
              (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) /
            ((StateFlowGUI_B.Sum_e - 0.09) - 0.25 * cos
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * x1 - 0.25 * sin
            (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) +
      (StateFlowGUI_B.Ymov - 0.25 * sin
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((StateFlowGUI_B.Sum_e
      - 0.09) - 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) *
      (0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2));
    J[1] = x4;
    J[3] = x1;
    ...
    StateFlowGUI_B.VelocityB_c = StateFlowGUI_B.EtherCATPDOReceive15_i;

    /* MATLAB Function: '<S82>/Vel Asse B conv' */
    /* MATLAB Function 'Sistema_braccia/Velocita braccia 1/Vel Asse B conv': '<S118>:1' */
    /* '<S118>:1:2' */
    StateFlowGUI_B.vel_B_conv = StateFlowGUI_B.VelocityB_c * 6.2831853071795862 /
      163840.0 / 64.0;
    ...
    StateFlowGUI_B.VelocityA_g = StateFlowGUI_B.EtherCATPDOReceive14_k;

    /* MATLAB Function: '<S82>/Vel Asse A conv' */
    /* MATLAB Function 'Sistema_braccia/Velocita braccia 1/Vel Asse A conv': '<S117>:1' */
    /* '<S117>:1:2' */
    StateFlowGUI_B.vel_A_conv = StateFlowGUI_B.VelocityA_g * 6.2831853071795862 /
      163840.0 / 64.0;

    /* MATLAB Function: '<S12>/Cinematica Inversa Acc' */
    T2 = StateFlowGUI_B.MultiportSwitch_i[4];
    x2 = StateFlowGUI_B.MultiportSwitch_i[5];
    ...
    /* '<S63>:1:22' */
    x1 = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    J_p_idx_1 = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    J_p_idx_3 = (StateFlowGUI_B.Ymov - 0.25 * sin
                 (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) + (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1));

    /* '<S63>:1:25' */
    x4 = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    x5 = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    D2p = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    g_a = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    ...
    /* '<S63>:1:28' */
    i_a = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    ...
    /* '<S63>:1:31' */
    N21 = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    N22 = (0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2);
    ...
    J_p_idx_0 = ((((StateFlowGUI_B.Ymov - 0.25 * sin
                    (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 *
      cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) - ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) *
                  (StateFlowGUI_B.MultiportSwitch_i[3] - 0.25 * cos
                   (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
                   StateFlowGUI_B.theta2_p) / (((StateFlowGUI_B.Ymov - 0.25 *
      sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) + (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) * ((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) - ((((0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1) * StateFlowGUI_B.theta1_p +
      StateFlowGUI_B.MultiportSwitch_i[2]) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) -
      (StateFlowGUI_B.MultiportSwitch_i[3] - 0.25 * cos
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta1) * StateFlowGUI_B.theta1_p)
      * (0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) +
      (StateFlowGUI_B.Ymov - 0.25 * sin
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * StateFlowGUI_B.theta1_p)
      + 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
      StateFlowGUI_B.theta1_p * ((0.09 + StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) * (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) /
                  (((StateFlowGUI_B.Ymov - 0.25 * sin
                     (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      ...
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)))) + (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) * StateFlowGUI_B.theta2_p +
      StateFlowGUI_B.MultiportSwitch_i[2]) * (StateFlowGUI_B.Ymov - 0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) - ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) / (((StateFlowGUI_B.Ymov
      - 0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) + (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) * (x1 * x1))) -
      (((((0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
           StateFlowGUI_B.theta1_p + StateFlowGUI_B.MultiportSwitch_i[2]) *
          (StateFlowGUI_B.Ymov - 0.25 * sin
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((0.09 -
            StateFlowGUI_B.Sum_e) + 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) +
          StateFlowGUI_B.MultiportSwitch_i[3]) +
         (StateFlowGUI_B.MultiportSwitch_i[3] - 0.25 * cos
          (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
          StateFlowGUI_B.theta2_p) * ((0.09 + StateFlowGUI_B.Sum_e) - 0.25 * cos
          (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
           StateFlowGUI_B.Sum_e) + 0.25 * cos
          (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) - 0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1) * StateFlowGUI_B.theta1_p)
       + (0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
          StateFlowGUI_B.theta2_p + StateFlowGUI_B.MultiportSwitch_i[2]) *
       (StateFlowGUI_B.Ymov - 0.25 * sin
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
         StateFlowGUI_B.Sum_e) - 0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / (J_p_idx_1 * J_p_idx_1))
      * (((StateFlowGUI_B.Ymov - 0.25 * sin
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) - ((0.09 +
            StateFlowGUI_B.Sum_e) - 0.25 * cos
         ...
         (StateFlowGUI_B.Ymov - 0.25 * sin
          (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) / (((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (J_p_idx_3 * J_p_idx_3));
    x5 = (((((((((((0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
                    StateFlowGUI_B.theta1_p + StateFlowGUI_B.MultiportSwitch_i[2])
                   * (0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) *
                   (StateFlowGUI_B.Ymov - 0.25 * sin
                    (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((0.09 -
      ...
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) * StateFlowGUI_B.theta2_p *
      ((0.09 + StateFlowGUI_B.Sum_e) - 0.25 * cos
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)))) +
                  (StateFlowGUI_B.MultiportSwitch_i[3] - 0.25 * cos
                   (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
      ...
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) - (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * StateFlowGUI_B.theta2_p *
                 ((0.09 + StateFlowGUI_B.Sum_e) - 0.25 * cos
                  (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) + (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) * StateFlowGUI_B.theta2_p +
      StateFlowGUI_B.MultiportSwitch_i[2]) * (0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / (x4 * x4)) *
               (StateFlowGUI_B.Ymov - 0.25 * sin
                (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) /
               (((StateFlowGUI_B.Ymov - 0.25 * sin
                  (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      ...
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) - 0.25 * cos
               (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
               StateFlowGUI_B.theta2_p) - (StateFlowGUI_B.MultiportSwitch_i[3] -
               0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
               StateFlowGUI_B.theta2_p) * (0.25 * cos
               (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((0.09 -
                StateFlowGUI_B.Sum_e) + 0.25 * cos
      ...
      StateFlowGUI_B.Sum_e) + 0.25 * cos
            ...
            (0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) *
            (StateFlowGUI_B.Ymov - 0.25 * sin
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / (x5 * x5)) +
           ((StateFlowGUI_B.Ymov - 0.25 * sin
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (0.25 * cos
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
              StateFlowGUI_B.Sum_e) - 0.25 * cos
           ...
           (((StateFlowGUI_B.Ymov - 0.25 * sin
              ...
              (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) +
             (StateFlowGUI_B.Ymov - 0.25 * sin
              (StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) * (D2p * D2p))) -
          (((((0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
               StateFlowGUI_B.theta1_p + StateFlowGUI_B.MultiportSwitch_i[2]) *
              (StateFlowGUI_B.Ymov - 0.25 * sin
               (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((0.09 -
             ...
             (StateFlowGUI_B.MultiportSwitch_i[3] - 0.25 * cos
              (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
              StateFlowGUI_B.theta2_p) * ((0.09 + StateFlowGUI_B.Sum_e) - 0.25 *
              cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
               StateFlowGUI_B.Sum_e) + 0.25 * cos
              (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) - 0.25 * cos
            (StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
           ...
           (StateFlowGUI_B.Ymov - 0.25 * sin
            (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
             StateFlowGUI_B.Sum_e) - 0.25 * cos
            (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / (g_a * g_a)) *
          (((StateFlowGUI_B.Ymov - 0.25 * sin
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (0.25 * cos
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
              StateFlowGUI_B.Sum_e) - 0.25 * cos
           ...
           (StateFlowGUI_B.Ymov - 0.25 * sin
            (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) / (((0.09 -
             StateFlowGUI_B.Sum_e) + 0.25 * cos
            (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (T5 * T5))) +
      (StateFlowGUI_B.Ymov - 0.25 * sin
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * StateFlowGUI_B.theta2_p /
      ((0.09 - StateFlowGUI_B.Sum_e) + 0.25 * cos
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta2));
    J_p_idx_1 = -((((0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
                     StateFlowGUI_B.theta1_p + StateFlowGUI_B.MultiportSwitch_i
                     [2]) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) -
                    (StateFlowGUI_B.MultiportSwitch_i[3] - 0.25 * cos
                     (StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
      ...
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) + (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * StateFlowGUI_B.theta1_p)
                  + 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
                  StateFlowGUI_B.theta1_p * ((0.09 + StateFlowGUI_B.Sum_e) -
      0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) /
      ((StateFlowGUI_B.Ymov - 0.25 * sin
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
         StateFlowGUI_B.Sum_e) - 0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
         StateFlowGUI_B.Sum_e) + 0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) + (StateFlowGUI_B.Ymov -
        0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) - (((((0.25 *
      sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
      StateFlowGUI_B.theta1_p + StateFlowGUI_B.MultiportSwitch_i[2]) *
      (StateFlowGUI_B.Ymov - 0.25 * sin
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) +
      StateFlowGUI_B.MultiportSwitch_i[3]) + (StateFlowGUI_B.MultiportSwitch_i[3]
      - 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
      StateFlowGUI_B.theta2_p) * ((0.09 + StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
      StateFlowGUI_B.Sum_e) + 0.25 * cos
      ...
      (StateFlowGUI_B.Ymov - 0.25 * sin
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / (i_a * i_a)) *
      ((StateFlowGUI_B.Ymov - 0.25 * sin
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) - ((0.09 +
         StateFlowGUI_B.Sum_e) - 0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * sin
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) / (j_a * j_a);
    J_p_idx_3 = (((((0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
                     StateFlowGUI_B.theta1_p + StateFlowGUI_B.MultiportSwitch_i
                     [2]) * (0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (StateFlowGUI_B.Ymov -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((0.09 -
      ...
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / (N21 * N21)) /
      ((StateFlowGUI_B.Ymov - 0.25 * sin
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
         StateFlowGUI_B.Sum_e) - 0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / ((0.09 -
      ...
      (StateFlowGUI_B.Ymov - 0.25 * sin
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
      StateFlowGUI_B.Sum_e) - 0.25 * cos
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) / (N22 * N22)) *
      ((StateFlowGUI_B.Ymov - 0.25 * sin
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * ((0.09 +
         StateFlowGUI_B.Sum_e) - 0.25 * cos
        ...
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) + ((0.09 +
         StateFlowGUI_B.Sum_e) - 0.25 * cos
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * (0.25 * sin
        (StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) / (m_a * m_a);
    ...
    /* Sum: '<S12>/Sum4' */
    StateFlowGUI_B.q[0] = StateFlowGUI_B.sf_CinematicaInversa_k.theta1 -
      StateFlowGUI_B.Sum4_d;
    StateFlowGUI_B.q[1] = StateFlowGUI_B.sf_CinematicaInversa_k.theta2 -
      StateFlowGUI_B.Sum7_n;
    ...
    /* '<S69>:1:3' */
    /* '<S69>:1:15' */
    x1 = (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) + 0.72;
    J_p_idx_1 = (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) + 0.72;
    J_p_idx_3 = sin(StateFlowGUI_B.Sum4_d) - sin(StateFlowGUI_B.Sum7_n);
    x4 = J_p_idx_1 * J_p_idx_1 / 2.0 + J_p_idx_3 * J_p_idx_3 / 2.0;
    x5 = sin(StateFlowGUI_B.Sum4_d) - sin(StateFlowGUI_B.Sum7_n);
    D2p = (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) + 0.72;
    g_a = sin(StateFlowGUI_B.Sum4_d) - sin(StateFlowGUI_B.Sum7_n);
    x2 = atan((sqrt((x1 * x1 - x4 * x4) + x5 * x5) + (sin(StateFlowGUI_B.Sum7_n)
                - sin(StateFlowGUI_B.Sum4_d))) / (((D2p * D2p / 2.0 + (cos
      (StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d))) + g_a * g_a / 2.0)
               + 0.72)) * 2.0;

    /* '<S69>:1:19' */
    T5 = (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) + 0.72;
    i_a = (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) + 0.72;
    j_a = sin(StateFlowGUI_B.Sum4_d) - sin(StateFlowGUI_B.Sum7_n);
    N21 = i_a * i_a / 2.0 + j_a * j_a / 2.0;
    N22 = sin(StateFlowGUI_B.Sum4_d) - sin(StateFlowGUI_B.Sum7_n);
    m_a = (cos(StateFlowGUI_B.Sum7_n) - cos(StateFlowGUI_B.Sum4_d)) + 0.72;
    x1 = sin(StateFlowGUI_B.Sum4_d) - sin(StateFlowGUI_B.Sum7_n);
    T2 = atan((sqrt((T5 * T5 - N21 * N21) + N22 * N22) + (sin
                (StateFlowGUI_B.Sum7_n) - sin(StateFlowGUI_B.Sum4_d))) / (((m_a *
      m_a / 2.0 + (cos(StateFlowGUI_B.Sum4_d) - cos(StateFlowGUI_B.Sum7_n))) +
                x1 * x1 / 2.0) - 0.72)) * -2.0;

    /* '<S69>:1:23' */
    x4 = cos(T2) / sin(T2) * sin(StateFlowGUI_B.Sum4_d) - cos
      (StateFlowGUI_B.Sum4_d);

    /* '<S69>:1:24' */
    x5 = cos(StateFlowGUI_B.Sum7_n) - cos(T2) / sin(T2) * sin
      (StateFlowGUI_B.Sum7_n);

    /* '<S69>:1:25' */
    T5 = cos(x2) - cos(T2) / sin(T2) * sin(x2);

    /* '<S69>:1:27' */
    F = (StateFlowGUI_B.vel_B_conv * x4 + StateFlowGUI_B.vel_A_conv * x5) / T5;

    /* '<S69>:1:29' */
    N21 = ((cos(x2) / sin(x2) - cos(T2) / sin(T2)) * sin(StateFlowGUI_B.Sum4_d)
           + cos(T2) / sin(T2) * sin(StateFlowGUI_B.Sum4_d)) - cos
      (StateFlowGUI_B.Sum4_d);

    /* '<S69>:1:31' */
    N22 = ((cos(x2) / sin(x2) - cos(T2) / sin(T2)) * -sin(StateFlowGUI_B.Sum7_n)
           - cos(T2) / sin(T2) * sin(StateFlowGUI_B.Sum7_n)) + cos
      (StateFlowGUI_B.Sum7_n);

    /* '<S69>:1:33' */
    x1 = (cos(x2) / sin(x2) - cos(T2) / sin(T2)) * sin(T2);

    /* '<S69>:1:35' */
    x3 = N21 / x1 * StateFlowGUI_B.vel_B_conv + N22 / x1 *
    ...
    /* '<S69>:1:45' */
    /* '<S69>:1:46' */
    x5 = cos(x2) - cos(T2) / sin(T2) * sin(x2);
    ...
    /* '<S69>:1:58' */
    N21 = sin(T2);
    N21 = (-sin(x2) * F - -1.0 / (N21 * N21) * x3 * sin(x2)) - cos(T2) / sin(T2)
      * cos(x2) * F;
    ...
    D2p = sin(x2);
    g_a = sin(T2);
    D2p = (-1.0 / (D2p * D2p) * F + 1.0 / (g_a * g_a) * x3) * sin(T2) + (cos(x2)
      / sin(x2) - cos(T2) / sin(T2)) * (cos(T2) * x3);

    /* '<S69>:1:68' */
    J_p_idx_0 = (((-1.0 / (x4 * x4) * x3 * sin(StateFlowGUI_B.Sum4_d) + cos(T2) /
                   sin(T2) * cos(StateFlowGUI_B.Sum4_d) *
                   StateFlowGUI_B.vel_B_conv) + sin(StateFlowGUI_B.Sum4_d) *
                  StateFlowGUI_B.vel_B_conv) * x5 - (cos(T2) / sin(T2) * sin
      (StateFlowGUI_B.Sum4_d) - cos(StateFlowGUI_B.Sum4_d)) * N21) / (x5 * x5);
    x5 = (((1.0 / (T5 * T5) * x3 * sin(StateFlowGUI_B.Sum7_n) - cos(T2) / sin(T2)
            * cos(StateFlowGUI_B.Sum7_n) * StateFlowGUI_B.vel_A_conv) - sin
           (StateFlowGUI_B.Sum7_n) * StateFlowGUI_B.vel_A_conv) * x5 - (cos
           (StateFlowGUI_B.Sum7_n) - cos(T2) / sin(T2) * sin
           (StateFlowGUI_B.Sum7_n)) * N21) / (x5 * x5);
    J_p_idx_1 = ((((((-1.0 / (N22 * N22) * F + 1.0 / (m_a * m_a) * x3) * sin
                     (StateFlowGUI_B.Sum4_d) + (cos(x2) / sin(x2) - cos(T2) /
      sin(T2)) * (cos(StateFlowGUI_B.Sum4_d) * StateFlowGUI_B.vel_B_conv)) +
                    -1.0 / (J_p_idx_1 * J_p_idx_1) * x3 * sin
                    (StateFlowGUI_B.Sum4_d)) + cos(T2) / sin(T2) * cos
                   (StateFlowGUI_B.Sum4_d) * StateFlowGUI_B.vel_B_conv) + sin
                  (StateFlowGUI_B.Sum4_d) * StateFlowGUI_B.vel_B_conv) * x1 -
                 (((cos(x2) / sin(x2) - cos(T2) / sin(T2)) * sin
                   (StateFlowGUI_B.Sum4_d) + cos(T2) / sin(T2) * sin
                   (StateFlowGUI_B.Sum4_d)) - cos(StateFlowGUI_B.Sum4_d)) * D2p)
      / (x1 * x1);
    J_p_idx_3 = ((((((cos(x2) / sin(x2) - cos(T2) / sin(T2)) * (-cos
      (StateFlowGUI_B.Sum7_n) * StateFlowGUI_B.vel_A_conv) - (-1.0 / (J_p_idx_3 *
      J_p_idx_3) * F + 1.0 / (i_a * i_a) * x3) * sin(StateFlowGUI_B.Sum7_n)) -
                    -1.0 / (j_a * j_a) * x3 * sin(StateFlowGUI_B.Sum7_n)) - cos
                   (T2) / sin(T2) * cos(StateFlowGUI_B.Sum7_n) *
                   StateFlowGUI_B.vel_A_conv) - sin(StateFlowGUI_B.Sum7_n) *
                  StateFlowGUI_B.vel_A_conv) * x1 - (((cos(x2) / sin(x2) - cos
      (T2) / sin(T2)) * -sin(StateFlowGUI_B.Sum7_n) - cos(T2) / sin(T2) * sin
      (StateFlowGUI_B.Sum7_n)) + cos(StateFlowGUI_B.Sum7_n)) * D2p) / (x1 * x1);

    /* '<S69>:1:70' */
    J1[0] = -0.125 * sin(StateFlowGUI_B.Sum4_d);
    J1[2] = 0.0;
    J1[1] = 0.125 * cos(StateFlowGUI_B.Sum4_d);
    J1[3] = 0.0;

    /* '<S69>:1:72' */
    /* '<S69>:1:75' */
    J2[0] = 0.0;
    J2[2] = -0.125 * sin(StateFlowGUI_B.Sum7_n);
    J2[1] = 0.0;
    J2[3] = 0.125 * cos(StateFlowGUI_B.Sum7_n);

    /* '<S69>:1:77' */
    /* '<S69>:1:80' */
    J3[0] = (0.5 * sin(x2) * J[0] + sin(StateFlowGUI_B.Sum4_d)) * -0.25;
    J3[2] = 0.5 * sin(x2) * J[2] * -0.25;
    J3[1] = (0.5 * cos(x2) * J[0] + cos(StateFlowGUI_B.Sum4_d)) * 0.25;
    J3[3] = 0.5 * cos(x2) * J[2] * 0.25;

    /* '<S69>:1:82' */
    /* '<S69>:1:85' */
    J4[0] = -0.125 * sin(T2) * J[1];
    J4[2] = (0.5 * sin(T2) * J[3] + sin(StateFlowGUI_B.Sum7_n)) * -0.25;
    J4[1] = 0.125 * cos(T2) * J[1];
    J4[3] = (0.5 * cos(T2) * J[3] + cos(StateFlowGUI_B.Sum7_n)) * 0.25;

    /* '<S69>:1:87' */
    /* '<S69>:1:90' */
    JE[0] = (sin(x2) * J[0] + sin(StateFlowGUI_B.Sum4_d)) * -0.25;
    JE[2] = sin(x2) * J[2] * -0.25;
    JE[1] = (cos(x2) * J[0] + cos(StateFlowGUI_B.Sum4_d)) * 0.25;
    ...
    for (bitIdx = 0; bitIdx < 2; bitIdx++) {
      ...
      tmp_0[bitIdx] = j_a;
      y_0[bitIdx] = (x1 + tmp_0[bitIdx]) + N21;
      tmp_1[bitIdx] = 0.0;
      j_a = tmp_1[bitIdx];
      ...
      tmp_0[bitIdx + 2] = j_a;
      y_0[bitIdx + 2] = (tmp_0[bitIdx + 2] + x1) + N21;
      tmp_1[bitIdx + 2] = 0.0;
      j_a = tmp_1[bitIdx + 2];
    ...
    /* '<S69>:1:97' */
    x1 = -0.125 * cos(StateFlowGUI_B.Sum4_d) * StateFlowGUI_B.vel_B_conv;
    x4 = -0.125 * sin(StateFlowGUI_B.Sum4_d) * StateFlowGUI_B.vel_B_conv;
    N22 = -0.125 * cos(StateFlowGUI_B.Sum7_n) * StateFlowGUI_B.vel_A_conv;
    m_a = -0.125 * sin(StateFlowGUI_B.Sum7_n) * StateFlowGUI_B.vel_A_conv;
    D2p = ((0.5 * cos(x2) * F * J[0] + cos(StateFlowGUI_B.Sum4_d) *
            StateFlowGUI_B.vel_B_conv) + 0.5 * sin(x2) * J_p_idx_0) * -0.25;
    T5 = (0.5 * cos(x2) * F * J[2] + 0.5 * sin(x2) * x5) * -0.25;
    i_a = ((-sin(StateFlowGUI_B.Sum4_d) * StateFlowGUI_B.vel_B_conv - 0.5 * sin
            (x2) * F * J[0]) + 0.5 * cos(x2) * J_p_idx_0) * 0.25;
    g_a = (-0.5 * sin(x2) * F * J[2] + 0.5 * cos(x2) * x5) * 0.25;
    tmp_5 = (0.5 * cos(T2) * x3 * J[1] + 0.5 * sin(T2) * J_p_idx_1) * -0.25;
    tmp_6 = ((0.5 * cos(T2) * x3 * J[3] + cos(StateFlowGUI_B.Sum7_n) *
              StateFlowGUI_B.vel_A_conv) + 0.5 * sin(T2) * J_p_idx_3) * -0.25;
    tmp_7 = (-0.5 * sin(T2) * x3 * J[1] + 0.5 * cos(T2) * J_p_idx_1) * 0.25;
    x3 = ((-sin(StateFlowGUI_B.Sum7_n) * StateFlowGUI_B.vel_A_conv - 0.5 * sin
           (T2) * x3 * J[3]) + 0.5 * cos(T2) * J_p_idx_3) * 0.25;
    T2 = ((cos(x2) * F * J[0] + cos(StateFlowGUI_B.Sum4_d) *
           StateFlowGUI_B.vel_B_conv) + sin(x2) * J_p_idx_0) * -0.25;
    tmp_8 = (cos(x2) * F * J[2] + sin(x2) * x5) * -0.25;
    tmp_9 = ((-sin(StateFlowGUI_B.Sum4_d) * StateFlowGUI_B.vel_B_conv - sin(x2) *
    ...
    for (bitIdx = 0; bitIdx < 2; bitIdx++) {
      ...
      J2[bitIdx] = 0.0;
      x2 = J2[bitIdx];
      x2 += J1[bitIdx] * 0.015625;
      J2[bitIdx] = x2;
      x2 = J2[bitIdx];
      x2 += J1[bitIdx + 2] * 0.0;
      J2[bitIdx] = x2;
      F = (real_T)p_a[bitIdx] * x1;
      J2[bitIdx + 2] = 0.0;
      x2 = J2[bitIdx + 2];
      x2 += J1[bitIdx] * 0.0;
      J2[bitIdx + 2] = x2;
      x2 = J2[bitIdx + 2];
      x2 += J1[bitIdx + 2] * 0.015625;
      J2[bitIdx + 2] = x2;
    ...
    F = 0.0002485 - j_a;
    T2 = fabs(F);
    if (T2 > 2.2250738585072014E-308) {
      x2 = 1.0;
      x1 = T2;
    } else {
      x4 = T2 / 2.2250738585072014E-308;
      x2 = x4 * x4;
    }
    ...
    /* Gain: '<S12>/Gain' */
    StateFlowGUI_B.Gain_n = StateFlowGUI_P.Gain_Gain_j * StateFlowGUI_B.Cm1;
    ...
    /* '<S66>:1:4' */
    /* '<S66>:1:6' */
    x1 = 0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
      StateFlowGUI_B.theta2_p;
    J_p_idx_1 = 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
      StateFlowGUI_B.theta2_p;

    /* '<S66>:1:9' */
    J_p_idx_3 = 0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
      StateFlowGUI_B.theta1_p;
    x4 = 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
      StateFlowGUI_B.theta1_p;
    T2 = ((((((0.5 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
               StateFlowGUI_B.MultiportSwitch_i[2] * StateFlowGUI_B.theta1_p +
               StateFlowGUI_B.MultiportSwitch_i[2] *
               StateFlowGUI_B.MultiportSwitch_i[2]) + J_p_idx_3 * J_p_idx_3) +
             (0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
              (StateFlowGUI_B.theta1_p * StateFlowGUI_B.theta1_p) + 0.25 * sin
              (StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
              StateFlowGUI_B.theta1_pp) * ((StateFlowGUI_B.Sum_e + 0.09) - 0.25 *
              cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1))) +
            StateFlowGUI_B.MultiportSwitch_i[3] *
            StateFlowGUI_B.MultiportSwitch_i[3]) - 0.5 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
           StateFlowGUI_B.MultiportSwitch_i[3] * StateFlowGUI_B.theta1_p) + x4 *
          x4) + (0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
                 (StateFlowGUI_B.theta1_p * StateFlowGUI_B.theta1_p) - 0.25 *
                 cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta1) *
                 StateFlowGUI_B.theta1_pp) * (StateFlowGUI_B.Ymov - 0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1));

    /* '<S66>:1:12' */
    x2 = (((StateFlowGUI_B.Sum_e - 0.09) - 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * T2 /
          ((StateFlowGUI_B.Sum_e + 0.09) - 0.25 * cos
           (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) - (((((((0.5 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
      StateFlowGUI_B.MultiportSwitch_i[2] * StateFlowGUI_B.theta2_p +
      StateFlowGUI_B.MultiportSwitch_i[2] * StateFlowGUI_B.MultiportSwitch_i[2])
                + x1 * x1) + (0.25 * cos
                (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
                (StateFlowGUI_B.theta2_p * StateFlowGUI_B.theta2_p) + 0.25 * sin
                (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
                StateFlowGUI_B.theta2_pp) * ((StateFlowGUI_B.Sum_e - 0.09) -
                0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) +
              StateFlowGUI_B.MultiportSwitch_i[3] *
              StateFlowGUI_B.MultiportSwitch_i[3]) - 0.5 * cos
             (StateFlowGUI_B.sf_CinematicaInversa_k.theta2) *
             StateFlowGUI_B.MultiportSwitch_i[3] * StateFlowGUI_B.theta2_p) +
    ...
    StateFlowGUI_B.x_pp_f = ((StateFlowGUI_B.Ymov - 0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta1)) * -x2 - T2) /
      ((StateFlowGUI_B.Sum_e + 0.09) - 0.25 * cos
       (StateFlowGUI_B.sf_CinematicaInversa_k.theta1));
    StateFlowGUI_B.y_pp_l = x2;

    /* Sum: '<S12>/Sum2' */
    StateFlowGUI_B.Sum2_dc = StateFlowGUI_B.x_pp_f -
      StateFlowGUI_B.MultiportSwitch_i[4];

    /* Sum: '<S12>/Sum3' */
    StateFlowGUI_B.Sum3_b = StateFlowGUI_B.y_pp_l -
      StateFlowGUI_B.MultiportSwitch_i[5];
    ...
    for (bitIdx = 0; bitIdx < 2; bitIdx++) {
      ...
      T2 = fabs(StateFlowGUI_B.z[bitIdx]);
      if (T2 > x1) {
        x4 = x1 / T2;
        x2 = x2 * x4 * x4 + 1.0;
        x1 = T2;
    ...
    /* '<S75>:1:38' */
    /* '<S75>:1:39' */
    x1 = StateFlowGUI_norm_n(StateFlowGUI_B.csiH);
    x1 = (39.619574132744681 * StateFlowGUI_norm_n(StateFlowGUI_B.csiH) +
          9.6405136097991448) + x1 * x1 * -0.27679543903127646;

    /* '<S75>:1:41' */
    StateFlowGUI_B.rho = x1;
    StateFlowGUI_B.omega[0] = StateFlowGUI_B.z[0] / x2 * x1;
    StateFlowGUI_B.omega[1] = StateFlowGUI_B.z[1] / x2 * x1;
    ...
    StateFlowGUI_B.x_p = ((-(StateFlowGUI_B.Ymov - 0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((StateFlowGUI_B.Sum_e -
      0.09) - 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * x1 -
      0.25 * sin(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) +
                          (StateFlowGUI_B.Ymov - 0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((StateFlowGUI_B.Sum_e -
      0.09) - 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * (0.25 *
      cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2))) *
      StateFlowGUI_B.theta2_p + -(StateFlowGUI_B.Ymov - 0.25 * sin
      (StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) / ((StateFlowGUI_B.Sum_e -
      0.09) - 0.25 * cos(StateFlowGUI_B.sf_CinematicaInversa_k.theta2)) * x4 *
      StateFlowGUI_B.theta1_p;

    /* '<S76>:1:21' */
    StateFlowGUI_B.y_p = x4 * StateFlowGUI_B.theta1_p + x1 *
      StateFlowGUI_B.theta2_p;
     ...
     *  y = u * K where K = 1 / ( w * Ts )
     */
    StateFlowGUI_B.TSamp_e = StateFlowGUI_B.Sum7_n * StateFlowGUI_P.TSamp_WtEt_m;
    ...
    /* Gain: '<S107>/D*u(k)' */
    StateFlowGUI_B.Duk = StateFlowGUI_P.Duk_Gain * StateFlowGUI_B.Sum7_n;
    ...
    /* Gain: '<S109>/B11' */
    StateFlowGUI_B.B11 = StateFlowGUI_P.B11_Gain * StateFlowGUI_B.Sum7_n;

    /* Sum: '<S107>/A*x1(k) + B*u1(k) ' */
    StateFlowGUI_B.x1k1 = StateFlowGUI_B.sum2_n + StateFlowGUI_B.B11;

    /* Gain: '<S109>/B21' */
    StateFlowGUI_B.B21 = StateFlowGUI_P.B21_Gain * StateFlowGUI_B.Sum7_n;

    /* Sum: '<S107>/A*x2(k) + B*u2(k)' */
    StateFlowGUI_B.x2k1 = StateFlowGUI_B.sum3 + StateFlowGUI_B.B21;

    /* Gain: '<S103>/D*u(k)' */
    StateFlowGUI_B.Duk_h = StateFlowGUI_P.Duk_Gain_h * StateFlowGUI_B.Sum4_d;
     ...
     *  y = u * K where K = 1 / ( w * Ts )
     */
    StateFlowGUI_B.TSamp_nd = StateFlowGUI_B.Sum4_d *
      StateFlowGUI_P.TSamp_WtEt_gh;
    ...
    /* Gain: '<S105>/B11' */
    StateFlowGUI_B.B11_k = StateFlowGUI_P.B11_Gain_f * StateFlowGUI_B.Sum4_d;

    /* Sum: '<S103>/A*x1(k) + B*u1(k) ' */
    StateFlowGUI_B.x1k1_g = StateFlowGUI_B.sum2_nk + StateFlowGUI_B.B11_k;

    /* Gain: '<S105>/B21' */
    StateFlowGUI_B.B21_l = StateFlowGUI_P.B21_Gain_p * StateFlowGUI_B.Sum4_d;
    ...
    /* Gain: '<S80>/Gain' */
    StateFlowGUI_B.Gain_np = StateFlowGUI_P.Gain_Gain_d *
      StateFlowGUI_B.sf_CinematicaInversa_k.theta2;
...
RT_MODEL_StateFlowGUI_T *StateFlowGUI(void)
{
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: StateFlowGUI/<S5>/EtherCAT PDO Transmit 1 (xpcethercatpdotx) */
    {
      ...
      /* inputs */
      {
        _ssSetNumInputPorts(rts, 1);
        ssSetPortInfoForInputs(rts,
          &StateFlowGUI_M->NonInlinedSFcns.Sfcn15.inputPortInfo[0]);
    ...
    /* Level2 S-Function Block: StateFlowGUI/<S55>/EtherCAT PDO Receive14 (xpcethercatpdorx) */
    {
      ...
      {
        ssSetPortInfoForOutputs(rts,
          &StateFlowGUI_M->NonInlinedSFcns.Sfcn20.outputPortInfo[0]);
        _ssSetNumOutputPorts(rts, 1);
    ...
    /* Level2 S-Function Block: StateFlowGUI/<S7>/Torque send (xpcethercatpdotx) */
    {
      ...
      /* inputs */
      {
        _ssSetNumInputPorts(rts, 1);
        ssSetPortInfoForInputs(rts,
          &StateFlowGUI_M->NonInlinedSFcns.Sfcn22.inputPortInfo[0]);
    ...
    /* Level2 S-Function Block: StateFlowGUI/<S82>/EtherCAT PDO Receive15 (xpcethercatpdorx) */
    {
      ...
      {
        ssSetPortInfoForOutputs(rts,
          &StateFlowGUI_M->NonInlinedSFcns.Sfcn26.outputPortInfo[0]);
        _ssSetNumOutputPorts(rts, 1);
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortWidth(rts, 0, 1);
          ssSetOutputPortSignal(rts, 0, ((int32_T *)
            &StateFlowGUI_B.EtherCATPDOReceive15_i));
        }
      }
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P1_Size_o);
        ssSetSFcnParam(rts, 1, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P2_Size_i);
        ssSetSFcnParam(rts, 2, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P3_Size_l);
        ssSetSFcnParam(rts, 3, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P4_Size_g);
        ssSetSFcnParam(rts, 4, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P5_Size_h);
        ssSetSFcnParam(rts, 5, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P6_Size_m);
        ssSetSFcnParam(rts, 6, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P7_Size_n);
      }

      /* work vectors */
      ssSetIWork(rts, (int_T *) &StateFlowGUI_DW.EtherCATPDOReceive15_IWORK_j[0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_INTEGER);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &StateFlowGUI_DW.EtherCATPDOReceive15_IWORK_j[0]);
      }
    ...
    /* Level2 S-Function Block: StateFlowGUI/<S82>/EtherCAT PDO Receive14 (xpcethercatpdorx) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortWidth(rts, 0, 1);
          ssSetOutputPortSignal(rts, 0, ((int32_T *)
            &StateFlowGUI_B.EtherCATPDOReceive14_k));
        }
      }
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParam(rts, 1, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive14_P2_Size_e);
        ssSetSFcnParam(rts, 2, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive14_P3_Size_o);
        ssSetSFcnParam(rts, 3, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive14_P4_Size_f);
        ssSetSFcnParam(rts, 4, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive14_P5_Size_k);
        ssSetSFcnParam(rts, 5, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive14_P6_Size_p);
        ssSetSFcnParam(rts, 6, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive14_P7_Size_kb);
      }

      /* work vectors */
      ssSetIWork(rts, (int_T *) &StateFlowGUI_DW.EtherCATPDOReceive14_IWORK_b[0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_INTEGER);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &StateFlowGUI_DW.EtherCATPDOReceive14_IWORK_b[0]);
      }
    ...
    /* Level2 S-Function Block: StateFlowGUI/<S81>/EtherCAT PDO Receive15 (xpcethercatpdorx) */
    {
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParam(rts, 6, (mxArray*)
                       StateFlowGUI_P.EtherCATPDOReceive15_P7_Size_f5);
      }
  ...
  StateFlowGUI_M->Sizes.numBlocks = (462);/* Number of blocks */
