...
#ifndef RTW_HEADER_TestVite_h_
#define RTW_HEADER_TestVite_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef TestVite_COMMON_INCLUDES_
# define TestVite_COMMON_INCLUDES_
...
#endif                                 /* TestVite_COMMON_INCLUDES_ */

#include "TestVite_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_TestVite               RT_MODEL_TestVite_T

/* Definition for use in the target main file */
#define TestVite_rtModel               RT_MODEL_TestVite_T
...
typedef struct {
  ...
  int16_T ConvertB;                    /* '<Root>/Convert B' */
...
typedef struct {
  ...
  int_T EtherCATPDOTransmit2_IWORK[7]; /* '<Root>/EtherCAT PDO Transmit 2' */
} DW_TestVite_T;

/* Backward compatible GRT Identifiers */
#define rtB                            TestVite_B
#define BlockIO                        B_TestVite_T
#define rtP                            TestVite_P
#define Parameters                     P_TestVite_T
#define rtDWork                        TestVite_DW
#define D_Work                         DW_TestVite_T

/* Parameters (auto storage) */
struct P_TestVite_T_ {
...
extern P_TestVite_T TestVite_P;

/* Block signals (auto storage) */
extern B_TestVite_T TestVite_B;

/* Block states (auto storage) */
extern DW_TestVite_T TestVite_DW;

/*====================*
 * External functions *
 *====================*/
extern TestVite_rtModel *TestVite(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  TestVite_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_TestVite_T *const TestVite_M;
