...
MODEL           = TestVite
MODULES         = rt_matrx.c rt_printf.c TestVite_capi.c TestVite_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c ecat_config_xml_0.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = TestVite.mk
...
S_FUNCTIONS     = xpcethercatpdotx.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 0
...
MODELLIB                  = TestVitelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = TestVite_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\TestVite_slrt_rtw
