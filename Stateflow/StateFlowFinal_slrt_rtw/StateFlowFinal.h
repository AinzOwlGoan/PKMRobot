...
typedef struct {
  ...
  real_T MultiportSwitch[6];           /* '<S56>/Multiport Switch' */
  real_T Xmov;                         /* '<S12>/Sum' */
  ...
  real_T Kd[2];                        /* '<S12>/Kd' */
  real_T q[2];                         /* '<S12>/Sum4' */
  real_T ProportionalGain[2];          /* '<S63>/Proportional Gain' */
  real_T Integrator[2];                /* '<S63>/Integrator' */
  real_T Sum[2];                       /* '<S63>/Sum' */
  real_T Y[2];                         /* '<S12>/Sum9' */
  ...
  real_T IntegralGain[2];              /* '<S63>/Integral Gain' */
  ...
  real_T DiscreteTimeIntegrator1;      /* '<S107>/Discrete-Time Integrator1' */
  real_T DiscreteTimeIntegrator;       /* '<S107>/Discrete-Time Integrator' */
  real_T Gain_i;                       /* '<S107>/Gain' */
  real_T Gain1_f;                      /* '<S107>/Gain1' */
  real_T Sum1_i;                       /* '<S107>/Sum1' */
  real_T Sum2_b;                       /* '<S107>/Sum2' */
  real_T CA;                           /* '<S107>/MATLAB Function' */
  real_T CB;                           /* '<S107>/MATLAB Function' */
  real_T CH;                           /* '<S107>/MATLAB Function' */
  real_T Sum1_e;                       /* '<S106>/Sum1' */
  real_T Conversioneingradi;           /* '<S106>/Conversione in gradi ' */
  real_T DiscreteTimeIntegrator_i;     /* '<S106>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator1_b;    /* '<S106>/Discrete-Time Integrator1' */
  real_T Sum2_g;                       /* '<S106>/Sum2' */
  real_T Gain1_e;                      /* '<S106>/Gain1' */
  real_T Ki1;                          /* '<S106>/Ki1' */
  real_T Ki2;                          /* '<S106>/Ki2' */
  real_T Sum_h;                        /* '<S106>/Sum' */
  real_T Sum3_a;                       /* '<S106>/Sum3' */
  real_T Kp1;                          /* '<S106>/Kp1' */
  real_T Sum4_f;                       /* '<S106>/Sum4' */
  real_T Kp2;                          /* '<S106>/Kp2' */
  real_T Sum5_p;                       /* '<S106>/Sum5' */
  real_T Sum6_n;                       /* '<S106>/Sum6' */
  real_T CA_o;                         /* '<S106>/MATLAB Function1' */
  real_T CB_b;                         /* '<S106>/MATLAB Function1' */
  real_T theta1;                       /* '<S106>/MATLAB Function' */
  real_T theta2;                       /* '<S106>/MATLAB Function' */
  ...
  real_T TmpSignalConversionAtSFunctionI[4];/* '<S12>/MATLAB Function4' */
  real_T omega[2];                     /* '<S12>/MATLAB Function4' */
  real_T TmpSignalConversionAtSFunctio_k[4];/* '<S12>/MATLAB Function3' */
  real_T y;                            /* '<S12>/MATLAB Function3' */
  real_T xp;                           /* '<S12>/MATLAB Function2' */
  real_T yp;                           /* '<S12>/MATLAB Function2' */
  real_T xs;                           /* '<S56>/spirale' */
  real_T ys;                           /* '<S56>/spirale' */
  real_T xs_p;                         /* '<S56>/spirale' */
  real_T ys_p;                         /* '<S56>/spirale' */
  real_T xs_pp;                        /* '<S56>/spirale' */
  real_T ys_pp;                        /* '<S56>/spirale' */
  real_T x;                            /* '<S56>/g' */
  real_T y_c;                          /* '<S56>/g' */
  real_T x_p_l;                        /* '<S56>/g' */
  real_T y_p_o;                        /* '<S56>/g' */
  real_T x_pp;                         /* '<S56>/g' */
  real_T y_pp;                         /* '<S56>/g' */
  real_T xq;                           /* '<S56>/Quadrato' */
  real_T yq;                           /* '<S56>/Quadrato' */
  real_T xq_p;                         /* '<S56>/Quadrato' */
  real_T yq_p;                         /* '<S56>/Quadrato' */
  real_T xq_pp;                        /* '<S56>/Quadrato' */
  real_T yq_pp;                        /* '<S56>/Quadrato' */
  real_T xc;                           /* '<S56>/Cerchio' */
  real_T yc;                           /* '<S56>/Cerchio' */
  real_T xc_p;                         /* '<S56>/Cerchio' */
  real_T yc_p;                         /* '<S56>/Cerchio' */
  real_T xc_pp;                        /* '<S56>/Cerchio' */
  real_T yc_pp;                        /* '<S56>/Cerchio' */
  real_T xct;                          /* '<S56>/Cerchi Tangenti' */
  real_T yct;                          /* '<S56>/Cerchi Tangenti' */
  real_T xct_p;                        /* '<S56>/Cerchi Tangenti' */
  real_T yct_p;                        /* '<S56>/Cerchi Tangenti' */
  real_T xct_pp;                       /* '<S56>/Cerchi Tangenti' */
  real_T yct_pp;                       /* '<S56>/Cerchi Tangenti' */
...
typedef struct {
  real_T Integrator_DSTATE[2];         /* '<S63>/Integrator' */
  ...
  real_T DiscreteTimeIntegrator1_DSTATE;/* '<S107>/Discrete-Time Integrator1' */
  real_T DiscreteTimeIntegrator_DSTATE;/* '<S107>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_c;/* '<S106>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator1_DSTAT_j;/* '<S106>/Discrete-Time Integrator1' */
  ...
  real_T DiscreteTimeIntegrator1_PREV_U;/* '<S107>/Discrete-Time Integrator1' */
  real_T DiscreteTimeIntegrator_PREV_U;/* '<S107>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_PREV_U_j;/* '<S106>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator1_PREV__o;/* '<S106>/Discrete-Time Integrator1' */
  struct {
    real_T EXECRATIO;
  ...
  uint8_T DiscreteTimeIntegrator1_SYSTEM_;/* '<S107>/Discrete-Time Integrator1' */
  uint8_T DiscreteTimeIntegrator_SYSTEM_E;/* '<S107>/Discrete-Time Integrator' */
  uint8_T DiscreteTimeIntegrator_SYSTEM_j;/* '<S106>/Discrete-Time Integrator' */
  uint8_T DiscreteTimeIntegrator1_SYSTE_c;/* '<S106>/Discrete-Time Integrator1' */
...
struct P_StateFlowFinal_T_ {
  ...
  real_T Ki_Value;                     /* Expression: 500
                                        * Referenced by: '<S107>/Ki'
                                        */
  real_T Kp_Value;                     /* Expression: 600
                                        * Referenced by: '<S107>/Kp'
                                        */
  ...
  real_T Integrator_IC;                /* Expression: InitialConditionForIntegrator
                                        * Referenced by: '<S63>/Integrator'
                                        */
  real_T Constant_Value_a;             /* Expression: 3000
  ...
  real_T Memory_X0_o;                  /* Expression: 0
                                        ...
                                        */
  real_T AlzataA_Value;                /* Expression: 0.1
                                        * Referenced by: '<Root>/Alzata A'
                                        */
  real_T PeriodoA_Value;               /* Expression: 3
  ...
  real_T Memory_X0_a;                  /* Expression: 0
                                        ...
                                        */
  real_T AlzataB_Value;                /* Expression: -deg2rad(2*360)
                                        * Referenced by: '<Root>/Alzata B '
                                        */
  real_T PeriodoB_Value;               /* Expression: 3
  ...
  real_T Gain4_Gain;                   /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_ek;           /* Expression: 0
 ...
 * '<S56>'  : 'StateFlowFinal/Sistema_braccia/Leggi di moto'
 * '<S57>'  : 'StateFlowFinal/Sistema_braccia/MATLAB Function'
 * '<S58>'  : 'StateFlowFinal/Sistema_braccia/MATLAB Function1'
 * '<S59>'  : 'StateFlowFinal/Sistema_braccia/MATLAB Function2'
 * '<S60>'  : 'StateFlowFinal/Sistema_braccia/MATLAB Function3'
 * '<S61>'  : 'StateFlowFinal/Sistema_braccia/MATLAB Function4'
 * '<S62>'  : 'StateFlowFinal/Sistema_braccia/MATLAB Jin'
 * '<S63>'  : 'StateFlowFinal/Sistema_braccia/PID Controller'
 ...
 * '<S106>' : 'StateFlowFinal/State flow robot/Posizionamento'
 * '<S107>' : 'StateFlowFinal/State flow robot/Setting'
 * '<S108>' : 'StateFlowFinal/State flow robot/Posizionamento/MATLAB Function'
 * '<S109>' : 'StateFlowFinal/State flow robot/Posizionamento/MATLAB Function1'
 * '<S110>' : 'StateFlowFinal/State flow robot/Setting/MATLAB Function'
 */
