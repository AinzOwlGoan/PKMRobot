...
static void StateFlowFinal_output(void)
{
...

  {
      ...
      switch (StateFlowFinal_DW.is_c15_StateFlowFinal) {
       ...
       case StateFlowFinal_IN_HomeDef:
        ...
        if (sf_internal_predicateOutput) {
          ...
          /*  */
          /* '<S200>:1:8' */
          x1 = (StateFlowFinal_B.Sum_h - 1.0) / 3.0;

          /* '<S200>:1:9' */
          x2 = StateFlowFinal_B.Sum_h / 4.0;
          ...
          /* '<S200>:1:41' */
          StateFlowFinal_B.theta1_p = 46.7149 * F1 / 3.0;

          /* '<S200>:1:42' */
          StateFlowFinal_B.theta2 = 101.1994 * x2;

          /* '<S200>:1:43' */
          StateFlowFinal_B.theta2_p = 101.1994 * F2 / 4.0;
    ...
    /* '<S48>:1:4' */
    /* '<S48>:1:6' */
    x1 = 2.0 * StateFlowFinal_B.Sum * 0.25 + 0.045;

    /* '<S48>:1:7' */
    F2 = 2.0 * StateFlowFinal_B.Ymov * 0.25;

    /* '<S48>:1:8' */
    F1 = ((StateFlowFinal_B.Sum * StateFlowFinal_B.Sum + 0.0081) +
          StateFlowFinal_B.Ymov * StateFlowFinal_B.Ymov) + 2.0 *
      StateFlowFinal_B.Sum * 0.09;

    /* '<S48>:1:9' */
    x2 = 2.0 * StateFlowFinal_B.Sum * 0.25 + -0.045;
    ...
    x2 = (StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta1_l)) -
      ...
      ((StateFlowFinal_B.Sum + 0.09) - 0.25 * cos(StateFlowFinal_B.theta1_l)) /
      ((StateFlowFinal_B.Sum - 0.09) - 0.25 * cos(StateFlowFinal_B.theta2_j));

    /* '<S50>:1:12' */
    x4 = (((StateFlowFinal_B.Sum + 0.09) - 0.25 * cos(StateFlowFinal_B.theta1_l))
    ...
    x2 = ((StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) *
          (-0.25 * cos(StateFlowFinal_B.theta2_j)) * ((StateFlowFinal_B.Sum +
            0.09) - 0.25 * cos(StateFlowFinal_B.theta1_l)) /
          ((StateFlowFinal_B.Sum - 0.09) - 0.25 * cos(StateFlowFinal_B.theta2_j))
          + ((StateFlowFinal_B.Sum + 0.09) - 0.25 * cos
    ...
    J[2] = (-(StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) /
      ...
      (StateFlowFinal_B.theta2_j)) / ((StateFlowFinal_B.Sum - 0.09) - 0.25 * cos
      (StateFlowFinal_B.theta2_j)) * (0.25 * cos(StateFlowFinal_B.theta2_j));
    J[1] = x4;
    J[3] = x2;
    ...
    /* '<S49>:1:22' */
    x2 = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    ...
    J_p_idx_3 = (StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) *
      ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos(StateFlowFinal_B.theta1_l)) /
      ((0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j)) +
      (StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta1_l));

    /* '<S49>:1:25' */
    x4 = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    x5 = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    D2p = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    g_a = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    ...
    /* '<S49>:1:28' */
    i_a = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    ...
    /* '<S49>:1:31' */
    N21 = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    N22 = (0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j);
    ...
    J_p_idx_0 = ((((StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta1_l))
      ...
      StateFlowFinal_B.Sum) - 0.25 * cos(StateFlowFinal_B.theta1_l)) * (0.25 *
      ...
      StateFlowFinal_B.Sum) - 0.25 * cos(StateFlowFinal_B.theta1_l)) / ((0.09 -
      StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j)) +
                    (StateFlowFinal_B.Ymov - 0.25 * sin
                     (StateFlowFinal_B.theta1_l))) * ((0.09 -
      StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j))) - ((((0.25
      ...
      * cos(StateFlowFinal_B.theta1_l) * StateFlowFinal_B.theta1_p_j) * (0.25 *
      ...
      StateFlowFinal_B.theta1_p_j * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l))) * (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) / (((StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) / ((0.09 - StateFlowFinal_B.Sum) + 0.25 * cos
      (StateFlowFinal_B.theta2_j)) + (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta1_l))) * ((0.09 - StateFlowFinal_B.Sum) + 0.25 *
      ...
      * StateFlowFinal_B.theta2_p_p + StateFlowFinal_B.MultiportSwitch[2]) *
      ...
      StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j)) +
                   (StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta1_l)))
                  * (x2 * x2))) - (((((0.25 * sin(StateFlowFinal_B.theta1_l) *
      StateFlowFinal_B.theta1_p_j + StateFlowFinal_B.MultiportSwitch[2]) *
      (StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) / ((0.09 -
      StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j)) +
      StateFlowFinal_B.MultiportSwitch[3]) + (StateFlowFinal_B.MultiportSwitch[3]
      - 0.25 * cos(StateFlowFinal_B.theta2_j) * StateFlowFinal_B.theta2_p_p) *
      ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos(StateFlowFinal_B.theta1_l)) /
      ((0.09 - StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j))) -
      0.25 * cos(StateFlowFinal_B.theta1_l) * StateFlowFinal_B.theta1_p_j) +
      (0.25 * sin(StateFlowFinal_B.theta2_j) * StateFlowFinal_B.theta2_p_p +
       StateFlowFinal_B.MultiportSwitch[2]) * (StateFlowFinal_B.Ymov - 0.25 *
      sin(StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) - 0.25 *
      cos(StateFlowFinal_B.theta1_l)) / (J_p_idx_1 * J_p_idx_1)) *
      (((StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta1_l)) * (0.25 *
         cos(StateFlowFinal_B.theta1_l)) - ((0.09 + StateFlowFinal_B.Sum) - 0.25
         * cos(StateFlowFinal_B.theta1_l)) * (0.25 * sin
         (StateFlowFinal_B.theta1_l))) * (StateFlowFinal_B.Ymov - 0.25 * sin
        (StateFlowFinal_B.theta2_j))) / (((0.09 - StateFlowFinal_B.Sum) + 0.25 *
    ...
    x5 = (((((((((((0.25 * sin(StateFlowFinal_B.theta1_l) *
      ...
      (StateFlowFinal_B.theta2_j)) * (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) / ((0.09 - StateFlowFinal_B.Sum) + 0.25 * cos
      (StateFlowFinal_B.theta2_j)) + ((0.25 * sin(StateFlowFinal_B.theta1_l) *
      ...
      * sin(StateFlowFinal_B.theta2_j)) + 0.25 * cos(StateFlowFinal_B.theta2_j) *
      StateFlowFinal_B.theta2_p_p * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      ...
      StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j))) -
                 ...
                 * (0.25 * sin(StateFlowFinal_B.theta2_j)) *
                 StateFlowFinal_B.theta2_p_p * ((0.09 + StateFlowFinal_B.Sum) -
      0.25 * cos(StateFlowFinal_B.theta1_l)) / ((0.09 - StateFlowFinal_B.Sum) +
      0.25 * cos(StateFlowFinal_B.theta2_j))) + (0.25 * sin
      (StateFlowFinal_B.theta2_j) * StateFlowFinal_B.theta2_p_p +
      StateFlowFinal_B.MultiportSwitch[2]) * (0.25 * cos
      (StateFlowFinal_B.theta2_j)) * (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) / (x4 * x4)) * (StateFlowFinal_B.Ymov - 0.25 *
                sin(StateFlowFinal_B.theta2_j)) / (((StateFlowFinal_B.Ymov -
      0.25 * sin(StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) -
      0.25 * cos(StateFlowFinal_B.theta1_l)) / ((0.09 - StateFlowFinal_B.Sum) +
      0.25 * cos(StateFlowFinal_B.theta2_j)) + (StateFlowFinal_B.Ymov - 0.25 *
      sin(StateFlowFinal_B.theta1_l))) * ((0.09 - StateFlowFinal_B.Sum) + 0.25 *
      cos(StateFlowFinal_B.theta2_j))) - 0.25 * cos(StateFlowFinal_B.theta2_j) *
               StateFlowFinal_B.theta2_p_p) - (StateFlowFinal_B.MultiportSwitch
               [3] - 0.25 * cos(StateFlowFinal_B.theta2_j) *
               StateFlowFinal_B.theta2_p_p) * (0.25 * cos
               (StateFlowFinal_B.theta2_j)) / ((0.09 - StateFlowFinal_B.Sum) +
             ...
             (((StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) *
               ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
                (StateFlowFinal_B.theta1_l)) / ((0.09 - StateFlowFinal_B.Sum) +
                0.25 * cos(StateFlowFinal_B.theta2_j)) + (StateFlowFinal_B.Ymov
           ...
           ((StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) *
            (0.25 * cos(StateFlowFinal_B.theta2_j)) * ((0.09 +
              StateFlowFinal_B.Sum) - 0.25 * cos(StateFlowFinal_B.theta1_l)) /
            ((0.09 - StateFlowFinal_B.Sum) + 0.25 * cos
             (StateFlowFinal_B.theta2_j)) + ((0.09 + StateFlowFinal_B.Sum) -
            ...
            * sin(StateFlowFinal_B.theta2_j)) / (((StateFlowFinal_B.Ymov - 0.25 *
              sin(StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) -
              0.25 * cos(StateFlowFinal_B.theta1_l)) / ((0.09 -
               StateFlowFinal_B.Sum) + 0.25 * cos(StateFlowFinal_B.theta2_j)) +
             (StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta1_l))) *
    ...
    J_p_idx_1 = -((((0.25 * sin(StateFlowFinal_B.theta1_l) *
      ...
      * cos(StateFlowFinal_B.theta1_l) * StateFlowFinal_B.theta1_p_j) * (0.25 *
      ...
      StateFlowFinal_B.MultiportSwitch[2]) * (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) / (i_a * i_a)) * ((StateFlowFinal_B.Ymov -
      0.25 * sin(StateFlowFinal_B.theta1_l)) * (0.25 * cos
      (StateFlowFinal_B.theta1_l)) - ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) * (0.25 * sin(StateFlowFinal_B.theta1_l))) /
      (j_a * j_a);
    J_p_idx_3 = (((((0.25 * sin(StateFlowFinal_B.theta1_l) *
      ...
      * sin(StateFlowFinal_B.theta2_j)) + 0.25 * cos(StateFlowFinal_B.theta2_j) *
      ...
      (StateFlowFinal_B.theta2_j)) * (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) / (N21 * N21)) / ((StateFlowFinal_B.Ymov -
      0.25 * sin(StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) -
      0.25 * cos(StateFlowFinal_B.theta1_l)) / ((0.09 - StateFlowFinal_B.Sum) +
      0.25 * cos(StateFlowFinal_B.theta2_j)) + (StateFlowFinal_B.Ymov - 0.25 *
      sin(StateFlowFinal_B.theta1_l))) - (((((0.25 * sin
      ...
      StateFlowFinal_B.MultiportSwitch[2]) * (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) / (N22 * N22)) * ((StateFlowFinal_B.Ymov -
      0.25 * sin(StateFlowFinal_B.theta2_j)) * (0.25 * cos
      (StateFlowFinal_B.theta2_j)) * ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) / ((0.09 - StateFlowFinal_B.Sum) + 0.25 * cos
      (StateFlowFinal_B.theta2_j)) + ((0.09 + StateFlowFinal_B.Sum) - 0.25 * cos
      (StateFlowFinal_B.theta1_l)) * (0.25 * sin(StateFlowFinal_B.theta2_j))) /
      (m_a * m_a);
    ...
    /* Sum: '<S65>/Sum' */
    StateFlowFinal_B.Sum_f[0] = StateFlowFinal_B.ProportionalGain[0] +
    ...
    /* '<S52>:1:12' */
    F1 = (((StateFlowFinal_B.Sum - 0.09) - 0.25 * cos(StateFlowFinal_B.theta2_j))
          * x1 / ((StateFlowFinal_B.Sum + 0.09) - 0.25 * cos
      ...
      sin(StateFlowFinal_B.theta2_j)) - ((StateFlowFinal_B.Sum - 0.09) - 0.25 *
      cos(StateFlowFinal_B.theta2_j)) / ((StateFlowFinal_B.Sum + 0.09) - 0.25 *
      cos(StateFlowFinal_B.theta1_l)) * (StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta1_l)));

    /* '<S52>:1:14' */
    StateFlowFinal_B.x_pp_f = ((StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta1_l)) * -F1 - x1) / ((StateFlowFinal_B.Sum + 0.09)
      - 0.25 * cos(StateFlowFinal_B.theta1_l));
    ...
    StateFlowFinal_B.x_p = ((-(StateFlowFinal_B.Ymov - 0.25 * sin
      (StateFlowFinal_B.theta2_j)) / ((StateFlowFinal_B.Sum - 0.09) - 0.25 * cos
      (StateFlowFinal_B.theta2_j)) * x2 - 0.25 * sin(StateFlowFinal_B.theta2_j))
      + (StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) /
      ((StateFlowFinal_B.Sum - 0.09) - 0.25 * cos(StateFlowFinal_B.theta2_j)) *
      (0.25 * cos(StateFlowFinal_B.theta2_j))) * StateFlowFinal_B.theta2_p_p +
      -(StateFlowFinal_B.Ymov - 0.25 * sin(StateFlowFinal_B.theta2_j)) /
      ((StateFlowFinal_B.Sum - 0.09) - 0.25 * cos(StateFlowFinal_B.theta2_j)) *
      x4 * StateFlowFinal_B.theta1_p_j;
