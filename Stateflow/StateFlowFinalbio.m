...
bio(81).dim=[1,1];
bio(81).sigWidth=1;
bio(81).sigAddress='&StateFlowFinal_B.theta1_p_j';
bio(81).ndims=2;
bio(81).size=[];
...
bio(82).dim=[1,1];
bio(82).sigWidth=1;
bio(82).sigAddress='&StateFlowFinal_B.theta2_p_p';
bio(82).ndims=2;
bio(82).size=[];
...
bio(109).dim=[1,1];
bio(109).sigWidth=1;
bio(109).sigAddress='&StateFlowFinal_B.Sum';
bio(109).ndims=2;
bio(109).size=[];
...
bio(205).dim=[2,1];
bio(205).sigWidth=2;
bio(205).sigAddress='&StateFlowFinal_B.Sum_f[0]';
bio(205).ndims=2;
bio(205).size=[];
...
bio(230).dim=[1,1];
bio(230).sigWidth=1;
bio(230).sigAddress='&StateFlowFinal_B.theta1_p';
bio(230).ndims=2;
bio(230).size=[];
bio(230).isStruct=false;

bio(231).blkName='State flow robot/Posizionamento/MATLAB Function/p3';
bio(231).sigName='';
bio(231).portIdx=2;
bio(231).dim=[1,1];
bio(231).sigWidth=1;
bio(231).sigAddress='&StateFlowFinal_B.theta2';
bio(231).ndims=2;
bio(231).size=[];
bio(231).isStruct=false;

bio(232).blkName='State flow robot/Posizionamento/MATLAB Function/p4';
bio(232).sigName='';
bio(232).portIdx=3;
bio(232).dim=[1,1];
bio(232).sigWidth=1;
bio(232).sigAddress='&StateFlowFinal_B.theta2_p';
bio(232).ndims=2;
bio(232).size=[];
bio(232).isStruct=false;

bio(233).blkName='State flow robot/Posizionamento/MATLAB Function1/p1';
bio(233).sigName='';
bio(233).portIdx=0;
bio(233).dim=[1,1];
bio(233).sigWidth=1;
bio(233).sigAddress='&StateFlowFinal_B.CA_o';
bio(233).ndims=2;
bio(233).size=[];
bio(233).isStruct=false;

bio(234).blkName='State flow robot/Posizionamento/MATLAB Function1/p2';
bio(234).sigName='';
bio(234).portIdx=1;
bio(234).dim=[1,1];
bio(234).sigWidth=1;
bio(234).sigAddress='&StateFlowFinal_B.CB_b';
bio(234).ndims=2;
bio(234).size=[];
bio(234).isStruct=false;

bio(235).blkName='State flow robot/Posizionamento/Discrete-Time Integrator';
bio(235).sigName='';
bio(235).portIdx=0;
bio(235).dim=[1,1];
bio(235).sigWidth=1;
bio(235).sigAddress='&StateFlowFinal_B.DiscreteTimeIntegrator_i';
bio(235).ndims=2;
bio(235).size=[];
bio(235).isStruct=false;

bio(236).blkName='State flow robot/Posizionamento/Discrete-Time Integrator1';
bio(236).sigName='';
bio(236).portIdx=0;
bio(236).dim=[1,1];
bio(236).sigWidth=1;
bio(236).sigAddress='&StateFlowFinal_B.DiscreteTimeIntegrator1_b';
bio(236).ndims=2;
bio(236).size=[];
bio(236).isStruct=false;

bio(237).blkName='State flow robot/Posizionamento/Conversione';
bio(237).sigName='';
bio(237).portIdx=0;
bio(237).dim=[1,1];
bio(237).sigWidth=1;
bio(237).sigAddress='&StateFlowFinal_B.Conversione';
bio(237).ndims=2;
bio(237).size=[];
bio(237).isStruct=false;

bio(238).blkName='State flow robot/Posizionamento/Gain1';
bio(238).sigName='';
bio(238).portIdx=0;
bio(238).dim=[1,1];
bio(238).sigWidth=1;
bio(238).sigAddress='&StateFlowFinal_B.Gain1_e';
bio(238).ndims=2;
bio(238).size=[];
bio(238).isStruct=false;

bio(239).blkName='State flow robot/Posizionamento/Ki1';
bio(239).sigName='';
bio(239).portIdx=0;
bio(239).dim=[1,1];
bio(239).sigWidth=1;
bio(239).sigAddress='&StateFlowFinal_B.Ki1';
bio(239).ndims=2;
bio(239).size=[];
bio(239).isStruct=false;

bio(240).blkName='State flow robot/Posizionamento/Ki2';
bio(240).sigName='';
bio(240).portIdx=0;
bio(240).dim=[1,1];
bio(240).sigWidth=1;
bio(240).sigAddress='&StateFlowFinal_B.Ki2';
bio(240).ndims=2;
bio(240).size=[];
bio(240).isStruct=false;

bio(241).blkName='State flow robot/Posizionamento/Kp1';
bio(241).sigName='';
bio(241).portIdx=0;
bio(241).dim=[1,1];
bio(241).sigWidth=1;
bio(241).sigAddress='&StateFlowFinal_B.Kp1_g';
bio(241).ndims=2;
bio(241).size=[];
bio(241).isStruct=false;

bio(242).blkName='State flow robot/Posizionamento/Kp2';
bio(242).sigName='';
bio(242).portIdx=0;
bio(242).dim=[1,1];
bio(242).sigWidth=1;
bio(242).sigAddress='&StateFlowFinal_B.Kp2';
bio(242).ndims=2;
bio(242).size=[];
bio(242).isStruct=false;

bio(243).blkName='State flow robot/Posizionamento/Sum';
bio(243).sigName='';
bio(243).portIdx=0;
bio(243).dim=[1,1];
bio(243).sigWidth=1;
bio(243).sigAddress='&StateFlowFinal_B.Sum_h';
bio(243).ndims=2;
bio(243).size=[];
bio(243).isStruct=false;

bio(244).blkName='State flow robot/Posizionamento/Sum1';
bio(244).sigName='';
bio(244).portIdx=0;
bio(244).dim=[1,1];
bio(244).sigWidth=1;
bio(244).sigAddress='&StateFlowFinal_B.Sum1_e';
bio(244).ndims=2;
bio(244).size=[];
bio(244).isStruct=false;

bio(245).blkName='State flow robot/Posizionamento/Sum2';
bio(245).sigName='';
bio(245).portIdx=0;
bio(245).dim=[1,1];
bio(245).sigWidth=1;
bio(245).sigAddress='&StateFlowFinal_B.Sum2_g';
bio(245).ndims=2;
bio(245).size=[];
bio(245).isStruct=false;

bio(246).blkName='State flow robot/Posizionamento/Sum3';
bio(246).sigName='';
bio(246).portIdx=0;
bio(246).dim=[1,1];
bio(246).sigWidth=1;
bio(246).sigAddress='&StateFlowFinal_B.Sum3_a';
bio(246).ndims=2;
bio(246).size=[];
bio(246).isStruct=false;

bio(247).blkName='State flow robot/Posizionamento/Sum4';
bio(247).sigName='';
bio(247).portIdx=0;
bio(247).dim=[1,1];
bio(247).sigWidth=1;
bio(247).sigAddress='&StateFlowFinal_B.Sum4_f';
bio(247).ndims=2;
bio(247).size=[];
bio(247).isStruct=false;

bio(248).blkName='State flow robot/Posizionamento/Sum5';
bio(248).sigName='';
bio(248).portIdx=0;
bio(248).dim=[1,1];
bio(248).sigWidth=1;
bio(248).sigAddress='&StateFlowFinal_B.Sum5_p';
bio(248).ndims=2;
bio(248).size=[];
bio(248).isStruct=false;

bio(249).blkName='State flow robot/Posizionamento/Sum6';
bio(249).sigName='';
bio(249).portIdx=0;
bio(249).dim=[1,1];
bio(249).sigWidth=1;
bio(249).sigAddress='&StateFlowFinal_B.Sum6_n';
bio(249).ndims=2;
bio(249).size=[];
bio(249).isStruct=false;

bio(250).blkName='State flow robot/Setting/MATLAB Function/p1';
bio(250).sigName='';
bio(250).portIdx=0;
bio(250).dim=[1,1];
bio(250).sigWidth=1;
bio(250).sigAddress='&StateFlowFinal_B.CA';
bio(250).ndims=2;
bio(250).size=[];
bio(250).isStruct=false;

bio(251).blkName='State flow robot/Setting/MATLAB Function/p2';
bio(251).sigName='';
bio(251).portIdx=1;
bio(251).dim=[1,1];
bio(251).sigWidth=1;
bio(251).sigAddress='&StateFlowFinal_B.CB';
bio(251).ndims=2;
bio(251).size=[];
bio(251).isStruct=false;

bio(252).blkName='State flow robot/Setting/MATLAB Function/p3';
bio(252).sigName='';
bio(252).portIdx=2;
bio(252).dim=[1,1];
bio(252).sigWidth=1;
bio(252).sigAddress='&StateFlowFinal_B.CH';
bio(252).ndims=2;
bio(252).size=[];
bio(252).isStruct=false;

bio(253).blkName='State flow robot/Setting/Discrete-Time Integrator';
bio(253).sigName='';
bio(253).portIdx=0;
bio(253).dim=[1,1];
bio(253).sigWidth=1;
bio(253).sigAddress='&StateFlowFinal_B.DiscreteTimeIntegrator';
bio(253).ndims=2;
bio(253).size=[];
bio(253).isStruct=false;

bio(254).blkName='State flow robot/Setting/Discrete-Time Integrator1';
bio(254).sigName='';
bio(254).portIdx=0;
bio(254).dim=[1,1];
bio(254).sigWidth=1;
bio(254).sigAddress='&StateFlowFinal_B.DiscreteTimeIntegrator1';
bio(254).ndims=2;
bio(254).size=[];
bio(254).isStruct=false;

bio(255).blkName='State flow robot/Setting/Gain';
bio(255).sigName='';
bio(255).portIdx=0;
bio(255).dim=[1,1];
bio(255).sigWidth=1;
bio(255).sigAddress='&StateFlowFinal_B.Gain_i';
bio(255).ndims=2;
bio(255).size=[];
bio(255).isStruct=false;

bio(256).blkName='State flow robot/Setting/Gain1';
bio(256).sigName='';
bio(256).portIdx=0;
bio(256).dim=[1,1];
bio(256).sigWidth=1;
bio(256).sigAddress='&StateFlowFinal_B.Gain1_f';
bio(256).ndims=2;
bio(256).size=[];
bio(256).isStruct=false;

bio(257).blkName='State flow robot/Setting/Sum1';
bio(257).sigName='';
bio(257).portIdx=0;
bio(257).dim=[1,1];
bio(257).sigWidth=1;
bio(257).sigAddress='&StateFlowFinal_B.Sum1_i';
bio(257).ndims=2;
bio(257).size=[];
bio(257).isStruct=false;

bio(258).blkName='State flow robot/Setting/Sum2';
bio(258).sigName='';
bio(258).portIdx=0;
bio(258).dim=[1,1];
bio(258).sigWidth=1;
bio(258).sigAddress='&StateFlowFinal_B.Sum2_b';
bio(258).ndims=2;
bio(258).size=[];
bio(258).isStruct=false;

bio(259).blkName='Sistema Vite/Actual A/Discrete Derivative A/Diff';
bio(259).sigName='';
bio(259).portIdx=0;
bio(259).dim=[1,1];
bio(259).sigWidth=1;
bio(259).sigAddress='&StateFlowFinal_B.Diff_l';
bio(259).ndims=2;
bio(259).size=[];
bio(259).isStruct=false;

bio(260).blkName='Sistema Vite/Actual A/Discrete Derivative A/TSamp';
bio(260).sigName='';
bio(260).portIdx=0;
bio(260).dim=[1,1];
bio(260).sigWidth=1;
bio(260).sigAddress='&StateFlowFinal_B.TSamp_i';
bio(260).ndims=2;
bio(260).size=[];
bio(260).isStruct=false;

bio(261).blkName='Sistema Vite/Actual A/Discrete Derivative A/UD';
bio(261).sigName='U(k-1)';
bio(261).portIdx=0;
bio(261).dim=[1,1];
bio(261).sigWidth=1;
bio(261).sigAddress='&StateFlowFinal_B.Uk1_p';
bio(261).ndims=2;
bio(261).size=[];
bio(261).isStruct=false;

bio(262).blkName='Sistema Vite/Actual A/Posizione attuale Vite A/Asse A conv';
bio(262).sigName='';
bio(262).portIdx=0;
bio(262).dim=[1,1];
bio(262).sigWidth=1;
bio(262).sigAddress='&StateFlowFinal_B.pos_A_conv_c';
bio(262).ndims=2;
bio(262).size=[];
bio(262).isStruct=false;

bio(263).blkName='Sistema Vite/Actual A/Posizione attuale Vite A/Asse B conv v';
bio(263).sigName='';
bio(263).portIdx=0;
bio(263).dim=[1,1];
bio(263).sigWidth=1;
bio(263).sigAddress='&StateFlowFinal_B.pos_B_conv_v';
bio(263).ndims=2;
bio(263).size=[];
bio(263).isStruct=false;

bio(264).blkName='Sistema Vite/Actual A/Posizione attuale Vite A/Sum5';
bio(264).sigName='';
bio(264).portIdx=0;
bio(264).dim=[1,1];
bio(264).sigWidth=1;
bio(264).sigAddress='&StateFlowFinal_B.Sum5';
bio(264).ndims=2;
bio(264).size=[];
bio(264).isStruct=false;

bio(265).blkName='Sistema_braccia/Kalman Filter1/CalculateYhat/Product';
bio(265).sigName='';
bio(265).portIdx=0;
bio(265).dim=[1,1];
bio(265).sigWidth=1;
bio(265).sigAddress='&StateFlowFinal_B.Product';
bio(265).ndims=2;
bio(265).size=[];
bio(265).isStruct=false;

bio(266).blkName='Sistema_braccia/Kalman Filter1/CalculateYhat/Product1';
bio(266).sigName='';
bio(266).portIdx=0;
bio(266).dim=[1,1];
bio(266).sigWidth=1;
bio(266).sigAddress='&StateFlowFinal_B.Product1';
bio(266).ndims=2;
bio(266).size=[];
bio(266).isStruct=false;

bio(267).blkName='Sistema_braccia/Kalman Filter1/CalculateYhat/Add1';
bio(267).sigName='';
bio(267).portIdx=0;
bio(267).dim=[1,1];
bio(267).sigWidth=1;
bio(267).sigAddress='&StateFlowFinal_B.Add1';
bio(267).ndims=2;
bio(267).size=[];
bio(267).isStruct=false;

bio(268).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionA/Conversion';
bio(268).sigName='';
bio(268).portIdx=0;
bio(268).dim=[2,2];
bio(268).sigWidth=4;
bio(268).sigAddress='&StateFlowFinal_B.Conversion_d[0]';
bio(268).ndims=2;
bio(268).size=[];
bio(268).isStruct=false;

bio(269).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionB/Conversion';
bio(269).sigName='';
bio(269).portIdx=0;
bio(269).dim=[2,1];
bio(269).sigWidth=2;
bio(269).sigAddress='&StateFlowFinal_B.Conversion_me[0]';
bio(269).ndims=2;
bio(269).size=[];
bio(269).isStruct=false;

bio(270).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionC/Conversion';
bio(270).sigName='';
bio(270).portIdx=0;
bio(270).dim=[1,2];
bio(270).sigWidth=2;
bio(270).sigAddress='&StateFlowFinal_B.Conversion_g[0]';
bio(270).ndims=2;
bio(270).size=[];
bio(270).isStruct=false;

bio(271).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionD/Conversion';
bio(271).sigName='';
bio(271).portIdx=0;
bio(271).dim=[1,1];
bio(271).sigWidth=1;
bio(271).sigAddress='&StateFlowFinal_B.Conversion_n';
bio(271).ndims=2;
bio(271).size=[];
bio(271).isStruct=false;

bio(272).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionG/Conversion';
bio(272).sigName='';
bio(272).portIdx=0;
bio(272).dim=[2,2];
bio(272).sigWidth=4;
bio(272).sigAddress='&StateFlowFinal_B.Conversion_l[0]';
bio(272).ndims=2;
bio(272).size=[];
bio(272).isStruct=false;

bio(273).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionH/Conversion';
bio(273).sigName='';
bio(273).portIdx=0;
bio(273).dim=[1,2];
bio(273).sigWidth=2;
bio(273).sigAddress='&StateFlowFinal_B.Conversion_pk[0]';
bio(273).ndims=2;
bio(273).size=[];
bio(273).isStruct=false;

bio(274).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionN/Conversion';
bio(274).sigName='';
bio(274).portIdx=0;
bio(274).dim=[2,1];
bio(274).sigWidth=2;
bio(274).sigAddress='&StateFlowFinal_B.Conversion_cs[0]';
bio(274).ndims=2;
bio(274).size=[];
bio(274).isStruct=false;

bio(275).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionP/Conversion';
bio(275).sigName='';
bio(275).portIdx=0;
bio(275).dim=[2,2];
bio(275).sigWidth=4;
bio(275).sigAddress='&StateFlowFinal_B.Conversion_ks[0]';
bio(275).ndims=2;
bio(275).size=[];
bio(275).isStruct=false;

bio(276).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionP0/Conversion';
bio(276).sigName='';
bio(276).portIdx=0;
bio(276).dim=[2,2];
bio(276).sigWidth=4;
bio(276).sigAddress='&StateFlowFinal_B.Conversion_kg[0]';
bio(276).ndims=2;
bio(276).size=[];
bio(276).isStruct=false;

bio(277).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionQ/Conversion';
bio(277).sigName='';
bio(277).portIdx=0;
bio(277).dim=[2,2];
bio(277).sigWidth=4;
bio(277).sigAddress='&StateFlowFinal_B.Conversion_px[0]';
bio(277).ndims=2;
bio(277).size=[];
bio(277).isStruct=false;

bio(278).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionR/Conversion';
bio(278).sigName='';
bio(278).portIdx=0;
bio(278).dim=[1,1];
bio(278).sigWidth=1;
bio(278).sigAddress='&StateFlowFinal_B.Conversion_h';
bio(278).ndims=2;
bio(278).size=[];
bio(278).isStruct=false;

bio(279).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionReset/Conversion';
bio(279).sigName='';
bio(279).portIdx=0;
bio(279).dim=[1,1];
bio(279).sigWidth=1;
bio(279).sigAddress='&StateFlowFinal_B.Conversion_n2';
bio(279).ndims=2;
bio(279).size=[];
bio(279).isStruct=false;

bio(280).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionX/Conversion';
bio(280).sigName='';
bio(280).portIdx=0;
bio(280).dim=[2,1];
bio(280).sigWidth=2;
bio(280).sigAddress='&StateFlowFinal_B.Conversion_i[0]';
bio(280).ndims=2;
bio(280).size=[];
bio(280).isStruct=false;

bio(281).blkName='Sistema_braccia/Kalman Filter1/DataTypeConversionX0/Conversion';
bio(281).sigName='';
bio(281).portIdx=0;
bio(281).dim=[2,1];
bio(281).sigWidth=2;
bio(281).sigAddress='&StateFlowFinal_B.Conversion_m[0]';
bio(281).ndims=2;
bio(281).size=[];
bio(281).isStruct=false;

bio(282).blkName='Sistema_braccia/Kalman Filter1/Observer/A[k]*xhat[k|k-1]';
bio(282).sigName='';
bio(282).portIdx=0;
bio(282).dim=[2,1];
bio(282).sigWidth=2;
bio(282).sigAddress='&StateFlowFinal_B.Akxhatkk1[0]';
bio(282).ndims=2;
bio(282).size=[];
bio(282).isStruct=false;

bio(283).blkName='Sistema_braccia/Kalman Filter1/Observer/B[k]*u[k]';
bio(283).sigName='';
bio(283).portIdx=0;
bio(283).dim=[2,1];
bio(283).sigWidth=2;
bio(283).sigAddress='&StateFlowFinal_B.Bkuk[0]';
bio(283).ndims=2;
bio(283).size=[];
bio(283).isStruct=false;

bio(284).blkName='Sistema_braccia/Kalman Filter1/Observer/Reshape';
bio(284).sigName='';
bio(284).portIdx=0;
bio(284).dim=[2,1];
bio(284).sigWidth=2;
bio(284).sigAddress='&StateFlowFinal_B.Reshape[0]';
bio(284).ndims=2;
bio(284).size=[];
bio(284).isStruct=false;

bio(285).blkName='Sistema_braccia/Kalman Filter1/Observer/Add';
bio(285).sigName='';
bio(285).portIdx=0;
bio(285).dim=[2,1];
bio(285).sigWidth=2;
bio(285).sigAddress='&StateFlowFinal_B.Add[0]';
bio(285).ndims=2;
bio(285).size=[];
bio(285).isStruct=false;

bio(286).blkName='Sistema_braccia/Kalman Filter1/UseCurrentEstimator/Add';
bio(286).sigName='';
bio(286).portIdx=0;
bio(286).dim=[2,1];
bio(286).sigWidth=2;
bio(286).sigAddress='&StateFlowFinal_B.UseCurrentEstimator_e.Add[0]';
bio(286).ndims=2;
bio(286).size=[];
bio(286).isStruct=false;

bio(287).blkName='Sistema_braccia/Kalman Filter2/CalculateYhat/Product';
bio(287).sigName='';
bio(287).portIdx=0;
bio(287).dim=[1,1];
bio(287).sigWidth=1;
bio(287).sigAddress='&StateFlowFinal_B.Product_m';
bio(287).ndims=2;
bio(287).size=[];
bio(287).isStruct=false;

bio(288).blkName='Sistema_braccia/Kalman Filter2/CalculateYhat/Product1';
bio(288).sigName='';
bio(288).portIdx=0;
bio(288).dim=[1,1];
bio(288).sigWidth=1;
bio(288).sigAddress='&StateFlowFinal_B.Product1_l';
bio(288).ndims=2;
bio(288).size=[];
bio(288).isStruct=false;

bio(289).blkName='Sistema_braccia/Kalman Filter2/CalculateYhat/Add1';
bio(289).sigName='';
bio(289).portIdx=0;
bio(289).dim=[1,1];
bio(289).sigWidth=1;
bio(289).sigAddress='&StateFlowFinal_B.Add1_a';
bio(289).ndims=2;
bio(289).size=[];
bio(289).isStruct=false;

bio(290).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionA/Conversion';
bio(290).sigName='';
bio(290).portIdx=0;
bio(290).dim=[2,2];
bio(290).sigWidth=4;
bio(290).sigAddress='&StateFlowFinal_B.Conversion_b[0]';
bio(290).ndims=2;
bio(290).size=[];
bio(290).isStruct=false;

bio(291).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionB/Conversion';
bio(291).sigName='';
bio(291).portIdx=0;
bio(291).dim=[2,1];
bio(291).sigWidth=2;
bio(291).sigAddress='&StateFlowFinal_B.Conversion_pt[0]';
bio(291).ndims=2;
bio(291).size=[];
bio(291).isStruct=false;

bio(292).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionC/Conversion';
bio(292).sigName='';
bio(292).portIdx=0;
bio(292).dim=[1,2];
bio(292).sigWidth=2;
bio(292).sigAddress='&StateFlowFinal_B.Conversion_f[0]';
bio(292).ndims=2;
bio(292).size=[];
bio(292).isStruct=false;

bio(293).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionD/Conversion';
bio(293).sigName='';
bio(293).portIdx=0;
bio(293).dim=[1,1];
bio(293).sigWidth=1;
bio(293).sigAddress='&StateFlowFinal_B.Conversion_a';
bio(293).ndims=2;
bio(293).size=[];
bio(293).isStruct=false;

bio(294).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionG/Conversion';
bio(294).sigName='';
bio(294).portIdx=0;
bio(294).dim=[2,2];
bio(294).sigWidth=4;
bio(294).sigAddress='&StateFlowFinal_B.Conversion_i1[0]';
bio(294).ndims=2;
bio(294).size=[];
bio(294).isStruct=false;

bio(295).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionH/Conversion';
bio(295).sigName='';
bio(295).portIdx=0;
bio(295).dim=[1,2];
bio(295).sigWidth=2;
bio(295).sigAddress='&StateFlowFinal_B.Conversion_g3[0]';
bio(295).ndims=2;
bio(295).size=[];
bio(295).isStruct=false;

bio(296).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionN/Conversion';
bio(296).sigName='';
bio(296).portIdx=0;
bio(296).dim=[2,1];
bio(296).sigWidth=2;
bio(296).sigAddress='&StateFlowFinal_B.Conversion_jd[0]';
bio(296).ndims=2;
bio(296).size=[];
bio(296).isStruct=false;

bio(297).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionP/Conversion';
bio(297).sigName='';
bio(297).portIdx=0;
bio(297).dim=[2,2];
bio(297).sigWidth=4;
bio(297).sigAddress='&StateFlowFinal_B.Conversion_gp[0]';
bio(297).ndims=2;
bio(297).size=[];
bio(297).isStruct=false;

bio(298).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionP0/Conversion';
bio(298).sigName='';
bio(298).portIdx=0;
bio(298).dim=[2,2];
bio(298).sigWidth=4;
bio(298).sigAddress='&StateFlowFinal_B.Conversion_pv[0]';
bio(298).ndims=2;
bio(298).size=[];
bio(298).isStruct=false;

bio(299).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionQ/Conversion';
bio(299).sigName='';
bio(299).portIdx=0;
bio(299).dim=[2,2];
bio(299).sigWidth=4;
bio(299).sigAddress='&StateFlowFinal_B.Conversion_d0[0]';
bio(299).ndims=2;
bio(299).size=[];
bio(299).isStruct=false;

bio(300).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionR/Conversion';
bio(300).sigName='';
bio(300).portIdx=0;
bio(300).dim=[1,1];
bio(300).sigWidth=1;
bio(300).sigAddress='&StateFlowFinal_B.Conversion_o';
bio(300).ndims=2;
bio(300).size=[];
bio(300).isStruct=false;

bio(301).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionReset/Conversion';
bio(301).sigName='';
bio(301).portIdx=0;
bio(301).dim=[1,1];
bio(301).sigWidth=1;
bio(301).sigAddress='&StateFlowFinal_B.Conversion_dw';
bio(301).ndims=2;
bio(301).size=[];
bio(301).isStruct=false;

bio(302).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionX/Conversion';
bio(302).sigName='';
bio(302).portIdx=0;
bio(302).dim=[2,1];
bio(302).sigWidth=2;
bio(302).sigAddress='&StateFlowFinal_B.Conversion_pc[0]';
bio(302).ndims=2;
bio(302).size=[];
bio(302).isStruct=false;

bio(303).blkName='Sistema_braccia/Kalman Filter2/DataTypeConversionX0/Conversion';
bio(303).sigName='';
bio(303).portIdx=0;
bio(303).dim=[2,1];
bio(303).sigWidth=2;
bio(303).sigAddress='&StateFlowFinal_B.Conversion_p[0]';
bio(303).ndims=2;
bio(303).size=[];
bio(303).isStruct=false;

bio(304).blkName='Sistema_braccia/Kalman Filter2/Observer/A[k]*xhat[k|k-1]';
bio(304).sigName='';
bio(304).portIdx=0;
bio(304).dim=[2,1];
bio(304).sigWidth=2;
bio(304).sigAddress='&StateFlowFinal_B.Akxhatkk1_b[0]';
bio(304).ndims=2;
bio(304).size=[];
bio(304).isStruct=false;

bio(305).blkName='Sistema_braccia/Kalman Filter2/Observer/B[k]*u[k]';
bio(305).sigName='';
bio(305).portIdx=0;
bio(305).dim=[2,1];
bio(305).sigWidth=2;
bio(305).sigAddress='&StateFlowFinal_B.Bkuk_b[0]';
bio(305).ndims=2;
bio(305).size=[];
bio(305).isStruct=false;

bio(306).blkName='Sistema_braccia/Kalman Filter2/Observer/Reshape';
bio(306).sigName='';
bio(306).portIdx=0;
bio(306).dim=[2,1];
bio(306).sigWidth=2;
bio(306).sigAddress='&StateFlowFinal_B.Reshape_c[0]';
bio(306).ndims=2;
bio(306).size=[];
bio(306).isStruct=false;

bio(307).blkName='Sistema_braccia/Kalman Filter2/Observer/Add';
bio(307).sigName='';
bio(307).portIdx=0;
bio(307).dim=[2,1];
bio(307).sigWidth=2;
bio(307).sigAddress='&StateFlowFinal_B.Add_f[0]';
bio(307).ndims=2;
bio(307).size=[];
bio(307).isStruct=false;

bio(308).blkName='Sistema_braccia/Kalman Filter2/UseCurrentEstimator/Add';
bio(308).sigName='';
bio(308).portIdx=0;
bio(308).dim=[2,1];
bio(308).sigWidth=2;
bio(308).sigAddress='&StateFlowFinal_B.UseCurrentEstimator.Add[0]';
bio(308).ndims=2;
bio(308).size=[];
bio(308).isStruct=false;

bio(309).blkName='Sistema_braccia/Posizioni/Discrete Derivative B/Diff';
bio(309).sigName='';
bio(309).portIdx=0;
bio(309).dim=[1,1];
bio(309).sigWidth=1;
bio(309).sigAddress='&StateFlowFinal_B.Diff_i';
bio(309).ndims=2;
bio(309).size=[];
bio(309).isStruct=false;

bio(310).blkName='Sistema_braccia/Posizioni/Discrete Derivative B/TSamp';
bio(310).sigName='';
bio(310).portIdx=0;
bio(310).dim=[1,1];
bio(310).sigWidth=1;
bio(310).sigAddress='&StateFlowFinal_B.TSamp_n';
bio(310).ndims=2;
bio(310).size=[];
bio(310).isStruct=false;

bio(311).blkName='Sistema_braccia/Posizioni/Discrete Derivative B/UD';
bio(311).sigName='U(k-1)';
bio(311).portIdx=0;
bio(311).dim=[1,1];
bio(311).sigWidth=1;
bio(311).sigAddress='&StateFlowFinal_B.Uk1_d';
bio(311).ndims=2;
bio(311).size=[];
bio(311).isStruct=false;

bio(312).blkName='Sistema_braccia/Posizioni/Discrete Derivative B1/Diff';
bio(312).sigName='';
bio(312).portIdx=0;
bio(312).dim=[1,1];
bio(312).sigWidth=1;
bio(312).sigAddress='&StateFlowFinal_B.Diff_d';
bio(312).ndims=2;
bio(312).size=[];
bio(312).isStruct=false;

bio(313).blkName='Sistema_braccia/Posizioni/Discrete Derivative B1/TSamp';
bio(313).sigName='';
bio(313).portIdx=0;
bio(313).dim=[1,1];
bio(313).sigWidth=1;
bio(313).sigAddress='&StateFlowFinal_B.TSamp_h';
bio(313).ndims=2;
bio(313).size=[];
bio(313).isStruct=false;

bio(314).blkName='Sistema_braccia/Posizioni/Discrete Derivative B1/UD';
bio(314).sigName='U(k-1)';
bio(314).portIdx=0;
bio(314).dim=[1,1];
bio(314).sigWidth=1;
bio(314).sigAddress='&StateFlowFinal_B.Uk1_b';
bio(314).ndims=2;
bio(314).size=[];
bio(314).isStruct=false;

bio(315).blkName='Sistema_braccia/Posizioni/Discrete Derivative B2/Diff';
bio(315).sigName='';
bio(315).portIdx=0;
bio(315).dim=[1,1];
bio(315).sigWidth=1;
bio(315).sigAddress='&StateFlowFinal_B.Diff_f';
bio(315).ndims=2;
bio(315).size=[];
bio(315).isStruct=false;

bio(316).blkName='Sistema_braccia/Posizioni/Discrete Derivative B2/TSamp';
bio(316).sigName='';
bio(316).portIdx=0;
bio(316).dim=[1,1];
bio(316).sigWidth=1;
bio(316).sigAddress='&StateFlowFinal_B.TSamp_e';
bio(316).ndims=2;
bio(316).size=[];
bio(316).isStruct=false;

bio(317).blkName='Sistema_braccia/Posizioni/Discrete Derivative B2/UD';
bio(317).sigName='U(k-1)';
bio(317).portIdx=0;
bio(317).dim=[1,1];
bio(317).sigWidth=1;
bio(317).sigAddress='&StateFlowFinal_B.Uk1_l';
bio(317).ndims=2;
bio(317).size=[];
bio(317).isStruct=false;

bio(318).blkName='Sistema_braccia/Posizioni/Discrete Derivative B3/Diff';
bio(318).sigName='';
bio(318).portIdx=0;
bio(318).dim=[1,1];
bio(318).sigWidth=1;
bio(318).sigAddress='&StateFlowFinal_B.Diff_n';
bio(318).ndims=2;
bio(318).size=[];
bio(318).isStruct=false;

bio(319).blkName='Sistema_braccia/Posizioni/Discrete Derivative B3/TSamp';
bio(319).sigName='';
bio(319).portIdx=0;
bio(319).dim=[1,1];
bio(319).sigWidth=1;
bio(319).sigAddress='&StateFlowFinal_B.TSamp_nd';
bio(319).ndims=2;
bio(319).size=[];
bio(319).isStruct=false;

bio(320).blkName='Sistema_braccia/Posizioni/Discrete Derivative B3/UD';
bio(320).sigName='U(k-1)';
bio(320).portIdx=0;
bio(320).dim=[1,1];
bio(320).sigWidth=1;
bio(320).sigAddress='&StateFlowFinal_B.Uk1_ll';
bio(320).ndims=2;
bio(320).size=[];
bio(320).isStruct=false;

bio(321).blkName='Sistema_braccia/Posizioni/Discrete Derivative B4/Diff';
bio(321).sigName='';
bio(321).portIdx=0;
bio(321).dim=[1,1];
bio(321).sigWidth=1;
bio(321).sigAddress='&StateFlowFinal_B.Diff_b';
bio(321).ndims=2;
bio(321).size=[];
bio(321).isStruct=false;

bio(322).blkName='Sistema_braccia/Posizioni/Discrete Derivative B4/TSamp';
bio(322).sigName='';
bio(322).portIdx=0;
bio(322).dim=[1,1];
bio(322).sigWidth=1;
bio(322).sigAddress='&StateFlowFinal_B.TSamp_f';
bio(322).ndims=2;
bio(322).size=[];
bio(322).isStruct=false;

bio(323).blkName='Sistema_braccia/Posizioni/Discrete Derivative B4/UD';
bio(323).sigName='U(k-1)';
bio(323).portIdx=0;
bio(323).dim=[1,1];
bio(323).sigWidth=1;
bio(323).sigAddress='&StateFlowFinal_B.Uk1_j';
bio(323).ndims=2;
bio(323).size=[];
bio(323).isStruct=false;

bio(324).blkName='Sistema_braccia/Posizioni/Discrete Derivative B5/Diff';
bio(324).sigName='';
bio(324).portIdx=0;
bio(324).dim=[1,1];
bio(324).sigWidth=1;
bio(324).sigAddress='&StateFlowFinal_B.Diff_bt';
bio(324).ndims=2;
bio(324).size=[];
bio(324).isStruct=false;

bio(325).blkName='Sistema_braccia/Posizioni/Discrete Derivative B5/TSamp';
bio(325).sigName='';
bio(325).portIdx=0;
bio(325).dim=[1,1];
bio(325).sigWidth=1;
bio(325).sigAddress='&StateFlowFinal_B.TSamp_iq';
bio(325).ndims=2;
bio(325).size=[];
bio(325).isStruct=false;

bio(326).blkName='Sistema_braccia/Posizioni/Discrete Derivative B5/UD';
bio(326).sigName='U(k-1)';
bio(326).portIdx=0;
bio(326).dim=[1,1];
bio(326).sigWidth=1;
bio(326).sigAddress='&StateFlowFinal_B.Uk1_bl';
bio(326).ndims=2;
bio(326).size=[];
bio(326).isStruct=false;

bio(327).blkName='Sistema_braccia/Kalman Filter1/CalculatePL/DataTypeConversionL/Conversion';
bio(327).sigName='';
bio(327).portIdx=0;
bio(327).dim=[2,1];
bio(327).sigWidth=2;
bio(327).sigAddress='&StateFlowFinal_B.Conversion_c[0]';
bio(327).ndims=2;
bio(327).size=[];
bio(327).isStruct=false;

bio(328).blkName='Sistema_braccia/Kalman Filter1/CalculatePL/DataTypeConversionM/Conversion';
bio(328).sigName='';
bio(328).portIdx=0;
bio(328).dim=[2,1];
bio(328).sigWidth=2;
bio(328).sigAddress='&StateFlowFinal_B.Conversion_j[0]';
bio(328).ndims=2;
bio(328).size=[];
bio(328).isStruct=false;

bio(329).blkName='Sistema_braccia/Kalman Filter1/CalculatePL/DataTypeConversionP/Conversion';
bio(329).sigName='';
bio(329).portIdx=0;
bio(329).dim=[1,1];
bio(329).sigWidth=1;
bio(329).sigAddress='&StateFlowFinal_B.Conversion_j0';
bio(329).ndims=2;
bio(329).size=[];
bio(329).isStruct=false;

bio(330).blkName='Sistema_braccia/Kalman Filter1/CalculatePL/DataTypeConversionZ/Conversion';
bio(330).sigName='';
bio(330).portIdx=0;
bio(330).dim=[2,2];
bio(330).sigWidth=4;
bio(330).sigAddress='&StateFlowFinal_B.Conversion_k[0]';
bio(330).ndims=2;
bio(330).size=[];
bio(330).isStruct=false;

bio(331).blkName='Sistema_braccia/Kalman Filter1/Observer/MeasurementUpdate/C[k]*xhat[k|k-1]';
bio(331).sigName='';
bio(331).portIdx=0;
bio(331).dim=[1,1];
bio(331).sigWidth=1;
bio(331).sigAddress='&StateFlowFinal_B.MeasurementUpdate.Ckxhatkk1';
bio(331).ndims=2;
bio(331).size=[];
bio(331).isStruct=false;

bio(332).blkName='Sistema_braccia/Kalman Filter1/Observer/MeasurementUpdate/D[k]*u[k]';
bio(332).sigName='';
bio(332).portIdx=0;
bio(332).dim=[1,1];
bio(332).sigWidth=1;
bio(332).sigAddress='&StateFlowFinal_B.MeasurementUpdate.Dkuk';
bio(332).ndims=2;
bio(332).size=[];
bio(332).isStruct=false;

bio(333).blkName='Sistema_braccia/Kalman Filter1/Observer/MeasurementUpdate/Product3';
bio(333).sigName='';
bio(333).portIdx=0;
bio(333).dim=[2,1];
bio(333).sigWidth=2;
bio(333).sigAddress='&StateFlowFinal_B.MeasurementUpdate.Product3[0]';
bio(333).ndims=2;
bio(333).size=[];
bio(333).isStruct=false;

bio(334).blkName='Sistema_braccia/Kalman Filter1/Observer/MeasurementUpdate/Add1';
bio(334).sigName='yhat[k|k-1]';
bio(334).portIdx=0;
bio(334).dim=[1,1];
bio(334).sigWidth=1;
bio(334).sigAddress='&StateFlowFinal_B.MeasurementUpdate.yhatkk1';
bio(334).ndims=2;
bio(334).size=[];
bio(334).isStruct=false;

bio(335).blkName='Sistema_braccia/Kalman Filter1/Observer/MeasurementUpdate/Sum';
bio(335).sigName='';
bio(335).portIdx=0;
bio(335).dim=[1,1];
bio(335).sigWidth=1;
bio(335).sigAddress='&StateFlowFinal_B.MeasurementUpdate.Sum';
bio(335).ndims=2;
bio(335).size=[];
bio(335).isStruct=false;

bio(336).blkName='Sistema_braccia/Kalman Filter1/UseCurrentEstimator/Enabled Subsystem/Product';
bio(336).sigName='';
bio(336).portIdx=0;
bio(336).dim=[1,1];
bio(336).sigWidth=1;
bio(336).sigAddress='&StateFlowFinal_B.UseCurrentEstimator_e.Product';
bio(336).ndims=2;
bio(336).size=[];
bio(336).isStruct=false;

bio(337).blkName='Sistema_braccia/Kalman Filter1/UseCurrentEstimator/Enabled Subsystem/Product1';
bio(337).sigName='';
bio(337).portIdx=0;
bio(337).dim=[1,1];
bio(337).sigWidth=1;
bio(337).sigAddress='&StateFlowFinal_B.UseCurrentEstimator_e.Product1';
bio(337).ndims=2;
bio(337).size=[];
bio(337).isStruct=false;

bio(338).blkName='Sistema_braccia/Kalman Filter1/UseCurrentEstimator/Enabled Subsystem/Product2';
bio(338).sigName='';
bio(338).portIdx=0;
bio(338).dim=[2,1];
bio(338).sigWidth=2;
bio(338).sigAddress='&StateFlowFinal_B.UseCurrentEstimator_e.Product2[0]';
bio(338).ndims=2;
bio(338).size=[];
bio(338).isStruct=false;

bio(339).blkName='Sistema_braccia/Kalman Filter1/UseCurrentEstimator/Enabled Subsystem/Add1';
bio(339).sigName='';
bio(339).portIdx=0;
bio(339).dim=[1,1];
bio(339).sigWidth=1;
bio(339).sigAddress='&StateFlowFinal_B.UseCurrentEstimator_e.Add1';
bio(339).ndims=2;
bio(339).size=[];
bio(339).isStruct=false;

bio(340).blkName='Sistema_braccia/Kalman Filter2/CalculatePL/DataTypeConversionL/Conversion';
bio(340).sigName='';
bio(340).portIdx=0;
bio(340).dim=[2,1];
bio(340).sigWidth=2;
bio(340).sigAddress='&StateFlowFinal_B.Conversion_ky[0]';
bio(340).ndims=2;
bio(340).size=[];
bio(340).isStruct=false;

bio(341).blkName='Sistema_braccia/Kalman Filter2/CalculatePL/DataTypeConversionM/Conversion';
bio(341).sigName='';
bio(341).portIdx=0;
bio(341).dim=[2,1];
bio(341).sigWidth=2;
bio(341).sigAddress='&StateFlowFinal_B.Conversion[0]';
bio(341).ndims=2;
bio(341).size=[];
bio(341).isStruct=false;

bio(342).blkName='Sistema_braccia/Kalman Filter2/CalculatePL/DataTypeConversionP/Conversion';
bio(342).sigName='';
bio(342).portIdx=0;
bio(342).dim=[1,1];
bio(342).sigWidth=1;
bio(342).sigAddress='&StateFlowFinal_B.Conversion_pq';
bio(342).ndims=2;
bio(342).size=[];
bio(342).isStruct=false;

bio(343).blkName='Sistema_braccia/Kalman Filter2/CalculatePL/DataTypeConversionZ/Conversion';
bio(343).sigName='';
bio(343).portIdx=0;
bio(343).dim=[2,2];
bio(343).sigWidth=4;
bio(343).sigAddress='&StateFlowFinal_B.Conversion_f1[0]';
bio(343).ndims=2;
bio(343).size=[];
bio(343).isStruct=false;

bio(344).blkName='Sistema_braccia/Kalman Filter2/Observer/MeasurementUpdate/C[k]*xhat[k|k-1]';
bio(344).sigName='';
bio(344).portIdx=0;
bio(344).dim=[1,1];
bio(344).sigWidth=1;
bio(344).sigAddress='&StateFlowFinal_B.MeasurementUpdate_a.Ckxhatkk1';
bio(344).ndims=2;
bio(344).size=[];
bio(344).isStruct=false;

bio(345).blkName='Sistema_braccia/Kalman Filter2/Observer/MeasurementUpdate/D[k]*u[k]';
bio(345).sigName='';
bio(345).portIdx=0;
bio(345).dim=[1,1];
bio(345).sigWidth=1;
bio(345).sigAddress='&StateFlowFinal_B.MeasurementUpdate_a.Dkuk';
bio(345).ndims=2;
bio(345).size=[];
bio(345).isStruct=false;

bio(346).blkName='Sistema_braccia/Kalman Filter2/Observer/MeasurementUpdate/Product3';
bio(346).sigName='';
bio(346).portIdx=0;
bio(346).dim=[2,1];
bio(346).sigWidth=2;
bio(346).sigAddress='&StateFlowFinal_B.MeasurementUpdate_a.Product3[0]';
bio(346).ndims=2;
bio(346).size=[];
bio(346).isStruct=false;

bio(347).blkName='Sistema_braccia/Kalman Filter2/Observer/MeasurementUpdate/Add1';
bio(347).sigName='yhat[k|k-1]';
bio(347).portIdx=0;
bio(347).dim=[1,1];
bio(347).sigWidth=1;
bio(347).sigAddress='&StateFlowFinal_B.MeasurementUpdate_a.yhatkk1';
bio(347).ndims=2;
bio(347).size=[];
bio(347).isStruct=false;

bio(348).blkName='Sistema_braccia/Kalman Filter2/Observer/MeasurementUpdate/Sum';
bio(348).sigName='';
bio(348).portIdx=0;
bio(348).dim=[1,1];
bio(348).sigWidth=1;
bio(348).sigAddress='&StateFlowFinal_B.MeasurementUpdate_a.Sum';
bio(348).ndims=2;
bio(348).size=[];
bio(348).isStruct=false;

bio(349).blkName='Sistema_braccia/Kalman Filter2/UseCurrentEstimator/Enabled Subsystem/Product';
bio(349).sigName='';
bio(349).portIdx=0;
bio(349).dim=[1,1];
bio(349).sigWidth=1;
bio(349).sigAddress='&StateFlowFinal_B.UseCurrentEstimator.Product';
bio(349).ndims=2;
bio(349).size=[];
bio(349).isStruct=false;

bio(350).blkName='Sistema_braccia/Kalman Filter2/UseCurrentEstimator/Enabled Subsystem/Product1';
bio(350).sigName='';
bio(350).portIdx=0;
bio(350).dim=[1,1];
bio(350).sigWidth=1;
bio(350).sigAddress='&StateFlowFinal_B.UseCurrentEstimator.Product1';
bio(350).ndims=2;
bio(350).size=[];
bio(350).isStruct=false;

bio(351).blkName='Sistema_braccia/Kalman Filter2/UseCurrentEstimator/Enabled Subsystem/Product2';
bio(351).sigName='';
bio(351).portIdx=0;
bio(351).dim=[2,1];
bio(351).sigWidth=2;
bio(351).sigAddress='&StateFlowFinal_B.UseCurrentEstimator.Product2[0]';
bio(351).ndims=2;
bio(351).size=[];
bio(351).isStruct=false;

bio(352).blkName='Sistema_braccia/Kalman Filter2/UseCurrentEstimator/Enabled Subsystem/Add1';
bio(352).sigName='';
bio(352).portIdx=0;
bio(352).dim=[1,1];
bio(352).sigWidth=1;
bio(352).sigAddress='&StateFlowFinal_B.UseCurrentEstimator.Add1';
bio(352).ndims=2;
bio(352).size=[];
bio(352).isStruct=false;

bio(353).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/D*u(k)';
bio(353).sigName='';
bio(353).portIdx=0;
bio(353).dim=[1,1];
bio(353).sigWidth=1;
bio(353).sigAddress='&StateFlowFinal_B.Duk_h';
bio(353).ndims=2;
bio(353).size=[];
bio(353).isStruct=false;

bio(354).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*x1(k) + B*u1(k) ';
bio(354).sigName='x1(k+1)';
bio(354).portIdx=0;
bio(354).dim=[1,1];
bio(354).sigWidth=1;
bio(354).sigAddress='&StateFlowFinal_B.x1k1_g';
bio(354).ndims=2;
bio(354).size=[];
bio(354).isStruct=false;

bio(355).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*x2(k) + B*u2(k)';
bio(355).sigName='x2(k+1)';
bio(355).portIdx=0;
bio(355).dim=[1,1];
bio(355).sigWidth=1;
bio(355).sigAddress='&StateFlowFinal_B.x2k1_n';
bio(355).ndims=2;
bio(355).size=[];
bio(355).isStruct=false;

bio(356).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/C*X(k)+D*u(k)';
bio(356).sigName='y(k)';
bio(356).portIdx=0;
bio(356).dim=[1,1];
bio(356).sigWidth=1;
bio(356).sigAddress='&StateFlowFinal_B.yk_i';
bio(356).ndims=2;
bio(356).size=[];
bio(356).isStruct=false;

bio(357).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/Delay_x1';
bio(357).sigName='x1(k)';
bio(357).portIdx=0;
bio(357).dim=[1,1];
bio(357).sigWidth=1;
bio(357).sigAddress='&StateFlowFinal_B.x1k_a';
bio(357).ndims=2;
bio(357).size=[];
bio(357).isStruct=false;

bio(358).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/Delay_x2';
bio(358).sigName='x2(k)';
bio(358).portIdx=0;
bio(358).dim=[1,1];
bio(358).sigWidth=1;
bio(358).sigAddress='&StateFlowFinal_B.x2k_g';
bio(358).ndims=2;
bio(358).size=[];
bio(358).isStruct=false;

bio(359).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/D*u(k)';
bio(359).sigName='';
bio(359).portIdx=0;
bio(359).dim=[1,1];
bio(359).sigWidth=1;
bio(359).sigAddress='&StateFlowFinal_B.Duk';
bio(359).ndims=2;
bio(359).size=[];
bio(359).isStruct=false;

bio(360).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*x1(k) + B*u1(k) ';
bio(360).sigName='x1(k+1)';
bio(360).portIdx=0;
bio(360).dim=[1,1];
bio(360).sigWidth=1;
bio(360).sigAddress='&StateFlowFinal_B.x1k1';
bio(360).ndims=2;
bio(360).size=[];
bio(360).isStruct=false;

bio(361).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*x2(k) + B*u2(k)';
bio(361).sigName='x2(k+1)';
bio(361).portIdx=0;
bio(361).dim=[1,1];
bio(361).sigWidth=1;
bio(361).sigAddress='&StateFlowFinal_B.x2k1';
bio(361).ndims=2;
bio(361).size=[];
bio(361).isStruct=false;

bio(362).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/C*X(k)+D*u(k)';
bio(362).sigName='y(k)';
bio(362).portIdx=0;
bio(362).dim=[1,1];
bio(362).sigWidth=1;
bio(362).sigAddress='&StateFlowFinal_B.yk';
bio(362).ndims=2;
bio(362).size=[];
bio(362).isStruct=false;

bio(363).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/Delay_x1';
bio(363).sigName='x1(k)';
bio(363).portIdx=0;
bio(363).dim=[1,1];
bio(363).sigWidth=1;
bio(363).sigAddress='&StateFlowFinal_B.x1k';
bio(363).ndims=2;
bio(363).size=[];
bio(363).isStruct=false;

bio(364).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/Delay_x2';
bio(364).sigName='x2(k)';
bio(364).portIdx=0;
bio(364).dim=[1,1];
bio(364).sigWidth=1;
bio(364).sigAddress='&StateFlowFinal_B.x2k';
bio(364).ndims=2;
bio(364).size=[];
bio(364).isStruct=false;

bio(365).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/D*u(k)';
bio(365).sigName='';
bio(365).portIdx=0;
bio(365).dim=[1,1];
bio(365).sigWidth=1;
bio(365).sigAddress='&StateFlowFinal_B.Duk_n';
bio(365).ndims=2;
bio(365).size=[];
bio(365).isStruct=false;

bio(366).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*x1(k) + B*u1(k) ';
bio(366).sigName='x1(k+1)';
bio(366).portIdx=0;
bio(366).dim=[1,1];
bio(366).sigWidth=1;
bio(366).sigAddress='&StateFlowFinal_B.x1k1_h';
bio(366).ndims=2;
bio(366).size=[];
bio(366).isStruct=false;

bio(367).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*x2(k) + B*u2(k)';
bio(367).sigName='x2(k+1)';
bio(367).portIdx=0;
bio(367).dim=[1,1];
bio(367).sigWidth=1;
bio(367).sigAddress='&StateFlowFinal_B.x2k1_h';
bio(367).ndims=2;
bio(367).size=[];
bio(367).isStruct=false;

bio(368).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/C*X(k)+D*u(k)';
bio(368).sigName='y(k)';
bio(368).portIdx=0;
bio(368).dim=[1,1];
bio(368).sigWidth=1;
bio(368).sigAddress='&StateFlowFinal_B.yk_m';
bio(368).ndims=2;
bio(368).size=[];
bio(368).isStruct=false;

bio(369).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/Delay_x1';
bio(369).sigName='x1(k)';
bio(369).portIdx=0;
bio(369).dim=[1,1];
bio(369).sigWidth=1;
bio(369).sigAddress='&StateFlowFinal_B.x1k_i';
bio(369).ndims=2;
bio(369).size=[];
bio(369).isStruct=false;

bio(370).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/Delay_x2';
bio(370).sigName='x2(k)';
bio(370).portIdx=0;
bio(370).dim=[1,1];
bio(370).sigWidth=1;
bio(370).sigAddress='&StateFlowFinal_B.x2k_d';
bio(370).ndims=2;
bio(370).size=[];
bio(370).isStruct=false;

bio(371).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*k(k-1)/A11';
bio(371).sigName='';
bio(371).portIdx=0;
bio(371).dim=[1,1];
bio(371).sigWidth=1;
bio(371).sigAddress='&StateFlowFinal_B.A11_p';
bio(371).ndims=2;
bio(371).size=[];
bio(371).isStruct=false;

bio(372).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*k(k-1)/A12';
bio(372).sigName='';
bio(372).portIdx=0;
bio(372).dim=[1,1];
bio(372).sigWidth=1;
bio(372).sigAddress='&StateFlowFinal_B.A12_c';
bio(372).ndims=2;
bio(372).size=[];
bio(372).isStruct=false;

bio(373).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*k(k-1)/A21';
bio(373).sigName='';
bio(373).portIdx=0;
bio(373).dim=[1,1];
bio(373).sigWidth=1;
bio(373).sigAddress='&StateFlowFinal_B.A21_h';
bio(373).ndims=2;
bio(373).size=[];
bio(373).isStruct=false;

bio(374).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*k(k-1)/A22';
bio(374).sigName='';
bio(374).portIdx=0;
bio(374).dim=[1,1];
bio(374).sigWidth=1;
bio(374).sigAddress='&StateFlowFinal_B.A22_d';
bio(374).ndims=2;
bio(374).size=[];
bio(374).isStruct=false;

bio(375).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*k(k-1)/sum2';
bio(375).sigName='';
bio(375).portIdx=0;
bio(375).dim=[1,1];
bio(375).sigWidth=1;
bio(375).sigAddress='&StateFlowFinal_B.sum2_nk';
bio(375).ndims=2;
bio(375).size=[];
bio(375).isStruct=false;

bio(376).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/A*k(k-1)/sum3';
bio(376).sigName='';
bio(376).portIdx=0;
bio(376).dim=[1,1];
bio(376).sigWidth=1;
bio(376).sigAddress='&StateFlowFinal_B.sum3_e';
bio(376).ndims=2;
bio(376).size=[];
bio(376).isStruct=false;

bio(377).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/B*(u(k)+u(k-1))/B11';
bio(377).sigName='';
bio(377).portIdx=0;
bio(377).dim=[1,1];
bio(377).sigWidth=1;
bio(377).sigAddress='&StateFlowFinal_B.B11_k';
bio(377).ndims=2;
bio(377).size=[];
bio(377).isStruct=false;

bio(378).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/B*(u(k)+u(k-1))/B21';
bio(378).sigName='';
bio(378).portIdx=0;
bio(378).dim=[1,1];
bio(378).sigWidth=1;
bio(378).sigAddress='&StateFlowFinal_B.B21_l';
bio(378).ndims=2;
bio(378).size=[];
bio(378).isStruct=false;

bio(379).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/C*x(k)/C11';
bio(379).sigName='';
bio(379).portIdx=0;
bio(379).dim=[1,1];
bio(379).sigWidth=1;
bio(379).sigAddress='&StateFlowFinal_B.C11_h';
bio(379).ndims=2;
bio(379).size=[];
bio(379).isStruct=false;

bio(380).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/C*x(k)/C12';
bio(380).sigName='';
bio(380).portIdx=0;
bio(380).dim=[1,1];
bio(380).sigWidth=1;
bio(380).sigAddress='&StateFlowFinal_B.C12_e';
bio(380).ndims=2;
bio(380).size=[];
bio(380).isStruct=false;

bio(381).blkName='Sistema_braccia/Posizioni/Second-Order Filter/Model/C*x(k)/sum2';
bio(381).sigName='';
bio(381).portIdx=0;
bio(381).dim=[1,1];
bio(381).sigWidth=1;
bio(381).sigAddress='&StateFlowFinal_B.sum2_k';
bio(381).ndims=2;
bio(381).size=[];
bio(381).isStruct=false;

bio(382).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*k(k-1)/A11';
bio(382).sigName='';
bio(382).portIdx=0;
bio(382).dim=[1,1];
bio(382).sigWidth=1;
bio(382).sigAddress='&StateFlowFinal_B.A11';
bio(382).ndims=2;
bio(382).size=[];
bio(382).isStruct=false;

bio(383).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*k(k-1)/A12';
bio(383).sigName='';
bio(383).portIdx=0;
bio(383).dim=[1,1];
bio(383).sigWidth=1;
bio(383).sigAddress='&StateFlowFinal_B.A12';
bio(383).ndims=2;
bio(383).size=[];
bio(383).isStruct=false;

bio(384).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*k(k-1)/A21';
bio(384).sigName='';
bio(384).portIdx=0;
bio(384).dim=[1,1];
bio(384).sigWidth=1;
bio(384).sigAddress='&StateFlowFinal_B.A21';
bio(384).ndims=2;
bio(384).size=[];
bio(384).isStruct=false;

bio(385).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*k(k-1)/A22';
bio(385).sigName='';
bio(385).portIdx=0;
bio(385).dim=[1,1];
bio(385).sigWidth=1;
bio(385).sigAddress='&StateFlowFinal_B.A22';
bio(385).ndims=2;
bio(385).size=[];
bio(385).isStruct=false;

bio(386).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*k(k-1)/sum2';
bio(386).sigName='';
bio(386).portIdx=0;
bio(386).dim=[1,1];
bio(386).sigWidth=1;
bio(386).sigAddress='&StateFlowFinal_B.sum2_n';
bio(386).ndims=2;
bio(386).size=[];
bio(386).isStruct=false;

bio(387).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/A*k(k-1)/sum3';
bio(387).sigName='';
bio(387).portIdx=0;
bio(387).dim=[1,1];
bio(387).sigWidth=1;
bio(387).sigAddress='&StateFlowFinal_B.sum3';
bio(387).ndims=2;
bio(387).size=[];
bio(387).isStruct=false;

bio(388).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/B*(u(k)+u(k-1))/B11';
bio(388).sigName='';
bio(388).portIdx=0;
bio(388).dim=[1,1];
bio(388).sigWidth=1;
bio(388).sigAddress='&StateFlowFinal_B.B11';
bio(388).ndims=2;
bio(388).size=[];
bio(388).isStruct=false;

bio(389).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/B*(u(k)+u(k-1))/B21';
bio(389).sigName='';
bio(389).portIdx=0;
bio(389).dim=[1,1];
bio(389).sigWidth=1;
bio(389).sigAddress='&StateFlowFinal_B.B21';
bio(389).ndims=2;
bio(389).size=[];
bio(389).isStruct=false;

bio(390).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/C*x(k)/C11';
bio(390).sigName='';
bio(390).portIdx=0;
bio(390).dim=[1,1];
bio(390).sigWidth=1;
bio(390).sigAddress='&StateFlowFinal_B.C11';
bio(390).ndims=2;
bio(390).size=[];
bio(390).isStruct=false;

bio(391).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/C*x(k)/C12';
bio(391).sigName='';
bio(391).portIdx=0;
bio(391).dim=[1,1];
bio(391).sigWidth=1;
bio(391).sigAddress='&StateFlowFinal_B.C12';
bio(391).ndims=2;
bio(391).size=[];
bio(391).isStruct=false;

bio(392).blkName='Sistema_braccia/Posizioni/Second-Order Filter1/Model/C*x(k)/sum2';
bio(392).sigName='';
bio(392).portIdx=0;
bio(392).dim=[1,1];
bio(392).sigWidth=1;
bio(392).sigAddress='&StateFlowFinal_B.sum2';
bio(392).ndims=2;
bio(392).size=[];
bio(392).isStruct=false;

bio(393).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*k(k-1)/A11';
bio(393).sigName='';
bio(393).portIdx=0;
bio(393).dim=[1,1];
bio(393).sigWidth=1;
bio(393).sigAddress='&StateFlowFinal_B.A11_h';
bio(393).ndims=2;
bio(393).size=[];
bio(393).isStruct=false;

bio(394).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*k(k-1)/A12';
bio(394).sigName='';
bio(394).portIdx=0;
bio(394).dim=[1,1];
bio(394).sigWidth=1;
bio(394).sigAddress='&StateFlowFinal_B.A12_g';
bio(394).ndims=2;
bio(394).size=[];
bio(394).isStruct=false;

bio(395).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*k(k-1)/A21';
bio(395).sigName='';
bio(395).portIdx=0;
bio(395).dim=[1,1];
bio(395).sigWidth=1;
bio(395).sigAddress='&StateFlowFinal_B.A21_p';
bio(395).ndims=2;
bio(395).size=[];
bio(395).isStruct=false;

bio(396).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*k(k-1)/A22';
bio(396).sigName='';
bio(396).portIdx=0;
bio(396).dim=[1,1];
bio(396).sigWidth=1;
bio(396).sigAddress='&StateFlowFinal_B.A22_j';
bio(396).ndims=2;
bio(396).size=[];
bio(396).isStruct=false;

bio(397).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*k(k-1)/sum2';
bio(397).sigName='';
bio(397).portIdx=0;
bio(397).dim=[1,1];
bio(397).sigWidth=1;
bio(397).sigAddress='&StateFlowFinal_B.sum2_e';
bio(397).ndims=2;
bio(397).size=[];
bio(397).isStruct=false;

bio(398).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/A*k(k-1)/sum3';
bio(398).sigName='';
bio(398).portIdx=0;
bio(398).dim=[1,1];
bio(398).sigWidth=1;
bio(398).sigAddress='&StateFlowFinal_B.sum3_b';
bio(398).ndims=2;
bio(398).size=[];
bio(398).isStruct=false;

bio(399).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/B*(u(k)+u(k-1))/B11';
bio(399).sigName='';
bio(399).portIdx=0;
bio(399).dim=[1,1];
bio(399).sigWidth=1;
bio(399).sigAddress='&StateFlowFinal_B.B11_d';
bio(399).ndims=2;
bio(399).size=[];
bio(399).isStruct=false;

bio(400).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/B*(u(k)+u(k-1))/B21';
bio(400).sigName='';
bio(400).portIdx=0;
bio(400).dim=[1,1];
bio(400).sigWidth=1;
bio(400).sigAddress='&StateFlowFinal_B.B21_h';
bio(400).ndims=2;
bio(400).size=[];
bio(400).isStruct=false;

bio(401).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/C*x(k)/C11';
bio(401).sigName='';
bio(401).portIdx=0;
bio(401).dim=[1,1];
bio(401).sigWidth=1;
bio(401).sigAddress='&StateFlowFinal_B.C11_e';
bio(401).ndims=2;
bio(401).size=[];
bio(401).isStruct=false;

bio(402).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/C*x(k)/C12';
bio(402).sigName='';
bio(402).portIdx=0;
bio(402).dim=[1,1];
bio(402).sigWidth=1;
bio(402).sigAddress='&StateFlowFinal_B.C12_m';
bio(402).ndims=2;
bio(402).size=[];
bio(402).isStruct=false;

bio(403).blkName='Sistema_braccia/Posizioni/Second-Order Filter2/Model/C*x(k)/sum2';
bio(403).sigName='';
bio(403).portIdx=0;
bio(403).dim=[1,1];
bio(403).sigWidth=1;
bio(403).sigAddress='&StateFlowFinal_B.sum2_ka';
bio(403).ndims=2;
bio(403).size=[];
